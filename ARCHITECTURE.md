...
- PMD: Custom ruleset `pmd-ruleset.xml` (quickstart rules, 10 excluded rules, allowCommentedBlocks, excludes `com/intel/mkl/`), 583 violations (code-style only, down 83% from original 3,443 after systematic cleanup: 240 violations fixed including 94 ForLoopCanBeForeach, 116 false positives excluded)
