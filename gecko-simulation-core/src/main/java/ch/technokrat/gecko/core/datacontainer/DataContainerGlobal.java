...
public final class DataContainerGlobal extends AbstractDataContainer implements Observer, DataContainerValuesSettable, DataContainerIntegralCalculatable{
  ...
  public void init(final int rows, final String[] signalNames, final String xDataName){
      final DataContainerCompressable data = new DataContainerCompressable(rows, new TimeSeriesConstantDt(), signalNames, xDataName);      
    _settable = data;
    _data = data;
