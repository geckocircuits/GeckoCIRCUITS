...
/**
 * This an interface for using RMI to control GeckoCIRCUITS from e.g. MATLAB, or remotely from
 * another machine. GeckoCustom implements this interface. Therefore all GeckoSCRIPT functions
...
public interface GeckoRemoteInterface extends Remote {
   ...
   * @deprecated this method is meaningless essentially now that multiple clients may be connected
   *     to GeckoCIRCUITS. Use @link #checkSessionID(long sessionID) instead.
   */
  @Deprecated
  ...
  @Declaration(
      "double[][] getFourier(String scope, int port, double tStart, double tStop, int harm)")
  double[][] getFourier(
  ...
  @Declaration(
      "void createComponent(String compType, String newElemName, int sheetPosX, sheetPosY)")
  ...
  @Declaration(
      "createConnector(String elementName, int xStart, int yStart, int xEnd, int yEnd, boolean startHorizontal)")
  ...
  @Declaration(
      "void initSteadyStateDetection(String[] stateVariables, double frequency, double dt, double simulationTime)")
  void initSteadyStateDetection(
  ...
  double[] simulateToSteadyState(
      final boolean supressMessages, final double targetCorrelation, final double targetMeanPctDiff)
      throws RemoteException;
  ...
  // @Declaration("void setLossFile(String elementName, String lossFileName) throws
  ...
  // @Declaration("void setNonLinear(String elementName, String characteristicFileName) throws
  // FileNotFoundException")
  @Deprecated
  ...
  // @Declaration("void initSteadyStateDetection(String[] stateVariables, double[] frequencies,
  // double dt, double simulationTime)")
  @Deprecated
  void initSteadyStateDetection(
      String[] stateVariables, double[] frequencies, double deltaT, double simulationTime)
      throws RemoteException;
  ...
  @Deprecated
  double[] getSignalCharacteristics(
