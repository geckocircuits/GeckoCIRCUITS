...
public final class JPanelDialogRange extends JPanel {
  ...
  private final FormatJTextField _rngSc1,
      _rngSc2,
      _rngDf1,
      _rngDf2,
      _rngSl1,
      _rngSl2; // Angaben Zeitbereiche
  ...
  private final transient KeyListener _xDef1KeyListener =
      new KeyListener() {
  ...
  private final transient KeyListener _xDef2KeyListener =
      new KeyListener() {
  ...
  public JPanelDialogRange(final AbstractDataContainer worksheet, final double[] sliderValues) {
    ...
    setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(), "Set range", TitledBorder.LEFT, TitledBorder.TOP));
  ...
  private void setActionListeners() {
    ...
    jRadButScopeRange.addActionListener(
        new ActionListener() {
    ...
    jRadButtDefRange.addActionListener(
        new ActionListener() {
