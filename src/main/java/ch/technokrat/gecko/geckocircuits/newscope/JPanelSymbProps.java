...
public class JPanelSymbProps extends javax.swing.JPanel {
  ...
  public JPanelSymbProps(SymbolSettable lineSettable, final Component redrawComponent) {
    ...
    jCheckBoxShow.addActionListener(
        new ActionListener() {
  ...
  private void initComponents() {
    ...
    jComboBoxShape.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jComboBoxSymbColor.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
                                    ...
                                    .addGroup(
                                        jPanel1Layout
                                            ...
                                            .addComponent(
                                                ...
                                                Short.MAX_VALUE)
                                            .addComponent(
                                                jComboBoxSymbColor, 0, 110, Short.MAX_VALUE)
                                            .addComponent(
                                                jComboBoxShape,
                                                javax.swing.GroupLayout.Alignment.LEADING,
                                                0,
    ...
    jPanel1Layout.linkSize(
        ...
        new java.awt.Component[] {jComboBoxShape, jComboBoxSymbColor, jSpinnerSkip});
  ...
  private void jComboBoxSymbColorActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jComboBoxSymbColorActionPerformed
    if (_redrawComponent != null) {
      _symbSettable.setSymbolColor(
          GeckoColor.getFromOrdinal(jComboBoxSymbColor.getSelectedIndex()));
    }
    repaintComponent();
  } // GEN-LAST:event_jComboBoxSymbColorActionPerformed

  private void jComboBoxShapeActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jComboBoxShapeActionPerformed
    if (_redrawComponent != null) {
  ...
  private void jCheckBoxShowActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jCheckBoxShowActionPerformed
  ...
  private void jSpinnerSkipStateChanged(
      javax.swing.event.ChangeEvent evt) { // NOPMD//GEN-FIRST:event_jSpinnerSkipStateChanged
