...
public class JPanelAxisSettings2 extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    jComboBoxScaleType.addActionListener(
    ...
    jCheckBoxAutoScale.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jTextFieldAxisLabel.addPropertyChangeListener(
    ...
    formatJTextFieldMinVal.addFocusListener(
    ...
    formatJTextFieldMaxVal.addFocusListener(
        new java.awt.event.FocusAdapter() {
          public void focusLost(java.awt.event.FocusEvent evt) {
    ...
    jCheckBoxSymmetricZero.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    javax.swing.GroupLayout jPanelAxisSettingsLayout =
        new javax.swing.GroupLayout(jPanelAxisSettings);
    jPanelAxisSettings.setLayout(jPanelAxisSettingsLayout);
    jPanelAxisSettingsLayout.setHorizontalGroup(
        jPanelAxisSettingsLayout
                                ...
                                jPanelAxisSettingsLayout
                                    ...
                                    .addGroup(
                                        jPanelAxisSettingsLayout
                                            ...
                                            .addComponent(
                                                formatJTextFieldMinVal,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE)
                                            .addComponent(
                                                formatJTextFieldMaxVal,
                                                javax.swing.GroupLayout.Alignment.TRAILING,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE)
  ...
  private void jTextFieldAxisLabelPropertyChange(
      java.beans.PropertyChangeEvent
          evt) { // NOPMD//GEN-FIRST:event_jTextFieldAxisLabelPropertyChange
    if (_initDone) {
  ...
  private void jCheckBoxAutoScaleActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxAutoScaleActionPerformed
  ...
  private void jComboBoxScaleTypeActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jComboBoxScaleTypeActionPerformed
    if (_initDone) {
  ...
  private void formatJTextFieldMinValFocusLost(
      java.awt.event.FocusEvent evt) { // GEN-FIRST:event_formatJTextFieldMinValFocusLost
    setNewLimits();
    repaintComponent();
  } // GEN-LAST:event_formatJTextFieldMinValFocusLost

  private void formatJTextFieldMaxValFocusLost(
      java.awt.event.FocusEvent evt) { // GEN-FIRST:event_formatJTextFieldMaxValFocusLost
    setNewLimits();
    repaintComponent();
  } // GEN-LAST:event_formatJTextFieldMaxValFocusLost

  private void jCheckBoxSymmetricZeroActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxSymmetricZeroActionPerformed
