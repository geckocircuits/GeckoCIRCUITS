...
public final class ScopeSignalMean extends AbstractScopeSignal {
  ...
  public ScopeSignalMean(
      final AbstractScopeSignal connectedScopeSignal, final double averagingTime) {
    super();
  ...
  public int hashCode() {
    ...
    hash =
        67 * hash
            + (int)
                (Double.doubleToLongBits(this._averagingTime)
                    ^ (Double.doubleToLongBits(this._averagingTime) >>> 32));
    hash =
        67 * hash
            + (this._connectedScopeSignal != null ? this._connectedScopeSignal.hashCode() : 0);
    return hash;
  }
