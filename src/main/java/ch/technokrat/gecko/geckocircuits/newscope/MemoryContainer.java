...
/**
 * Instead of creating a new float[] at every simulation step, we try to obtain a cached one. This
 * class is "pseudo-threadsafe". One could do it quite clean with some effort and synchronization of
 * the static methods. However, the occurence of returnValue == null is only rare. Therefore, we
 * just detect this nullpointer and generate a float[] in this case. This is much simpler and more
 * efficient than a correct thread synchronization.
 *
 * @author andreas
 */
