...
/**
 * A Curve class represents a single curve within a diagram, please note that there can be several
 * curves in one diagram, or different curves with the same data can be plotted in different
 * Diagrams!
 *
 * @author andy
 */
public abstract class AbstractCurve implements LineSettable, SymbolSettable {
  ...
  public void populatePropertiesFromModelFile(
      final TokenMap curveMap, final AbstractDiagram diagram) {
    _axisConnection =
        AxisConnection.getFromCode(
