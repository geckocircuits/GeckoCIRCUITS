...
public final class ScopeFrame extends javax.swing.JFrame {
  ...
  public ScopeFrame(final GraferV4 grafer) {
    ...
    inputMap.put(
        ...
        "moveExternalSignal" + KeyEvent.VK_LEFT);
    actionMap.put(
        "moveExternalSignal" + KeyEvent.VK_LEFT, new MoveExternalSignal(grafer, KeyEvent.VK_LEFT));
    inputMap.put(
        KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, KeyEvent.CTRL_MASK, false),
        "moveExternalSignal" + KeyEvent.VK_RIGHT);
    actionMap.put(
        "moveExternalSignal" + KeyEvent.VK_RIGHT,
        new MoveExternalSignal(grafer, KeyEvent.VK_RIGHT));
    inputMap.put(
        KeyStroke.getKeyStroke(KeyEvent.VK_UP, KeyEvent.CTRL_MASK, false),
        "moveExternalSignal" + KeyEvent.VK_UP);
    actionMap.put(
        "moveExternalSignal" + KeyEvent.VK_UP, new MoveExternalSignal(grafer, KeyEvent.VK_UP));
    inputMap.put(
        KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, KeyEvent.CTRL_MASK, false),
        "moveExternalSignal" + KeyEvent.VK_DOWN);
    actionMap.put(
        "moveExternalSignal" + KeyEvent.VK_DOWN, new MoveExternalSignal(grafer, KeyEvent.VK_DOWN));
    inputMap.put(
        KeyStroke.getKeyStroke(KeyEvent.VK_DELETE, KeyEvent.CTRL_MASK, true),
        "moveExternalSignal" + KeyEvent.VK_DELETE);
    actionMap.put(
        "moveExternalSignal" + KeyEvent.VK_DELETE,
        new MoveExternalSignal(grafer, KeyEvent.VK_DELETE));
  ...
  /**
   * Wenn die Simulation gerade laeuft, werden alle Menus deaktiviert, damit man dort nicht
   * herumpfuschen kann.
   *
  ...
  private void initComponents() {
    ...
    jMenuScopeData.addActionListener(
    ...
    jMenuItemSaveData.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jMenuItemSaveViewAsImage.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jMenuItemScopeSettings.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jMenuItemAvgSgn.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jMenuItemCharacteristics.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jMenuItemFourier.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void jMenuItemExitActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jMenuItemExitActionPerformed
    this.dispose();
  } // GEN-LAST:event_jMenuItemExitActionPerformed

  private void jMenuItemSaveViewAsImageActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jMenuItemSaveViewAsImageActionPerformed
    new SaveViewFrame(this, _grafer).setVisible(true);
  } // GEN-LAST:event_jMenuItemSaveViewAsImageActionPerformed

  private void jMenuItemSignalGraphActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jMenuItemSignalGraphActionPerformed
    if (_diagCON != null) {
      _diagCON.dispose();
    }
  ...
  private void jMenuItemCharacteristicsActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jMenuItemCharacteristicsActionPerformed
    ...
    _diagAvgRms =
        new DialogScopeCharacteristics(
            this, ramData, _powerAnalysisSettings, _grafer._sliderContainer.getSliderXRange());
    _diagAvgRms.setLocationByPlatform(true);
    _diagAvgRms.setVisible(true);
  } // GEN-LAST:event_jMenuItemCharacteristicsActionPerformed

  private void jMenuItemFourierActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jMenuItemFourierActionPerformed
    final AbstractDataContainer ramData = _regelBlockOSZI.getZVDatenImRAM();
    if (ramData == null) {
      return;
    }
  ...
  private void jMenuItemParameterActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jMenuItemParameterActionPerformed
    GeckoSim._win.openParameterMenu(this);
  } // GEN-LAST:event_jMenuItemParameterActionPerformed

  private void jMenuItemInitAndStartActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jMenuItemInitAndStartActionPerformed
    GeckoSim._win.initStartWithErrorDialogMessage();
  } // GEN-LAST:event_jMenuItemInitAndStartActionPerformed

  private void jMenuItemPauseActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jMenuItemPauseActionPerformed
    GeckoSim._win.pauseSimulation();
  } // GEN-LAST:event_jMenuItemPauseActionPerformed

  private void jMenuItemContinueActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jMenuItemContinueActionPerformed
    try {
  ...
  private void jMenuItemSaveDataActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jMenuItemSaveDataActionPerformed
    JOptionPane.showMessageDialog(
        this,
        "This menu option was removed. Please use the 'Export Data To File' \ncontrol"
            + "block, which you can find in the 'Source/ Sink' control menue.",
        "Information",
        JOptionPane.INFORMATION_MESSAGE);
  } // GEN-LAST:event_jMenuItemSaveDataActionPerformed

  private void jMenuItemAvgSgnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jMenuItemAvgSgnActionPerformed
    final DialogDefineAvg dialog =
        new DialogDefineAvg(
            this, true, (DataContainerIntegralCalculatable) _regelBlockOSZI.getZVDatenImRAM());
    dialog.setVisible(true);
  } // GEN-LAST:event_jMenuItemAvgSgnActionPerformed

  private void jMenuScopeDataActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jMenuScopeDataActionPerformed
  } // GEN-LAST:event_jMenuScopeDataActionPerformed

  private void jMenuItemScopeSettingsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jMenuItemScopeSettingsActionPerformed
