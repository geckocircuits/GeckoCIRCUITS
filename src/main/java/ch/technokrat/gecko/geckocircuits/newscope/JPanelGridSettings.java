...
public class JPanelGridSettings extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    jCheckBoxShowGridLineMaj.addActionListener(
    ...
    jCheckBoxAutoSpacing.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jCheckBoxShowLabelMaj.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    formatJTextFieldTickSpace.addKeyListener(
    ...
    formatJTextFieldTickLenghtMaj.addKeyListener(
        new java.awt.event.KeyAdapter() {
          public void keyReleased(java.awt.event.KeyEvent evt) {
                ...
                jPanelMajLayout
                    ...
                    .addGroup(
                        jPanelMajLayout
                            ...
                            .addComponent(
                                jCheckBoxAutoSpacing, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(
                                jCheckBoxShowGridLineMaj, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(
                                jCheckBoxShowLabelMaj, javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(
                                    ...
                                    .addGroup(
                                        jPanelMajLayout
                                            .createParallelGroup(
                                                javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(
                                                formatJTextFieldTickLenghtMaj,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE)
                                            .addComponent(
                                                formatJTextFieldTickSpace,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE))))
                    .addGap(16, 16, 16))
    ...
    jCheckBoxShowGridLineMin.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jCheckBoxShowLabelMin.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    formatJTextFieldNumTicks.addKeyListener(
        new java.awt.event.KeyAdapter() {
          public void keyReleased(java.awt.event.KeyEvent evt) {
    ...
    formatJTextFieldTickLengthMin.addKeyListener(
        new java.awt.event.KeyAdapter() {
          public void keyReleased(java.awt.event.KeyEvent evt) {
                                    ...
                                    .addGroup(
                                        jPanelMinLayout
                                            .createParallelGroup(
                                                javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(
                                                formatJTextFieldTickLengthMin,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                137,
                                                Short.MAX_VALUE)
                                            .addComponent(
                                                formatJTextFieldNumTicks,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                137,
                                                Short.MAX_VALUE))
                                    .addContainerGap())
                    ...
                    .addGroup(
                        jPanelMinLayout
                            ...
                            .addComponent(
                                ...
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(
                                jLabelTickLengthMin, javax.swing.GroupLayout.Alignment.TRAILING))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(jCheckBoxShowLabelMin)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(jCheckBoxShowGridLineMin)
    ...
    jCheckBoxAutoGridLine.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void jCheckBoxAutoSpacingActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxAutoSpacingActionPerformed
  ...
  private void jCheckBoxShowLabelMajActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxShowLabelMajActionPerformed
    if (_initDone) {
  ...
  private void jCheckBoxShowGridLineMajActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxShowGridLineMajActionPerformed
    if (_initDone) {
  ...
  private void jCheckBoxShowLabelMinActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxShowLabelMinActionPerformed
    if (_initDone) {
  ...
  private void jCheckBoxShowGridLineMinActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxShowGridLineMinActionPerformed
    if (_initDone) {
  ...
  private void jCheckBoxAutoGridLineActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxAutoGridLineActionPerformed
    if (_initDone) {
  ...
  private void formatJTextFieldTickSpaceKeyReleased(
      java.awt.event.KeyEvent evt) { // GEN-FIRST:event_formatJTextFieldTickSpaceKeyReleased
    if (_initDone) {
  ...
  private void formatJTextFieldNumTicksKeyReleased(
      java.awt.event.KeyEvent evt) { // GEN-FIRST:event_formatJTextFieldNumTicksKeyReleased
    if (_initDone) {
  ...
  private void formatJTextFieldTickLengthMinKeyReleased(
      java.awt.event.KeyEvent evt) { // GEN-FIRST:event_formatJTextFieldTickLengthMinKeyReleased
    if (_initDone) {
      _axis._axisTickSettings.setTickLengthMin(
          (int) formatJTextFieldTickLengthMin.getNumberFromField());
      repaintComponent();
    }
  } // GEN-LAST:event_formatJTextFieldTickLengthMinKeyReleased

  private void formatJTextFieldTickLenghtMajKeyReleased(
      java.awt.event.KeyEvent evt) { // GEN-FIRST:event_formatJTextFieldTickLenghtMajKeyReleased
    if (_initDone) {
      _axis._axisTickSettings.setTickLengthMaj(
          (int) formatJTextFieldTickLenghtMaj.getNumberFromField());
      repaintComponent();
    }
