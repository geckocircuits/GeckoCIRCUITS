...
final class ZoomWindow {
  ...
  final MouseMotionListener _mouseMotionLsnr =
      new MouseMotionListener() {
        ...
        private void updateZoomWindow(final MouseEvent mouseEvent) {
          ...
          if (_lastDrawnRect == null) {
            _clickedDiagram.repaint(
                _drawRectangle.x,
                _drawRectangle.y,
                _drawRectangle.width + 1,
                _drawRectangle.height + 1);
          } else {
        ...
        private void doPanning(final MouseEvent mouseEvent) {
          final Set<AbstractDiagram> diagramsForXUpate =
              _clickedDiagram._grafer.getDiagramsForXUpdate(mouseEvent, _clickedDiagram);
  ...
  final MouseListener _mouseListener =
      new MouseListener() {
        @Override
  ...
  private void setDiagramRange(final GraferV4 grafer) {
    ...
    final HiLoData newValueMinMax =
        HiLoData.hiLoDataFabric(
            (float) zoomedXAxis.getValueFromPixel(_drawRectangle.x),
