...
public final class NewScope extends javax.swing.JPanel {
  ...
  private static final String CURSOR_FORWARD_INFO =
      "Forward/Backward mode for cursor search functions";
  private static final String ZOOM_INFO =
      "<html>Lock zoom to X-axis. Alternatively, press<br> CTRL button "
  ...
  private void initComponents() {
    ...
    jToggleButtonOff.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/iconOFF_off.png"))); // NOI18N
    jToggleButtonOff.setToolTipText("Disable cursors and zoom modus");
    jToggleButtonOff.setFocusPainted(false);
    jToggleButtonOff.addActionListener(
    ...
    jToggleButtonZoom.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/iconOFF_zoomFenster.png"))); // NOI18N
    jToggleButtonZoom.setSelected(true);
    jToggleButtonZoom.setToolTipText(
        "<html>Activate zoom modus. Drag the mouse to zoom. Pressing Ctrl<br>\nor Shift during draggin enables zooming into a single axis direction.<br>\nAs alternative, you can use the mouse wheel for zooming. Alt-Drag<br>\nenables the pan modus.\n</html>");
    ...
    jToggleButtonZoom.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jToggleButtonSlider.setIcon(
        new javax.swing.ImageIcon(
            getClass()
                .getResource("/gecko/geckocircuits/allg/iconON_getXYschieber.png"))); // NOI18N
    jToggleButtonSlider.setToolTipText(
        "<html>Activate sliders (cursors). You can use the mouse wheel for fine-<br>\nadjustment of the cursors. The second (green) cursor moves by dragging<br>\nthe right mouse button. The green cursor shows DIFFERENCES values w.r.t<br>\nthe first (red) cursor values.</html>");
    ...
    jToggleButtonSlider.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonNextMax.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/icon_nextMax.png"))); // NOI18N
    ...
    jButtonNextMax.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonNextMin.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/icon_nextMin.png"))); // NOI18N
    ...
    jButtonNextMin.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonNextZero.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/icon_nextZero.png"))); // NOI18N
    ...
    jButtonNextZero.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonNextEqual.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/icon_nextEqual.png"))); // NOI18N
    jButtonNextEqual.setToolTipText(
        "<html>Move inactive cursor to next (ctrl-previous)<br>  value equal to the active cursor value</html>");
    ...
    jButtonNextEqual.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonShowAll.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/iconOFF_zoomFit2.png"))); // NOI18N
    ...
    jButtonZoomBack.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/iconUnZoom.png"))); // NOI18N
    ...
    jButtonZoomBack.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jToggleButtonCtrl.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/ctrlForward.png"))); // NOI18N
    ...
    jToggleButtonCtrl.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jToggleButtonZoomShift.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/zoomY.png"))); // NOI18N
    jToggleButtonZoomShift.setToolTipText(
        "<html>Lock zoom to Y-axis. Alternatively, press<br> SHIFT button when dragging the zoom window</html>");
    ...
    jToggleButtonZoomShift.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonSaveZoom.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/iconON_zoomFit2.png"))); // NOI18N
    ...
    jButtonSaveZoom.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonLoadZoom.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/loadZoom.png"))); // NOI18N
    ...
    jButtonLoadZoom.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jToggleButtonAuto.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/geckocircuits/allg/autoScale.png"))); // NOI18N
    ...
    jToggleButtonAuto.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jPanelGraph.addComponentListener(
    ...
    jPanelInfoLayout.setHorizontalGroup(
        jPanelInfoLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 734, Short.MAX_VALUE));
    jPanelInfoLayout.setVerticalGroup(
        jPanelInfoLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 483, Short.MAX_VALUE));
    ...
    layout.setVerticalGroup(
        layout
            ...
            .addComponent(
                ...
                javax.swing.GroupLayout.DEFAULT_SIZE,
                Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup().addComponent(jTabbedPane).addContainerGap()));
  } // </editor-fold>//GEN-END:initComponents

  // CHECKSTYLE:ON
  private void jButtonShowAllActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonShowAllActionPerformed
    for (GraferV4 grafer : _grafer) {
      grafer.doZoomAutoFit();
    }
  } // GEN-LAST:event_jButtonShowAllActionPerformed

  private void jToggleButtonOffActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jToggleButtonOffActionPerformed
  ...
  private void jToggleButtonSliderActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jToggleButtonSliderActionPerformed
  ...
  private void jToggleButtonZoomActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jToggleButtonZoomActionPerformed
    jToggleButtonOff.setSelected(false);
    jToggleButtonSlider.setSelected(false);
    jToggleButtonZoom.setSelected(true);
    for (GraferV4 grafer : _grafer) {
  ...
  private void jButtonZoomBackActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonZoomBackActionPerformed
  ...
  private void jButtonNextMaxActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonNextMaxActionPerformed
  ...
  private void jToggleButtonCtrlActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jToggleButtonCtrlActionPerformed
  ...
  private void jToggleButtonZoomShiftActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jToggleButtonZoomShiftActionPerformed
  ...
  private void jButtonNextMinActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonNextMinActionPerformed
    try {
      final AbstractCurve selectedCurve = _grafer.get(0).getSelectedCurve();
      if (selectedCurve instanceof CurveSignal) {
        _sliderContainer.goToSignalFlank(
            getIterationDirection(), FlankType.DESCEND, _grafer.get(0));
      } else {
  ...
  private void jButtonNextZeroActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonNextZeroActionPerformed
    try {
  ...
  private void jButtonNextEqualActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonNextEqualActionPerformed
    try {
  ...
  private void jButtonSaveZoomActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonSaveZoomActionPerformed
    for (GraferV4 grafer : _grafer) {
      try {
  ...
  private void jButtonLoadZoomActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonLoadZoomActionPerformed
    for (GraferV4 grafer : _grafer) {
      grafer.loadSavedZoom();
    }
  } // GEN-LAST:event_jButtonLoadZoomActionPerformed

  private void jToggleButtonAutoActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jToggleButtonAutoActionPerformed
    for (GraferV4 grafer : _grafer) {
  ...
  private void jPanelGraphComponentResized(
      java.awt.event.ComponentEvent evt) { // GEN-FIRST:event_jPanelGraphComponentResized
    for (GraferV4 grafer : _grafer) {
      grafer.setAxisPositions();
      this.repaint();
    }
  ...
  private void enableSliderButtons() {
    if (_signalCrvSelected) {
      jButtonNextMax.setIcon(
          new javax.swing.ImageIcon(
              getClass().getResource("/gecko/geckocircuits/allg/icon_nextSIGAsc.png")));
      jButtonNextMin.setIcon(
          new javax.swing.ImageIcon(
              getClass().getResource("/gecko/geckocircuits/allg/icon_nextSIGDesc.png")));
      ...
      jButtonNextMax.setIcon(
          new javax.swing.ImageIcon(
              getClass().getResource("/gecko/geckocircuits/allg/icon_nextMax.png")));
      jButtonNextMin.setIcon(
          new javax.swing.ImageIcon(
              getClass().getResource("/gecko/geckocircuits/allg/icon_nextMin.png")));
      jButtonNextMax.setVisible(true);
      jButtonNextMin.setVisible(true);
  ...
  private void setCTRLCursors() {
    ...
    if (jToggleButtonZoom.isSelected()) {
      jToggleButtonCtrl.setIcon(
          new javax.swing.ImageIcon(getClass().getResource("/gecko/geckocircuits/allg/zoomX.png")));
      ...
      if (jToggleButtonCtrl.isSelected()) {
        jToggleButtonCtrl.setIcon(
            new javax.swing.ImageIcon(
                getClass().getResource("/gecko/geckocircuits/allg/ctrlBackward.png")));
      } else {
        jToggleButtonCtrl.setIcon(
            new javax.swing.ImageIcon(
                getClass().getResource("/gecko/geckocircuits/allg/ctrlForward.png")));
      }
    }
  }
