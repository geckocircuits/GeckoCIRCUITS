...
/**
 * HiLo-Data represents a maximum-minimum value and supplies some insertion/detection methods.
 * Careful: this is a non-volatile (immutable) object, i.e. created once, you cannot change the
 * final object fields, similar to the Double, Integer Objects. This object has a private
 * constructor, do not add any public constructor! Create objects via the Fabric.
 *
 * @author andy
 */
public final class HiLoData {
  ...
  /**
   * very often, HiLo-Data is filled with integer objects {0, 1} {0,0}, ... Therefore, just return a
   * static object.
   *
   * @return
   */
  ...
  public static HiLoData mergeFromValue(final HiLoData data, final float value) {
    ...
    if (returnValue == null
        || returnValue._yHi != returnValue._yHi
        || returnValue._yLo != returnValue._yLo) {
