...
public class JLabelRot extends JLabel {
  ...
  public JLabelRot(
      final String txt, final double phiGradClockWise, final int width, final int height) {
    this(txt);
    this._txt = txt;
  ...
  public void paintComponent(final Graphics graphics) {
    ...
    g2d.drawString(
        _txt,
        (-this.getHeight() + X_OFFSET),
        (this.getWidth() - (this.getWidth() - g2d.getFont().getSize()) / 2));
  }
}
