...
public class GeckoGraphics2D extends Graphics2D {
  ...
  public boolean drawImage(
      final Image image, final AffineTransform xForm, final ImageObserver obs) {
  ...
  public void drawRenderedImage(
      final RenderedImage renderedImage, final AffineTransform affineTransform) {
    origGraphics.drawRenderedImage(renderedImage, affineTransform);
  }

  @Override
  public void drawRenderableImage(
      final RenderableImage renderableImage, final AffineTransform affineTransform) {
  ...
  public void drawString(AttributedCharacterIterator aci, int i, int i1) {
    origGraphics.drawString(
        aci, java.awt.Component.TOP_ALIGNMENT, java.awt.Component.TOP_ALIGNMENT);
  }
  ...
  @Override
  public boolean drawImage(
      Image image, int i, int i1, int i2, int i3, Color color, ImageObserver io) {
