...
class DialogCurveProperties extends GeckoDialog {
  ...
  public DialogCurveProperties(
      final javax.swing.JDialog parent,
      final boolean modal,
      final AbstractCurve curve,
  ...
  private void initComponents() {
    ...
    jCheckBoxIsFilling.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jSpinner1.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(0.9f), Float.valueOf(0.0f), Float.valueOf(1.0f), Float.valueOf(0.1f)));
  ...
  private void jComboBoxColorActionPerformed(
    ...
    if (_grafer != null) {
      _curve.getCurveSettings()._crvFillingDigColor =
          GeckoColor.getFromOrdinal(jComboBoxColor.getSelectedIndex());
      _grafer.repaint();
    }
  } // GEN-LAST:event_jComboBoxColorActionPerformed

  private void jCheckBoxIsFillingActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jCheckBoxIsFillingActionPerformed
    if (_grafer != null) {
