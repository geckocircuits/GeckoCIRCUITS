...
public final class SliderUtils {
  ...
  private static class DataContainerIterator {
    ...
    DataContainerIterator(
        final AbstractDataContainer container,
  ...
  private static boolean extremaCondition(
      final ExtremumType maxMin, final double before, final double value, final double after) {
    switch (maxMin) {
      case MAXIMUM:
  ...
  private static boolean signalFlankCondition(
      final FlankType flankType,
      final IterationDirection direction,
   ...
   */
  static double nextExtrema(
      final double xValue,
      final AbstractCurve crvIndex,
      final IterationDirection direction,
      final ExtremumType minMax,
      final AbstractDataContainer wsRAM) {

    try {
      final DataContainerIterator iterator =
          new DataContainerIterator(
              wsRAM, direction, wsRAM.findTimeIndex(xValue, 0), crvIndex.getValueDataIndex());
      ...
      JOptionPane.showMessageDialog(
          GeckoSim._win, "No extrema found!", MESSAGE_HEAD, JOptionPane.INFORMATION_MESSAGE);
      return xValue;
    }
  }
  ...
  static double nextSIGNALFlank(
    ...
    try {
      ...
      JOptionPane.showMessageDialog(
          null, "No flank found!", MESSAGE_HEAD, JOptionPane.INFORMATION_MESSAGE);
      return xValue;
    }
  }
  ...
  static double nextZeroOrEqual(
    ...
    try {
      ...
      JOptionPane.showMessageDialog(
          null, "No zero or equal value found!", MESSAGE_HEAD, JOptionPane.INFORMATION_MESSAGE);
      return xValue;
    }
