...
public final class PowerAnalysisSettings {
  ...
  void importIndividualControl(final TokenMap settingsMap) {
    _powerAnalCurrentIndices =
        settingsMap.readDataLine("powerAnalCurIndices[]", _powerAnalCurrentIndices);
    _powerAnalVoltageIndices =
        settingsMap.readDataLine("powerAnalVoltIndices[]", _powerAnalVoltageIndices);
  }
}
