...
public class JPanelLineProperties extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    jComboBoxStroke.addActionListener(
    ...
    jComboBoxColor.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jSpinnerTransp.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(1.0f), Float.valueOf(0.0f), Float.valueOf(1.0f), Float.valueOf(0.1f)));
    jSpinnerTransp.addChangeListener(
    ...
    jComboBoxType.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
                    ...
                    .addGroup(
                        layout
                            ...
                            .addComponent(
                                ...
                                Short.MAX_VALUE)
                            .addComponent(
                                jSpinnerTransp, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(
                                jComboBoxStroke,
                                0,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
  ...
  private void jSpinnerTranspStateChanged(
      javax.swing.event.ChangeEvent evt) { // NOPMD//GEN-FIRST:event_jSpinnerTranspStateChanged
    if (_redrawComponent != null) {
  ...
  @SuppressWarnings("PMD")
  private void jComboBoxColorActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jComboBoxColorActionPerformed
    if (_redrawComponent != null) {
  ...
  @SuppressWarnings("PMD")
  private void jComboBoxStrokeActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jComboBoxStrokeActionPerformed
    if (_redrawComponent != null) {
  ...
  private void jComboBoxTypeActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jComboBoxTypeActionPerformed
