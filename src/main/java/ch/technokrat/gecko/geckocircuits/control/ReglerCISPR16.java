...
public final class ReglerCISPR16 extends RegelBlock implements SpecialNameVisible, Operationable {

  public static final ControlTypeInfo tinfo =
      new ControlTypeInfo(ReglerCISPR16.class, "CISPR16", I18nKeys.EMI_TEST_RECEIVER);
  ...
  /**
   * todo: I don't know a better name for "DA" - this comes from Uwe. Maybe it means "Distanz
   * Aussen"
   */
  ...
  public List<OperationInterface> getOperationEnumInterfaces() {
    ...
    returnValue.add(
        new OperationInterface("startCalculation", I18nKeys.START_CALCULATION_DOC) {
          @Override
    ...
    returnValue.add(
        new OperationInterface("saveFourierData", I18nKeys.SAVE_DATA_DOC) {
          @Override
          public Object doOperation(final Object parameterValue) {
    ...
    returnValue.add(
        new OperationInterface("savePeakData", I18nKeys.SAVE_DATA_DOC) {
          @Override
          public Object doOperation(final Object parameterValue) {
    ...
    returnValue.add(
        new OperationInterface("saveQuasiPeakData", I18nKeys.SAVE_DATA_DOC) {
          @Override
          public Object doOperation(final Object parameterValue) {
    ...
    returnValue.add(
        new OperationInterface("saveAveragePeakData", I18nKeys.SAVE_DATA_DOC) {
          @Override
          public Object doOperation(final Object parameterValue) {
    ...
    returnValue.add(
        new OperationInterface("abortCalculation", I18nKeys.ABORT_SIMULATION) {
          @Override
          public Object doOperation(final Object parameterValue) {
    ...
    returnValue.add(
        new OperationInterface("calculateQpAtFrequency", I18nKeys.GET_QUASI_PEAK_AT_FREQ) {
          @Override
          public Object doOperation(final Object parameterValue) {
    ...
    returnValue.add(
        new OperationInterface("calculatePeakAtFrequency", I18nKeys.GET_PEAK_AT_FREQ) {
          @Override
          public Object doOperation(final Object parameterValue) {
            if (!(parameterValue instanceof Number)) {
              throw new IllegalArgumentException("parameter type must be numeric!");
            ...
            checkForValidTestReceiver();
            return _testReceiverNew.calculatePeakAtFrequency(
                ((Number) parameterValue).doubleValue());
          }
        });

    returnValue.add(
        new OperationInterface("calculateAvgAtFrequency", I18nKeys.GET_AVG_AT_FREQ) {
          @Override
          public Object doOperation(final Object parameterValue) {
            if (!(parameterValue instanceof Number)) {
              throw new IllegalArgumentException("parameter type must be numeric!");
            ...
            checkForValidTestReceiver();
            return _testReceiverNew.calculateAvgAtFrequency(
                ((Number) parameterValue).doubleValue());
          }
        });
  ...
  private class CisprCalculator extends AbstractControlCalculatable implements MemoryInitializable {
    ...
    public void doInit(final double deltaT) {
      try {
        _zvDatenRam =
            DataContainerSimple.fabricConstantDtTimeSeries(
                1,
                (int) ((SimulationsKern.tEND - SimulationsKern.tSTART) / deltaT) + DATA_INDEX_ADD);
  ...
  public void drawBlockRectangle(final Graphics2D graphics) {
    ...
    graphics.fillRect(
        (int) (dpix * (xPos - WIDTH)),
        (int) (dpix * (yPos - DA_OFFSET)),
        (int) (dpix * (WIDTH + DA_OFFSET)),
        (int) (dpix * (WIDTH + DA_OFFSET)));
    ...
    graphics.drawRect(
        ...
        (int) (dpix * (WIDTH + DA_OFFSET)));
    graphics.drawRect(
        (int) (dpix * (xPos - WIDTH)) + DI_OFFSET,
        (int) (dpix * (yPos - DA_OFFSET)) + DI_OFFSET,
        (int) (dpix * (WIDTH + DA_OFFSET)) - 2 * DI_OFFSET,
        (int) (dpix * (WIDTH + DA_OFFSET)) - 2 * DI_OFFSET);
    //
    int a1 = DI_OFFSET + 4, a2 = DI_OFFSET + 2;
    graphics.drawLine(
        (int) (dpix * (xPos - WIDTH) + a2),
        (int) (dpix * (yPos + WIDTH) - a1),
        (int) (dpix * (xPos + DA_OFFSET) - a2),
        (int) (dpix * (yPos + WIDTH) - a1)); // waagrechte Achse
    graphics.drawLine(
        (int) (dpix * (xPos - WIDTH) + a1),
        (int) (dpix * (yPos - DA_OFFSET) + a2),
        (int) (dpix * (xPos - WIDTH) + a1),
        (int) (dpix * (yPos + WIDTH) - a2)); // senkrechte Achse
    ...
    graphics.drawPolyline(
        new int[] {xk1, xk2, xk3, xk3, xk4}, new int[] {yk3, yk4, yk4, yk3, yk3}, 5);
  }
