...
class ReglerSignalSourceDialog extends AbstractDialogWithExternalOption<ReglerSignalSource> {
  ...
  private JCheckBox
      jCheckBoxShowDetails; // wieviel Info soll im SchematicEntry angezeigt werden (Uebersicht vs.
  // Info)?
  // Unterdialoge fuer Preview-SIGNAL -->
  private boolean displayDetails =
      false; // wieviel Info soll im SchematicEntry angezeigt werden (Uebersicht vs. Info)?
  ...
  protected void baueGuiIndividual() {
    ...
    parameterPanel =
        createParameterPanel(
            element._amplitudeAC,
            element._frequency,
            element._offsetDC,
            element._phase,
            element._dutyRatio);

    jComboShape.addActionListener(
        new ActionListener() {
          @Override
    ...
    jCheckBoxShowDetails.addActionListener(
        new ActionListener() {
