...
class ReglerSlidingDFTDialog extends DialogElementCONTROL<ReglerSlidingDFT> {
  ...
  void baueGuiIndividual() {
    ...
    _jButtonAddFreq.addActionListener(
        new ActionListener() {
          @Override
    ...
    _jButtonRemoveFreq.addActionListener(
        new ActionListener() {
          @Override
  ...
  public void processInputIndividual() {
    super
        .processInputIndividual(); // To change body of generated methods, choose Tools | Templates.
