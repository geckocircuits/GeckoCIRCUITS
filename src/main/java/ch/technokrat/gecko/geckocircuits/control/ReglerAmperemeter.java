...
public final class ReglerAmperemeter extends AbstractCurrentMeasurement {
  static ControlTypeInfo tinfo =
      new ControlTypeInfo(ReglerAmperemeter.class, "AMP", I18nKeys.CURRENT_MEASUREMENT_A);
  ...
  public void checkComponentCompatibility(
    ...
    if (testObject instanceof CurrentMeasurable) {
      ...
      insertList.addAll(
          Arrays.asList(measurable.getCurrentMeasurementComponents(ConnectorType.LK)));
    }
  }
