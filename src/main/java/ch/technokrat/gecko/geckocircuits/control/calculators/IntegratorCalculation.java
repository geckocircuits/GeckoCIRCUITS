...
public final class IntegratorCalculation extends AbstractControlCalculatable
  ...
  public IntegratorCalculation(
      final double constantFactor, final double initValue, final double min, final double max) {
    super(2, 1);
