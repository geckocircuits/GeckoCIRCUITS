...
public final class ReglerMUL extends AbstractReglerVariableInputs {
  static ControlTypeInfo tinfo =
      new ControlTypeInfo(ReglerMUL.class, "MUL", I18nKeys.MULTIPLICATION);
  ...
  protected void importIndividual(final TokenMap tokenMap) {
    ...
    if (YOUT.size()
        > 1) { // this is a weird bug... for old GeckoCIRCUITS models, there may be two output
      // terminal labels,
      // and therefore this was initialized wrong! I introduced this on 19.10.2012, maybe in the
      // future, this bugfix
