...
public final class ReglerTransferFunction extends AbstractReglerSingleInputSingleOutput
  ...
  public static final ControlTypeInfo tinfo =
      new ControlTypeInfo(
          ReglerTransferFunction.class,
          "TF",
          I18nKeys.TRANSFER_FUNKTION_H_S,
          I18nKeys.DEFINES_A_TRANSFER_FUNCTION);
  ...
  final UserParameter<Boolean> _inPolynomMode =
      UserParameter.Builder.<Boolean>start("polynomMode", false)
          .longName(I18nKeys.IF_TRUE_THEN_POLYNOM)
          .shortName("usePolynoms")
          .arrayIndex(this, -1)
          .build();
  final UserParameter<Boolean> _useInitialState =
      UserParameter.Builder.<Boolean>start("useInitState", false)
          .longName(I18nKeys.IF_TRUE_THEN_INITIAL)
          .arrayIndex(this, -1)
          .shortName("useInitState")
          .build();
  final UserParameter<Double> _constantFactor =
      UserParameter.Builder.<Double>start("constant", 1.0)
  ...
  private class TransferFunctionCalculator extends AbstractControlCalculatable
  ...
  public void copyAdditionalParameters(final AbstractBlockInterface originalBlock) {
    ...
    System.arraycopy(
        other._numeratorPolynom, 0, this._numeratorPolynom, 0, _numeratorPolynom.length);
  ...
  public List<OperationInterface> getOperationEnumInterfaces() {
    ...
    returnValue.add(
        new OperationInterface("setNumeratorPolynom", I18nKeys.SET_NUMERATOR_POLYNOM) {
          @Override
    ...
    returnValue.add(
        new OperationInterface("setDenominatorPolynom", I18nKeys.SET_DENOMINATOR_POLYNOM) {
          @Override
          public Object doOperation(final Object parameterValue) {
            final Double[] parameterArray = checkParameterType(parameterValue);
    ...
    returnValue.add(
        new OperationInterface("setPoles", I18nKeys.SET_POLE_COEFF) {
          @Override
          public Object doOperation(final Object parameterValue) {
    ...
    returnValue.add(
        new OperationInterface("setZeros", I18nKeys.SET_ZERO_COEFF) {
          @Override
          public Object doOperation(final Object parameterValue) {
            Double[] parameters = checkParameterType(parameterValue);
            for (int i = 0; i < parameters.length; i++) {
  ...
  private static Double[] checkParameterType(Object parameterValue) {
    ...
    throw new IllegalArgumentException(
        "Error: parameter must be a double[] array, but is"
            + " of type "
