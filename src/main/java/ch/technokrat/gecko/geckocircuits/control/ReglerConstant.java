...
public final class ReglerConstant extends RegelBlock {
  public static final ControlTypeInfo tinfo =
      new ControlTypeInfo(ReglerConstant.class, "CONST", I18nKeys.CONSTANT_VALUE);

  private static final String CONST_STR = "const";

  final UserParameter<Double> _constValue =
      UserParameter.Builder.<Double>start("constantValue", 1.0)
