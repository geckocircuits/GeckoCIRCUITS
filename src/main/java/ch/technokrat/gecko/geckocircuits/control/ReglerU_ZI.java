...
public final class ReglerU_ZI extends RegelBlock {
    ...
    protected void importIndividual(final TokenMap tokenMap) {
        _uziDisplay.jSpinnerLength1.setValue(tokenMap.readDataLine("scale1", (Float) _uziDisplay.jSpinnerLength1.getValue()));
        _uziDisplay.jSpinnerLength2.setValue(tokenMap.readDataLine("scale2", (Float) _uziDisplay.jSpinnerLength2.getValue()));
        _uziDisplay.jSpinnerZ1.setValue(tokenMap.readDataLine("scale3", (Float) _uziDisplay.jSpinnerZ1.getValue()));
        _uziDisplay.jSpinnerAverage1.setValue(tokenMap.readDataLine("average1", (Float) _uziDisplay.jSpinnerAverage1.getValue()));
        _uziDisplay.jSpinnerAverage2.setValue(tokenMap.readDataLine("average2", (Float) _uziDisplay.jSpinnerAverage2.getValue()));
        _uziDisplay.jSpinnerZ2.setValue(tokenMap.readDataLine("average3", (Float) _uziDisplay.jSpinnerZ2.getValue()));
    }
}
