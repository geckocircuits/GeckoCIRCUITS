    ...
    knOK.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(final ActionEvent actionEvent) {
            ...
            // 'OK'-Knopf oder 'Return'-Taste gedrueckt --> entsprechender Label des Elements wird
            // aktualisiert
            _label.setLabelFromUserDialog(_textField.getText());
            _clickedTerminal
                .getCircuitSheet()
                .updateRenamedLabel(_originalLabel, _textField.getText(), _conType);
