...
public class UZiDisplay extends GeckoDialog {
  ...
  private class DrawVector {
    ...
    public DrawVector(
        Color arrowColor, Color paintColor, JSpinner length, JSpinner average, JSpinner zSpinner) {
    ...
    private void setPlotVector(double u, double current) {
      ...
      if (average > 0) {
        ...
        for (int i = 0; i < averageSpan; i++) {
          spaceVectorReal +=
              averageHistoryRe[((int) (counter + HISTORY_BUFFER_SIZE - i)) % HISTORY_BUFFER_SIZE];
          spaceVectorImag +=
              averageHistoryIm[((int) (counter + HISTORY_BUFFER_SIZE - i)) % HISTORY_BUFFER_SIZE];
        }
      ...
      spaceVectorImagPos =
          (int) ((Float) _length.getValue() * spaceVectorImag * (Float) _zSpinner.getValue());
  ...
  private void initComponents() {
    ...
    jSpinnerZ1.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(1.0f), Float.valueOf(0.0f), null, Float.valueOf(0.1f)));
                    ...
                    .addGroup(
                        jPanel2Layout
                            ...
                            .addComponent(
                                ...
                                Short.MAX_VALUE)
                            .addComponent(
                                jLabel6, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE)
                            .addComponent(
                                jSpinnerZ1,
                                javax.swing.GroupLayout.Alignment.TRAILING,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
