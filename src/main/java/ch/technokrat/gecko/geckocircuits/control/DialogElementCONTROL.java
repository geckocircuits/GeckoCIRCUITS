...
public abstract class DialogElementCONTROL<T extends RegelBlock> extends DialogCircuitComponent<T> {
  ...
  public void baueGUI() {
    ...
    jpM.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(), "Parameter", TitledBorder.LEFT, TitledBorder.TOP));
  ...
  public static JPanel createComponentCouplingPanel(final AbstractBlockInterface couplingElement) {
    ...
    jpM.setBorder(
        BorderFactory.createTitledBorder(
            ...
            coupable.getCouplingTitle().getTranslation(),
            TitledBorder.LEFT,
            TitledBorder.TOP));
    ...
    final List<AbstractCircuitSheetComponent> allPossibleElements =
        couplingElement.getParentCircuitSheet().allElements;
    ...
    for (int i = 0; i < selectionList.size(); i++) {
      ...
      final AbstractBlockInterface connectedTo =
          coupable.getComponentCoupling()._coupledElements[0];
      if (connectedTo != null
          && selectionList.get(i).getStringID().equals(connectedTo.getStringID())) {
  ...
  private static void addSelectionComboListener(
      final JComboBox combo,
      final List<AbstractBlockInterface> selectionList,
        ...
        new ActionListener() {
          ...
          public void actionPerformed(final ActionEvent actionEvent) {
            if (combo.getSelectedIndex() < 0) {
              ...
              final AbstractBlockInterface selectedElement =
                  selectionList.get(combo.getSelectedIndex());
  ...
  private static final Comparator<AbstractBlockInterface> ALPHABETIC_SORT =
      new Comparator<AbstractBlockInterface>() {
        @Override
        public int compare(
            final AbstractBlockInterface first, final AbstractBlockInterface second) {
