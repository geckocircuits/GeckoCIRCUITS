...
/**
 * For some components, it makes sense to have a variable input number, e.g. adding, logic-or,
 * multiplication...
 *
 * @author andreas
 */
public abstract class AbstractReglerVariableInputs extends RegelBlock
    implements VariableTerminalNumber {

  private static final int DEFAULT_NUMBER_INPUTS = 1;

  public final UserParameter<Integer> _inputTerminalNumber =
      UserParameter.Builder.<Integer>start("anzXIN", DEFAULT_NUMBER_INPUTS)
