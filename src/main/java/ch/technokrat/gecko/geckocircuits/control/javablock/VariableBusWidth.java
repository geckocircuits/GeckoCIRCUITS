...
class VariableBusWidth {
  ...
  public VariableBusWidth(final ReglerJavaFunction parent) {
    ...
    _fixedOutputBusWidth =
        UserParameter.Builder.<Integer>start("outputBusWidth", 1)
    ...
    _fixedOutputBusEnabled =
        UserParameter.Builder.<Boolean>start("fixedBusEnabled", true)
    ...
    _useMatrix =
        UserParameter.Builder.<Boolean>start("useMatrix", false)
