...
public final class ReglerToEXTERNAL extends RegelBlockSimulink
    implements Comparable, VariableTerminalNumber {

  public static final ControlTypeInfo tinfo =
      new ControlTypeInfo(ReglerToEXTERNAL.class, "ToEXT", I18nKeys.EXPORT_DATA_TO_SIMULINK);
