...
public final class ReglerSmallSignalAnalysis extends RegelBlock {
  ...
  public static final ControlTypeInfo TYPE_INFO =
      new ControlTypeInfo(
          ReglerSmallSignalAnalysis.class, "ANALYSIS", I18nKeys.SMALL_SIGNAL_ANALYIS);

  private final int BLOCK_WIDTH = 6;

  final UserParameter<Double> _amplitude =
      UserParameter.Builder.<Double>start("Amplitude", DEFAULT_AMPLITUDE)
  ...
  final UserParameter<Double> _fBase =
      UserParameter.Builder.<Double>start("StartFreq", DEFAULT_FREQ_START)
  ...
  final UserParameter<Double> _fMax =
      UserParameter.Builder.<Double>start("EndFreq", DEFAULT_FREQ_END)
  ...
  final UserParameter<SSAShape> _signalType =
      UserParameter.Builder.<SSAShape>start("signalTypeNew", SSAShape.RECTANGLE)
  ...
  public final UserParameter<Boolean> _doAddOutput =
      UserParameter.Builder.<Boolean>start("addOutput", false)
          .longName(I18nKeys.IF_TRUE_USE_NONLINEAR_CHARACTERISTIC)
          .shortName("addOutput")
          .arrayIndex(this, -1)
          .build();

  TerminalControlInputWithLabel externalExcitationTerm =
      new TerminalControlInputWithLabel(this, -4, -2, "excitation");
  ...
  public AbstractControlCalculatable getInternalControlCalculatableForSimulationStart() {
    ...
    SmallSignalCalculator lastCalculator =
        new SmallSignalCalculator(
            _amplitude.getValue(),
            _fBase.getValue(),
            _fMax.getValue(),
            _signalType.getValue(),
            XIN.size(),
            YOUT.size(),
            _doAddOutput.getValue());
