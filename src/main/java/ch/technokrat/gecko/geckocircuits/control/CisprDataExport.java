...
public class CisprDataExport extends GeckoDialog {
  ...
  public CisprDataExport(
      final TestReceiverWindow parent,
      final Cispr16Settings settings,
    ...
    jTextFieldFile.setText(
        GeckoFileChooser.calculateCheckedCurrentDirectory(null)
            .getAbsolutePath()
            .replace(".ipes", ".txt"));
  }
  ...
  private void initComponents() {
    ...
    jButtonSaveDB.addActionListener(
    ...
    jButtonSaveVolts.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadioButtonPeak.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void jButtonSaveDBActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonSaveDBActionPerformed
    doSave(true);
    this.setVisible(false);
  } // GEN-LAST:event_jButtonSaveDBActionPerformed

  private void jRadioButtonPeakActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jRadioButtonPeakActionPerformed
    this.setVisible(false);
  ...
  private void jButtonSaveVoltsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonSaveVoltsActionPerformed
    doSave(false);
    this.setVisible(false);
