...
public class SubCircuitSheet extends CircuitSheet {
  ...
  public SubCircuitSheet(SchematischeEingabe2 se, SubcircuitBlock subBlock) {
    ...
    _upButton.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            SchematischeEingabe2.Singleton.setNewVisibleCircuitSheet(
                _subBlock.getParentCircuitSheet());
          }
        });
    ...
    _settingsButton.addActionListener(
        new ActionListener() {
    ...
    _newTerminalButton.setToolTipText(
        "<html>Create a new subcircuit terminal. Depending<br>on the component selection tab a circuit,<br>"
            + " control, or thermal terminal will be created.</html>");
    _newTerminalButton.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            switch (SchematischeEingabe2.Singleton.wireModeVersteckt) {
              ...
              case SchematischeEingabe2.WIRE_MODE_THERM:
                newElement =
                    AbstractTypeInfo.fabricNew(
                        AbstractTypeInfo.getTypeInfoFromClass(TerminalCircuit.class));
                break;
              case SchematischeEingabe2.WIRE_MODE_CONTROL:
                newElement =
                    AbstractTypeInfo.fabricNew(
                        AbstractTypeInfo.getTypeInfoFromClass(ReglerTERMINAL.class));
                break;
              default:
                assert false;
            }
        ...
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            JOptionPane.showMessageDialog(
                GeckoSim._win,
                "The subcircuit block can be used to create hierarchical circuit structures.\n"
