...
public final class ReglerPI extends AbstractReglerSingleInputSingleOutput {
  public static final ControlTypeInfo tinfo =
      new ControlTypeInfo(ReglerPI.class, "PI", I18nKeys.PI_CONTROL);

  public final UserParameter<Double> _r0 =
      UserParameter.Builder.<Double>start("r0", -1.0)
          .longName(I18nKeys.GAIN)
          .shortName("r0")
          .showInTextInfo(TextInfoType.SHOW_WHEN_DISPLAYPARAMETERS)
          .arrayIndex(this, 0)
          .build();
  public final UserParameter<Double> _a1 =
      UserParameter.Builder.<Double>start("a1", -1.0)
          ...
          .arrayIndex(this, 1)
          .build();
  public final UserParameter<Double> _TimeConstant =
      UserParameter.Builder.<Double>start("T_Value", 1.0)
  ...
  private final ActionListener _updateA1Value =
      new ActionListener() {
        @Override
  ...
  private final ActionListener _updateR0Value =
      new ActionListener() {
        @Override
        public void actionPerformed(final ActionEvent event) {
          if (_calculator instanceof PICalculator) {
  ...
  private final ActionListener _updateTValue =
      new ActionListener() {
        @Override
        public void actionPerformed(final ActionEvent event) {
