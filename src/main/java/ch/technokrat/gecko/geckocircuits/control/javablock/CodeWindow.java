...
public final class CodeWindow extends javax.swing.JFrame {
  ...
  public CodeWindow(final ReglerJavaFunction regelBlock, final StringBuffer outputStringBuffer) {
    ...
    ActionListener tableVisibleListener =
        new ActionListener() {
          @Override
    ...
    jCheckBoxMatrix.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    jSpinnerFixedOutputBus.addChangeListener(
        new ChangeListener() {
          @Override
          public void stateChanged(ChangeEvent e) {
            _variableBusWidth._fixedOutputBusWidth.setUserValue(
                (Integer) jSpinnerFixedOutputBus.getValue());
          }
        });
  ...
  private static final KeyListener keyPressedSetModelDirty =
      new KeyListener() {
  ...
  private void setMatrixCodeWindow(boolean selected) {
    if (selected) {
      ((TitledBorder) jPanelCode.getBorder())
          .setTitle("public double[][] calculateYOUT(double[][] xIN, double time, double dt) {");
    } else {
      ((TitledBorder) jPanelCode.getBorder())
          .setTitle("public double[] calculateYOUT(double[] xIN, double time, double dt) {");
    }
  ...
  private void addBusTable() {
    ...
    class SpinnerEditor extends AbstractCellEditor implements TableCellEditor {
      ...
      public Component getTableCellEditorComponent(
          JTable table, Object value, boolean isSelected, final int row, final int column) {
  ...
  private class OutputUpdate implements Runnable {
    ...
    public void run() {
      ...
      do {
        if (jTabbedPane.getSelectedIndex() == OUTPUT_TAB_NO
            && jTextAreaOutput.isEnabled()
  ...
  private void initComponents() {
    ...
    jButtonCompile.addActionListener(
    ...
    jButtonCloseWindow.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jPanelImports.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1),
            "Imports",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
            javax.swing.border.TitledBorder.DEFAULT_POSITION,
            new java.awt.Font("Dialog", 1, 10))); // NOI18N
    ...
    jPanelStaticInit.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1),
            "Initialization code (executed at simulation start)",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
            javax.swing.border.TitledBorder.DEFAULT_POSITION,
            new java.awt.Font("Dialog", 1, 10))); // NOI18N
    ...
    jPanelCode.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1),
            "public double[] calculateYOUT(double[] xIN, double time, double dt) {",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
            javax.swing.border.TitledBorder.DEFAULT_POSITION,
            new java.awt.Font("Dialog", 1, 10))); // NOI18N
    ...
    jPanelCompilerSource.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1),
    ...
    jPanelCompilerOutput.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1),
            "Compiler messages",
            javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    javax.swing.GroupLayout jPanelCompilerMessagesLayout =
        new javax.swing.GroupLayout(jPanelCompilerMessages);
    jPanelCompilerMessages.setLayout(jPanelCompilerMessagesLayout);
    jPanelCompilerMessagesLayout.setHorizontalGroup(
        jPanelCompilerMessagesLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    jButtonExample2.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonExample1.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jPanel4Layout.linkSize(
        ...
        new java.awt.Component[] {jButtonExample1, jButtonExample2});
        ...
        jPanel4Layout
            ...
            .addGroup(
                jPanel4Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 492, Short.MAX_VALUE)
    ...
    jRadioButtonConsole.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadioButtonWindow.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jCheckBoxClear.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jPanel2Layout
            ...
            .addGroup(
                jPanel2Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 358, Short.MAX_VALUE)));
    ...
    jButtonExternalFiles.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadioButtonFixedBus.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jSpinnerFixedOutputBus.setModel(
    ...
    jTable1.setModel(
        new javax.swing.table.DefaultTableModel(
            ...
            new String[] {"Index", "Label", "Bus width"}));
    ...
    jCheckBoxShowName.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jTextFieldName.addPropertyChangeListener(
        ...
        layout
            ...
            .addGroup(
                ...
                layout
                    .createSequentialGroup()
                    .addComponent(
                        jTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 562, Short.MAX_VALUE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(
                        layout
                            .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
  ...
  private void jButtonCloseWindowActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonCloseWindowActionPerformed
    loadCodeIntoRegler();
    this.dispose();
  } // GEN-LAST:event_jButtonCloseWindowActionPerformed

  private void jButtonExample2ActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonExample2ActionPerformed
  ...
  private void jButtonExample1ActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonExample1ActionPerformed
  ...
  private void jButtonAutoIndentActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonAutoIndentActionPerformed
  } // GEN-LAST:event_jButtonAutoIndentActionPerformed

  private void jCheckBoxShowNameActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jCheckBoxShowNameActionPerformed
    _javaFunction.setNameVisible(jCheckBoxShowName.isSelected());
  } // GEN-LAST:event_jCheckBoxShowNameActionPerformed

  private void jTextFieldNamePropertyChange(
      java.beans.PropertyChangeEvent evt) { // NOPMD//GEN-FIRST:event_jTextFieldNamePropertyChange
  ...
  private void jButtonCompileActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonCompileActionPerformed
    jTabbedPane.setSelectedIndex(1);
    loadCodeIntoRegler();
  } // GEN-LAST:event_jButtonCompileActionPerformed

  private void jRadioButtonWindowActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadioButtonWindowActionPerformed
    toggleOutputDirection();
  } // GEN-LAST:event_jRadioButtonWindowActionPerformed

  private void jRadioButtonConsoleActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadioButtonConsoleActionPerformed
    toggleOutputDirection();
  } // GEN-LAST:event_jRadioButtonConsoleActionPerformed

  private void jButtonCancelActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonCancelActionPerformed
    this.dispose();
  } // GEN-LAST:event_jButtonCancelActionPerformed

  private void jCheckBoxClearActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxClearActionPerformed
    _javaFunction.setClearOutput(jCheckBoxClear.isSelected());
  } // GEN-LAST:event_jCheckBoxClearActionPerformed

  private void jCheckBoxMatrixActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxMatrixActionPerformed
  ...
  private void jButtonExternalFilesActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonExternalFilesActionPerformed
    if (!_extWindowInit) {
  ...
  private void jRadioButtonFixedBusActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jRadioButtonFixedBusActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_jRadioButtonFixedBusActionPerformed

  private void loadCodeIntoRegler() {
    final JavaBlockSource newSource =
        new JavaBlockSource.Builder()
