...
class ReglerVOLTDialog extends DialogElementCONTROL {
  ...
  protected void baueGuiIndividual() {
    ...
    for (AbstractBlockInterface block :
        element
            ...
            .allElements
            .getClassFromContainer(AbstractBlockInterface.class)) {
    ...
    if (testCombo instanceof JComboBox) {
      ...
      dpvm.jComboBoxLabel1.addActionListener(
          new ActionListener() {
      ...
      componentCombo.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
    ...
    dpvm.jComboBoxLabel2.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent ae) {
            ...
            if (dpvm.jComboBoxLabel2.getSelectedItem() != null) {
              ...
              ((PotentialCoupable) element)
                  .getPotentialCoupling()
                  .setNewCouplingLabelUserDialog(1, newLabel);
              parStr[2] = "";
            }
          }
        });
  ...
  public void processInputs() {
    if (dpvm.jComboBoxLabel1.getSelectedItem() != null) {
      ...
      ((ComponentCoupable) element)
          .getComponentCoupling()
          .setNewCouplingElementInvisibleUndoable(0, null);
      ((PotentialCoupable) element)
          .getPotentialCoupling()
          .setNewCouplingLabelUserDialog(0, newLabel);
    }
