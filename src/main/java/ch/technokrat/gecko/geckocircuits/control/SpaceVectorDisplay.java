...
public class SpaceVectorDisplay extends javax.swing.JFrame {
  ...
  private class SpaceVector {
    ...
    private void setSpaceVector(final double r, final double s, double t) {
      ...
      if (old_spaceVectorImagPos != spaceVectorImagPos
          || old_spaceVectorRealPos != spaceVectorRealPos) {
        ...
        if (jRadioButtonLine.isSelected()) {
          offGraph.drawLine(
              spaceVectorRealPos,
              spaceVectorImagPos,
              old_spaceVectorRealPos,
              old_spaceVectorImagPos);
        }
  ...
  private void initComponents() {
    ...
    jPanel2.setBorder(
        javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(254, 1, 1)));

    jSpinnerLength1.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(1.0f), Float.valueOf(0.0f), null, Float.valueOf(1.0f)));

    jLabel1.setText("Scaling");

    jSpinnerAverage1.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(0.0f), Float.valueOf(0.0f), null, Float.valueOf(0.1f)));
                ...
                jPanel2Layout
                    ...
                    .addGroup(
                        jPanel2Layout
                            ...
                            .addComponent(
                                jSpinnerLength1, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(
                                jLabel3,
                                ...
                                Short.MAX_VALUE)
                            .addComponent(
                                jSpinnerAverage1, javax.swing.GroupLayout.Alignment.TRAILING))
                    .addContainerGap()));
    ...
    jToggleButtonClose.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jPanel3.setBorder(
        javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(51, 51, 255)));

    jSpinnerLength2.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(1.0f), Float.valueOf(0.0f), null, Float.valueOf(1.0f)));

    jLabel4.setText("Scaling");

    jSpinnerAverage2.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(0.0f), Float.valueOf(0.0f), null, Float.valueOf(0.1f)));
                ...
                jPanel3Layout
                    ...
                    .addGroup(
                        jPanel3Layout
                            ...
                            .addComponent(
                                jSpinnerLength2, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(
                                jLabel5,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                Short.MAX_VALUE)
                            .addComponent(
                                jSpinnerAverage2, javax.swing.GroupLayout.Alignment.TRAILING))
                    .addContainerGap()));
    ...
    jPanel4.setBorder(
        javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(0, 204, 51)));

    jSpinnerLength3.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(1.0f), Float.valueOf(0.0f), null, Float.valueOf(1.0f)));

    jLabel6.setText("Scaling");

    jSpinnerAverage3.setModel(
        new javax.swing.SpinnerNumberModel(
            Float.valueOf(0.0f), Float.valueOf(0.0f), null, Float.valueOf(0.1f)));
                ...
                jPanel4Layout
                    ...
                    .addGroup(
                        jPanel4Layout
                            ...
                            .addComponent(
                                jSpinnerLength3, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(
                                jLabel7,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                Short.MAX_VALUE)
                            .addComponent(
                                jSpinnerAverage3, javax.swing.GroupLayout.Alignment.TRAILING))
                    .addContainerGap()));
  ...
  private void jButtonClearActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonClearActionPerformed
    clearDisplay();
    repaint();
  } // GEN-LAST:event_jButtonClearActionPerformed

  private void jToggleButtonCloseActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jToggleButtonCloseActionPerformed
  ...
  //                Logger.getLogger(SpaceVectorDisplay.class.getName()).log(Level.SEVERE, null,
  // ex);
  //            }
  //        }
  //
