...
public final class JavaBlockClassLoader extends URLClassLoader {
  ...
  public JavaBlockClassLoader(final Map<String, CompiledClassContainer> classMap) {
    /**
     * be careful here! At the beginning, I tried the ClassLoader.getSystemClassLoader() as parent
     * for this classLoader. This works, but when GeckoCIRCUITS is run as applet in the browser, the
     * classloader won't find ControlCalculatable.jar. But, when using the getContextClassLoader(),
     * it will work.
     */
