...
final class DialogReglerVariableInputs extends DialogElementCONTROL {
  ...
  protected void processInputs() {
    ((AbstractReglerVariableInputs) element)
        ._inputTerminalNumber.setUserValue((Integer) _spinnerInputNumber.getValue());
  }
  ...
  protected void baueGuiIndividual() {
    SpinnerModel spinnerModel =
        new javax.swing.SpinnerNumberModel(
            Integer.valueOf(element.XIN.size()), Integer.valueOf(2), null, Integer.valueOf(1));
