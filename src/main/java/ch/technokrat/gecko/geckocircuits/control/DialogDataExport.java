...
public final class DialogDataExport extends javax.swing.JDialog {
  ...
  public DialogDataExport(
      final java.awt.Frame parent,
      final boolean modal,
      final ReglerSaveData dataSavable,
      final List<AbstractDataContainer> selectContainers,
      final DataSaver _parentDataSaver) {
    super(parent, modal);
  ...
  private void init() {
    ...
    _selectedModel.addListDataListener(
  ...
  private void initComponents() {
    ...
    jComboBoxFilter.setModel(
        new javax.swing.DefaultComboBoxModel(
            new String[] {"Item 1", "Item 2", "Item 3", "Item 4"}));
    jComboBoxFilter.addPropertyChangeListener(
    ...
    jButtonTable.addActionListener(
    ...
    jRadButtOverwrite.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadButtDoNumber.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadButtManSave.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadButtEndSave.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadButtContinSav.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jCheckBoxTranspose.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jComboSeparator.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jCheckPrintHdr.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jComboHeaderSym.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jSpinnerDigits.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    jRadioBinary.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
                                    ...
                                    .addGroup(
                                        ...
                                        jPanel1Layout
                                            ...
                                            .addComponent(
                                                ...
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(
                                        jCheckPrintHdr, javax.swing.GroupLayout.Alignment.LEADING)))
                    .addContainerGap(132, Short.MAX_VALUE)));

    jPanel1Layout.linkSize(
        javax.swing.SwingConstants.HORIZONTAL,
        new java.awt.Component[] {jComboHeaderSym, jComboSeparator, jSpinnerDigits});
        ...
        jPanel4Layout
            ...
            .addGroup(
                jPanel4Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 286, Short.MAX_VALUE)
                    .addContainerGap()));
    ...
    jButtonDoSave.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
            jButtonSaveData(evt);
          }
    ...
    jTxtFildFileName.addKeyListener(
    ...
    jButtonAbort.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void jButtonSaveData(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonSaveData

    _dataSaver = new DataSaver(_containers.get(0), _reglerDataSave);

    _dataSaver.addObserver(
        new Observer() {
  ...
  private void jRadioBinaryActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadioBinaryActionPerformed
    switchBinaryTxt();
  } // GEN-LAST:event_jRadioBinaryActionPerformed

  private void jRadioTextActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadioTextActionPerformed
    switchBinaryTxt();
  } // GEN-LAST:event_jRadioTextActionPerformed

  private void jButtonCloseActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonCloseActionPerformed
    dispose();
  } // GEN-LAST:event_jButtonCloseActionPerformed

  private void jComboBoxFilterPropertyChange(
      java.beans.PropertyChangeEvent evt) { // NOPMD//GEN-FIRST:event_jComboBoxFilterPropertyChange
  } // GEN-LAST:event_jComboBoxFilterPropertyChange

  private void jButtonAbortActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonAbortActionPerformed
    if (_dataSaver != null) {
      _dataSaver.abortSave();
    }
  } // GEN-LAST:event_jButtonAbortActionPerformed

  private void jTxtFildFileNameKeyReleased(
      java.awt.event.KeyEvent evt) { // NOPMD//GEN-FIRST:event_jTxtFildFileNameKeyReleased
    _reglerDataSave._file.setUserValue(jTxtFildFileName.getText());
  } // GEN-LAST:event_jTxtFildFileNameKeyReleased

  private void jCheckPrintHdrActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jCheckPrintHdrActionPerformed
    if (_initDone) {
      _reglerDataSave._printHeader.setUserValue(jCheckPrintHdr.isSelected());
    }
  } // GEN-LAST:event_jCheckPrintHdrActionPerformed

  private void jSpinnerDigitsStateChanged(
      javax.swing.event.ChangeEvent evt) { // NOPMD//GEN-FIRST:event_jSpinnerDigitsStateChanged
    if (_initDone) {
      _reglerDataSave._significDigits.setUserValue((Integer) jSpinnerDigits.getValue());
    }
  } // GEN-LAST:event_jSpinnerDigitsStateChanged

  private void jComboSeparatorActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jComboSeparatorActionPerformed
    if (_initDone) {
  ...
  private void jComboHeaderSymActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jComboHeaderSymActionPerformed
    if (_initDone) {
      _reglerDataSave._headerSymbol = (HeaderSymbol) jComboHeaderSym.getSelectedItem();
    }
  } // GEN-LAST:event_jComboHeaderSymActionPerformed

  private void jRadButtManSaveActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadButtManSaveActionPerformed
    setSaveModus();
  } // GEN-LAST:event_jRadButtManSaveActionPerformed

  private void jRadButtEndSaveActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadButtEndSaveActionPerformed
    setSaveModus();
  } // GEN-LAST:event_jRadButtEndSaveActionPerformed

  private void jRadButtContinSavActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadButtContinSavActionPerformed
    setSaveModus();
  } // GEN-LAST:event_jRadButtContinSavActionPerformed

  private void jRadButtOverwriteActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadButtOverwriteActionPerformed
    switchOverwrite();
  } // GEN-LAST:event_jRadButtOverwriteActionPerformed

  private void jRadButtDoNumberActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadButtDoNumberActionPerformed
    switchOverwrite();
  } // GEN-LAST:event_jRadButtDoNumberActionPerformed

  private void jSpinnerSkipStateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_jSpinnerSkipStateChanged
    if (_initDone) {
      _reglerDataSave._skipDataPoints.setUserValue((Integer) jSpinnerSkip.getValue());
    }
  } // GEN-LAST:event_jSpinnerSkipStateChanged

  private void jButtonTableActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonTableActionPerformed
    DataTableFrame dtf = new DataTableFrame(NetzlisteCONTROL.globalData, this);
    dtf.setVisible(true);
  } // GEN-LAST:event_jButtonTableActionPerformed

  private void jCheckBoxTransposeActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jCheckBoxTransposeActionPerformed
