...
/**
 * Der internen Zaehler kann durch den zweiten (unteren) RESET-Eingang auf '0' zurueckgesetzt
 * werden: solange der RESET-Eingang auf Null steht, ist der interne Zaehle auf Null gesetzt, sobald
 * der RESET-Eingang auf Eins gesetzt wird, beginnt der interne Zaehler zu laufen und wird direkt am
 * Ausgang ausgegeben
 *
 * @author andreas
 */
