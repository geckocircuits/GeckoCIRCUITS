...
/**
 * Class permits the compilation without a physical existing file (e.g. when loaded from Applet. The
 * Java-Compiler gets a handle to RamJavaFileObjects, where it writes its output bytes and / or the
 * compilation status/error messages
 *
 * @author andreas
 */
