...
public final class DialogTransferFunction extends javax.swing.JFrame {
  ...
  private void toggleMode() {
    ...
    if (_inPolynomialMode == jRadButtPoly.isSelected()
        || !_inPolynomialMode == jRadButtPoleMode.isSelected()) {
  ...
  private void updateTransferViewPoleZero() {
    ...
    final List<Double> nomPolynom =
        PolynomTools.evaluateFactorizedExpression(zeros, jTextFieldConst.getNumberFromField());
  ...
  private void addListeners() {
    ...
    jListNom.addListSelectionListener(
        new ListSelectionListener() {
  ...
  private void initComponents() {
    ...
    jButtonAddNom.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonDelNom.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonEditNom.setEnabled(false);
    jButtonEditNom.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                jPanelNumeratorLayout
                    ...
                    .addGroup(
                        jPanelNumeratorLayout
                            ...
                            .addComponent(
                                jTFInsertNumIm, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(
                                jButtonDelNom,
    ...
    jPanelNumeratorLayout.linkSize(
        javax.swing.SwingConstants.HORIZONTAL,
        new java.awt.Component[] {jButtonAddNom, jTFInsertNumIm, jTFInsertNumberRe});

    jPanelNumeratorLayout.linkSize(
        javax.swing.SwingConstants.HORIZONTAL,
        new java.awt.Component[] {jButtonDelNom, jButtonEditNom});
    ...
    jButtonDelNom1.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonAddDenom.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtAddDenomEdit.setEnabled(false);
    jButtAddDenomEdit.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    javax.swing.GroupLayout jPanelDenominatorLayout =
        new javax.swing.GroupLayout(jPanelDenominator);
    jPanelDenominator.setLayout(jPanelDenominatorLayout);
    jPanelDenominatorLayout.setHorizontalGroup(
        jPanelDenominatorLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                ...
                jPanelDenominatorLayout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(
                        jPanelDenominatorLayout
                            ...
                            .addComponent(
                                jTFInsertDeNumIm, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(
                                jButtAddDenomEdit,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    jCheckBoxEnabled.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadButtPoleMode.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadButtPoly.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonSaveState.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jCheckBoxInitial.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jTextFieldConst.addKeyListener(
        new java.awt.event.KeyAdapter() {
          public void keyReleased(java.awt.event.KeyEvent evt) {
  ...
  private void jButtonAddNomActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonAddNomActionPerformed
  ...
  private void jButtonDelNomActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonDelNomActionPerformed
  ...
  private void jButtonAddDenomActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonAddDenomActionPerformed
  ...
  private void jButtonDelNom1ActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonDelNom1ActionPerformed
  ...
  private void jButtonOKActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonOKActionPerformed
    this.dispose();
  } // GEN-LAST:event_jButtonOKActionPerformed

  private void jButtAddDenomEditActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtAddDenomEditActionPerformed
    ...
    final NComplex value =
        new NComplex(
            new Float(jTFInsertDeNum.getText()), Math.abs(new Float(jTFInsertDeNumIm.getText())));
  ...
  private void jButtonEditNomActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonEditNomActionPerformed
    ...
    final NComplex value =
        new NComplex(
            new Float(jTFInsertNumberRe.getText()), Math.abs(new Float(jTFInsertNumIm.getText())));
  ...
  private void jRadButtPoleModeActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadButtPoleModeActionPerformed
    toggleMode();
  } // GEN-LAST:event_jRadButtPoleModeActionPerformed

  private void jRadButtPolyActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jRadButtPolyActionPerformed
    toggleMode();
  } // GEN-LAST:event_jRadButtPolyActionPerformed

  private void jTextFieldNameKeyReleased(
      java.awt.event.KeyEvent evt) { // NOPMD//GEN-FIRST:event_jTextFieldNameKeyReleased
    try {
  ...
  private void jCheckBoxEnabledActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jCheckBoxEnabledActionPerformed
  ...
  private void jTextFieldConstKeyReleased(
      java.awt.event.KeyEvent evt) { // NOPMD//GEN-FIRST:event_jTextFieldConstKeyReleased
    _reglerTF._constantFactor.setUserValue(jTextFieldConst.getNumberFromField());
    updateTransferView();
  } // GEN-LAST:event_jTextFieldConstKeyReleased

  private void jCheckBoxInitialActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jCheckBoxInitialActionPerformed
    if (_initDone) {
      _reglerTF._useInitialState.setUserValue(jCheckBoxInitial.isSelected());
    }
  } // GEN-LAST:event_jCheckBoxInitialActionPerformed

  private void jButtonSaveStateActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonSaveStateActionPerformed
    _reglerTF.saveState();
