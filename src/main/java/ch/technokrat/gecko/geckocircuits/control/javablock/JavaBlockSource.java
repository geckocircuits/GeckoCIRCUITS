...
/**
 * Immutable class, which holds the java control block source code. Imutability makes comparisons
 * easier for equality. Builder pattern is used for object construction, see Joshua Bloch's book
 * "effective java".
 *
 * @author andreas
 */
