...
public final class ReglerGreaterEqual extends SimpleRegelBlock {
  public static final ControlTypeInfo tinfo =
      new ControlTypeInfo(ReglerGreaterEqual.class, "GE", I18nKeys.GREATER_EQUAL);
  ...
  public I18nKeys[] getOutputDescription() {
    return new I18nKeys[] {I18nKeys.GREATER_EQUAL_OUTPUT};
  }

  @Override
  public AbstractControlCalculatable getInternalControlCalculatableForSimulationStart() {
    return new GreaterEqualCalculator();
  }

  @Override
  String getDialogMessage() {
    return "<html>x1 >= x2  ...  y1 = 1<br>" + "x1 <  x2  ...  y1 = 0</html>";
  }
}
