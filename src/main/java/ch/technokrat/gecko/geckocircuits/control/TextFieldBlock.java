...
public final class TextFieldBlock extends AbstractSpecialBlock implements Operationable {
  ...
  public static final ControlTypeInfo tInfo =
      new ControlTypeInfo(TextFieldBlock.class, "TEXT", I18nKeys.TEXT_FIELD);
  ...
  final UserParameter<String> _titleText =
      UserParameter.Builder.<String>start("title_string", "Title")
          .longName(I18nKeys.TITLE_TEXT)
          .shortName("title")
          .showInTextInfo(TextInfoType.SHOW_NEVER)
          .arrayIndex(this, -1)
          .build();
  final UserParameter<String> _contentsText =
      UserParameter.Builder.<String>start("contents_string", "")
          .longName(I18nKeys.CONTENTS_TEXT)
          .shortName("contents")
          .showInTextInfo(TextInfoType.SHOW_NEVER)
          .arrayIndex(this, -1)
          .build();
  final UserParameter<Double> _height =
      UserParameter.Builder.<Double>start("hoehe", DEFAULT_HEIGHT)
          .longName(I18nKeys.X_BLOCK_DIMENSION)
          .shortName("height")
          .showInTextInfo(TextInfoType.SHOW_NEVER)
          .arrayIndex(this, -1)
          .build();
  final UserParameter<Double> _width =
      UserParameter.Builder.<Double>start("box_breite", DEFAULT_WIDTH)
          .longName(I18nKeys.Y_BLOCK_DIMENSION)
          .shortName("width")
          .showInTextInfo(TextInfoType.SHOW_NEVER)
          .arrayIndex(this, -1)
          .build();
  final UserParameter<Color> _backGroundColor =
      UserParameter.Builder.<Color>start(
              "back_color", new Color(DEFAULT_COLOR_INT, DEFAULT_COLOR_INT, DEFAULT_COLOR_INT))
          .longName(I18nKeys.BACKGROUND_COLOR)
          .shortName("backColor")
          .showInTextInfo(TextInfoType.SHOW_NEVER)
          .arrayIndex(this, -1)
          .build();
  final UserParameter<Color> _fontColor =
      UserParameter.Builder.<Color>start(
              "font_color", new Color(FONT_COLOR_INT, FONT_COLOR_INT, FONT_COLOR_INT))
  ...
  private final ActionListener _repaintParentAction =
      new ActionListener() {
        @Override
  ...
  protected void paintIndividualComponent(final Graphics2D graphics) {
    ...
    try {
      ...
      graphics.fillRect(
          rectPosX, rectPosY, (int) (dpix * (1.333 * width)), (int) (dpix * (3.6 * height)));
      ...
      for (String lineString : split) {
        final int stringPosY =
            lineCounter * (graphics.getFont().getSize() + 1) + (int) (rectPosY + dpix);
  ...
  public List<Operationable.OperationInterface> getOperationEnumInterfaces() {
    final List<Operationable.OperationInterface> returnValue =
        new ArrayList<Operationable.OperationInterface>();

    returnValue.add(
        new Operationable.OperationInterface("setTitle", I18nKeys.SET_TITLE) {
          @Override
    ...
    returnValue.add(
        new Operationable.OperationInterface("getTitle", I18nKeys.GET_TITLE) {
          @Override
          public Object doOperation(final Object parameterValue) {
    ...
    returnValue.add(
        new Operationable.OperationInterface("setText", I18nKeys.SET_TEXT) {
          @Override
          public Object doOperation(final Object parameterValue) {
    ...
    returnValue.add(
        new Operationable.OperationInterface("getText", I18nKeys.GET_TEXT) {
          @Override
          public Object doOperation(final Object parameterValue) {
