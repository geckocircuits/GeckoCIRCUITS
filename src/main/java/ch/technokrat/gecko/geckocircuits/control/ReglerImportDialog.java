...
class ReglerImportDialog extends DialogElementCONTROL<ReglerSignalSource> {
  ...
  private FormatJTextField
      jtfImportStatus; // fuer das Importieren externer Zeitverlaeufe, die dann vom SIGNAL-Block
  // ausgegeben werden
    ...
    jbImport.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent ae) {
            ...
            GeckoFileManagerWindow fileManager =
                new GeckoFileManagerWindow(element, ".dat", "Data file, space-separated", true);
