...
public final class Cispr16Settings {
  ...
  public Cispr16Settings(final ReglerCISPR16 regler) {
    ...
    _peak =
        UserParameter.Builder.<Boolean>start("calcPeak", true)
    ...
    _qpeak =
        UserParameter.Builder.<Boolean>start("calcQPeak", true)
    ...
    _filterThreshold =
        UserParameter.Builder.<Double>start("filterThreshold", 0.5)
    ...
    _average =
        UserParameter.Builder.<Boolean>start("calcAverage", false)
    ...
    _useBlackman =
        UserParameter.Builder.<Boolean>start("useBlackman", true)
    ...
    _showRMSValues =
        UserParameter.Builder.<Boolean>start("showRMS", true)
    ...
    _maxFreq =
        UserParameter.Builder.<Double>start("maxFreq", DEFAULT_MAX_FREQ)
    ...
    _minFreq =
        UserParameter.Builder.<Double>start("minFreq", DEFAULT_MIN_FREQ)
    ...
    _automaticQPSelection =
        UserParameter.Builder.<Boolean>start("automaticQPSelection", true)
    ...
    _qpInteval =
        UserParameter.Builder.<Double>start("QPinterval", 9000.0)
