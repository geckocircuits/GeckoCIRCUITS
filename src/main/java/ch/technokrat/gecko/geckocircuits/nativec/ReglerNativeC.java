...
public final class ReglerNativeC extends RegelBlock implements VariableTerminalNumber {
  ...
  public static final ControlTypeInfo tinfo =
      new ControlTypeInfo(ReglerNativeC.class, "C DLL", I18nKeys.C_DLL);
  ...
  private final UserParameter<String> _paramSelectedLibName =
      UserParameter.Builder.<String>start("nativeCLibrary", "null")
  ...
  private final UserParameter<String> _paramLibNames =
      UserParameter.Builder.<String>start("nativeCLibraries", "null")
  ...
  class CCalculator extends AbstractControlCalculatable {
    ...
    public void berechneYOUT(final double deltaT) {
      ...
      try {
        ...
        if (!severeErrorOccured) { // if the native library or function was not found, there is no
          // need to execute it!

          // OBSERVATION: UserParameter _paramLib*** was filled lazy with data from loaded File,
          //      too lazy to check them in the Constructor.
          //      Therefore, loading them at the latest possible chance! I couldn't find better
          // solutions.
          //      Inits here are usually unwanted, because of testing them on every Simulation
          // Timestep
        ...
        severeErrorOccured =
            true; // library couldn't be loaded or native function couldn't be executed
        if (_nativeCBlock != null) {
          _nativeCBlock.unloadLibraries();
          _nativeCBlock = null;
        }
  ...
  protected final Window openDialogWindow() {
    ...
    if (_guiWindow == null) {
      _guiWindow = new NativeCDialog(this, GeckoSim._win, false, _libFile, _libFileList);
