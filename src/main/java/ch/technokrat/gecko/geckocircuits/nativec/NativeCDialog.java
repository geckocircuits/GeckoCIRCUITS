...
public class NativeCDialog extends GeckoDialog {
   ...
   */
  public NativeCDialog(
      ReglerNativeC regObj,
      Window parent,
      boolean modal,
      NativeCLibraryFile libFile,
      DefaultListModel libFileList) {
    super(parent, modal);
    ...
    jButtonOpenFile.addActionListener(
        new ActionListener() {
          @Override
    ...
    jButtonRemoveSelection.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(final ActionEvent event) {
          ...
          public void actionPerformed(ActionEvent event) {
            ...
            if (_selectedLibFile.getFile() != null) {
              ...
              try {
                ...
                JOptionPane.showMessageDialog(
                    null,
                    "Seems like the selected Native Library is already used by another block!",
                    "Error",
    ...
    jListLibFiles.addListSelectionListener(
    ...
    /** add remove option */
    jListLibFiles.addMouseListener(
        new MouseAdapter() {
          @Override
                  ...
                  new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent event) {
                      ...
                      if (currentInd >= 0 && currentInd < _fileList.size()) {
                        ...
                        if (_selectedLibFile.getFileName() != null
                            && deletedFileName.equals(_selectedLibFile.getFileName())) {
    ...
    // set window size of Dialog GUI to 30 % of Main Window ... seemed to be a good choice on my
    // screen
    Dimension winSize =
        new Dimension(
            (int) (GeckoSim._win.getWidth() * 0.3), (int) (GeckoSim._win.getHeight() * 0.3));
  ...
  private void initFileChooser() {
    FileFilter filterLibrary =
        new FileNameExtensionFilter(
            "Shared Library (*.dll, *.so, *.jnilib)",
            "dll",
            "so",
            "jnilib"); // Windows: *.dll, Linux: *.so, Mac OS: *.jnilib
