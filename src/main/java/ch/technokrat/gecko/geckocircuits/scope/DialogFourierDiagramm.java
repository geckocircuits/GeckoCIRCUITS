...
public class DialogFourierDiagramm extends JDialog implements ComponentListener {
  ...
  private void baueGUI() {
    ...
    for (int i1 = 1; i1 < _worksheet.getRowLength() + 1; i1++) {
      if (_signalFourierAnalysiert[i1]) {
        ...
        rekonstruktion[i1 - 1] =
            new FourierKurvenRekonstruktion(
                _an[i1 - 1], _bn[i1 - 1], _nMin, _f1, _worksheet, i1, _rng1, _rng2);
    ...
    mItemF3.addActionListener(
        new ActionListener() {

          public void actionPerformed(ActionEvent ae) {
            // ------------------------------
            GeckoFileChooser fileChooser =
                GeckoFileChooser.createSimpleSaveFileChooser(".dat", DialogFourierDiagramm.this);
            ...
            try {
              BufferedWriter fkaku =
                  new BufferedWriter(new FileWriter(fileChooser.getFileWithCheckedEnding()));
    ...
    for (int i1 = 0; i1 < jbMaus.length; i1++) {
      ...
      switch (i1) {
        ...
        case 4:
          ...
          break;
        default:
          Logger.getLogger(DialogFourierDiagramm.class.getName())
              .log(Level.WARNING, "Error: 49ugnw3grjgtfzj");
          break;
      }
      // --------------------
    }
  ...
  private void aktualisiereMausModus(final ActionEvent actionEvent) {
    ...
    switch (indexKnopfGedrueckt) {
      ...
      default:
        Logger.getLogger(DialogFourierDiagramm.class.getName())
            .log(Level.WARNING, "Fehler: 98n3gweggtq5t");
        break;
    }
    for (int i1 = 1; i1 < _worksheet.getRowLength() + 1; i1++) {
      if (_signalFourierAnalysiert[i1]) {
