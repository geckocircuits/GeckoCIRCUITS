...
class FourierDiagramm extends GraferV3 implements MouseListener, MouseMotionListener {
  ...
  protected void setzeKurven() {
    ...
    this.setzeKurvePunktSymbolAnzeigen(
        new boolean[] {false}, new int[] {1}, new int[] {SYBM_CIRCLE}, new Color[] {Color.black});
  ...
  public void mouseDragged(final MouseEvent mouseEvent) {
    if (mausModus == GraferImplementation.MAUSMODUS_NIX) {
      ...
      xSchieberWert[0] =
          Math.round(
              getValueFromPixel(xSchieberPix, 0)[
                  0]); // x-Wert der Schieber-Position, nur ganzzahlige n-Werte
