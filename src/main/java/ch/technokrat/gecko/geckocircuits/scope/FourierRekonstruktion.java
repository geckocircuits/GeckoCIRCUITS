...
class FourierKurvenRekonstruktion extends GraferV3 implements MouseListener, MouseMotionListener {
  ...
  private int bi,
      ...
      X0yi,
      Y0xi,
      Y0yi; // Hoehe, Breite, X-u-Y-Koord. des Achsenkreuzes (alles in Pix)
  // -----------------------
  ...
  public FourierKurvenRekonstruktion(
      ...
      int nMin,
      double f1,
      AbstractDataContainer worksheet,
      int dataIndex,
      double rng1,
      double rng2) {
    // ---------------------------------------
    ...
    this.setPreferredSize(
        new Dimension(bi + 2 * X0xi, X0yi + (X0yi - hi))); // fuer pack() im uebergeordneten JFrame
  ...
  public void setzeAchsen() {
    ...
    this.setzeTickLabelAnzeige(
        new boolean[] {true}, new boolean[] {true}, new boolean[] {false}, new boolean[] {false});
    this.setzeTickLabelPosition(new int[] {20}, new int[] {16});
    this.setzeTickLabelFont(
        new Font[] {new Font("Arial", Font.PLAIN, 12)},
        new Font[] {new Font("Arial", Font.PLAIN, 12)});
    // =========================================
    //        this.setzeAchsenBegrenzungen(new double[]{0.02}, new double[]{0.06}, new
    // boolean[]{true}, new double[]{-4}, new double[]{4}, new boolean[]{true});
  ...
  protected void setzeKurven() {
    ...
    this.setzeKurvePunktSymbolAnzeigen(
        ...
        new int[] {20, 20},
        new int[] {SYBM_CIRCLE, SYBM_RECT_FILLED},
        new Color[] {Color.black, Color.gray});
    this.setzeKurveClipping(
        new double[] {xNeu[0], xNeu[0]},
        new double[] {xNeu[xNeu.length - 1], xNeu[xNeu.length - 1]},
        new double[] {0, 0},
        new double[] {1, 1},
        new int[] {CLIP_NO, CLIP_NO},
        new int[] {CLIP_NO, CLIP_NO},
        new int[] {CLIP_NO, CLIP_NO},
        new int[] {CLIP_NO, CLIP_NO});
  ...
  public void mouseReleased(MouseEvent me) {
    ...
    if (mausModus == GraferImplementation.MAUSMODUS_NIX) {
      ...
      double[] empfX =
          new double[] {
            xy1[0], xy2[0], -1, -1, auto_Achsenbegrenzung_Wertempfehlung(xy1[0], xy2[0])[4]
          };
      ...
      double[] empfY =
          new double[] {
            xy1[1], xy2[1], -1, -1, auto_Achsenbegrenzung_Wertempfehlung(xy1[1], xy2[1])[4]
          };
