...
public class DataContainerFourier extends AbstractDataContainer
  ...
  public DataContainerFourier(
      final int rows, final int maximumColumns, final double baseFrequency) {
  ...
  public final void setValue(final float value, final int row, final int column) {
    throw new UnsupportedOperationException(
        "this operation is not supported in the data container.");
  }
