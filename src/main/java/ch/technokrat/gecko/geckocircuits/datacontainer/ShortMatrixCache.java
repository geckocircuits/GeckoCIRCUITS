...
/**
 * For the dataContainerCompressable, we use a lot of interger[][] arrays, and "throw" them away
 * shortly afterwards. This utility class helps to keep a cache of inter[] objects. Should be
 * threadsave!
 *
 * @author andreas
 */
public final class ShortMatrixCache {
  ...
  private static ConcurrentHashMap<IntegerMatrixCache.DimensionKey, short[][]> shortMatrixCache =
      new ConcurrentHashMap<IntegerMatrixCache.DimensionKey, short[][]>();
  ...
  public static short[][] getCachedMatrix(final int mDim, final int nDim) {
    final IntegerMatrixCache.DimensionKey searchKey =
        new IntegerMatrixCache.DimensionKey(mDim, nDim);
