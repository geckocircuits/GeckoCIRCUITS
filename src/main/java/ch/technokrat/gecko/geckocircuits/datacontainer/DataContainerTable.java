...
public class DataContainerTable extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    jPanel1.setBorder(
        javax.swing.BorderFactory.createTitledBorder("Data selection / set table view to..."));
    ...
    jTextFieldNumberValue.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        layout
            ...
            .addGroup(
                layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)));
  } // </editor-fold>//GEN-END:initComponents

  private void jButtonEndActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonEndActionPerformed

    jTableData.scrollRectToVisible(
        new Rectangle(jTableData.getCellRect(_dataContainer.getMaximumTimeIndex(0), 0, true)));
  } // GEN-LAST:event_jButtonEndActionPerformed

  private void jButtonStartActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonStartActionPerformed
    jTableData.scrollRectToVisible(new Rectangle(jTableData.getCellRect(0, 0, true)));
  } // GEN-LAST:event_jButtonStartActionPerformed

  private void jTextFieldNumberValueActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jTextFieldNumberValueActionPerformed
