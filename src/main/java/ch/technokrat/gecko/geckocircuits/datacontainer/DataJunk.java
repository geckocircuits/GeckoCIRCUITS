 ...
 */
/**
 * a data junk is a block of data, that can be used within a DataContainer. It is useful to split
 * the whole data into smaller junks, since then we can grow the Data size dynamically, or we can
 * compress the single data junks.
 */
