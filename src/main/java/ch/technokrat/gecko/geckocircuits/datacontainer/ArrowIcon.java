...
class ArrowIcon implements Icon {
  ...
  private final Polygon _pagePolygon =
      new Polygon(new int[] {2, 4, 4, 10, 10, 2}, new int[] {4, 4, 2, 2, 12, 12}, 6);
  ...
  public void paintIcon(
      final Component component, final Graphics graphics, final int xPixel, final int yPixel) {
