...
/** @author andreas */
public final class DataContainerNullData extends AbstractDataContainer
  ...
  public void setContainerStatus(ContainerStatus containerStatus) {
    assert containerStatus == ContainerStatus.DELETED
        : "Null data container should not set status ! " + containerStatus;
  }
  ...
  @Override
  public final float getAVGValueInInterval(
      double intervalStart, double intervalStop, int columnIndex) {
    throw new UnsupportedOperationException("Not supported yet.");
  }
