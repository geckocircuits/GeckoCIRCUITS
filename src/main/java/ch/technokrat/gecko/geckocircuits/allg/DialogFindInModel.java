...
public final class DialogFindInModel extends javax.swing.JDialog {
        ...
        .addListSelectionListener(
            new ListSelectionListener() {
              ...
              public void valueChanged(ListSelectionEvent e) {
                try {
                  String foundString =
                      jList1.getModel().getElementAt(jList1.getSelectedIndex()).toString();
                  ...
                  _se._visibleCircuitSheet.findString(
                      foundString, jCheckBoxIgnore.isSelected(), !jCheckBoxExact.isSelected());
                } catch (Exception ex) {
        ...
        layout
            ...
            .addGroup(
                layout
                    ...
                    .addGap(5, 5, 5)
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
  ...
  private void jTextFieldKeyReleased(
      java.awt.event.KeyEvent evt) { // GEN-FIRST:event_jTextFieldKeyReleased
    String searchText = jTextField.getText();
    if (!searchText.isEmpty()) {
      Set<String> found =
          _se._visibleCircuitSheet.findString(
              searchText, jCheckBoxIgnore.isSelected(), !jCheckBoxExact.isSelected());
  ...
  private void jButtonCloseActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonCloseActionPerformed
