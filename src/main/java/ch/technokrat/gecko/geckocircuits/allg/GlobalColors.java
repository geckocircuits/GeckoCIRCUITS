...
public class GlobalColors {
  ...
  public static Color farbeTextLinie =
      Color.lightGray; // Verbindungslinie vom Textfeld zum zugehoerigen Element
  ...
  public static Color farbeParallelLK =
      Color.decode(
          "0xadd8e6"); // falls eine parallele Linie in Verbindung.zeichne() gezogen wird zur
