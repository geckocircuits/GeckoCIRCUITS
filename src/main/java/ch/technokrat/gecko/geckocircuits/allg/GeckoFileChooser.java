...
public class GeckoFileChooser {
  ...
  private GeckoFileChooser(
      final String ending, final File currentDirectory, final String fileDescription) {
  ...
  public static GeckoFileChooser createOpenFileChooser(
      final String ending,
    ...
    final GeckoFileChooser returnValue =
        new GeckoFileChooser(ending, checkedCurrentDirectory, fileDescription);
    final int result = returnValue._fileChooser.showOpenDialog(windowParent);
    returnValue.processResult(result);
    return returnValue;
  }

  public static GeckoFileChooser createSimpleOpenFileChooser(
      final String ending, final Component windowParent) {
    return createOpenFileChooser(ending, ending, windowParent, null);
  }

  public static GeckoFileChooser createSimpleSaveFileChooser(
      final String ending, final Component windowParent) {
    return createSaveFileChooser(ending, ending, windowParent, null);
  }

  public static GeckoFileChooser createSaveFileChooser(
      final String ending,
      final String fileDescription,
      final Component windowParent,
      final File currentDirectory) {
