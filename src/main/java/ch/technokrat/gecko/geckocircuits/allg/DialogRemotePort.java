...
public final class DialogRemotePort extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    _jPanelConnectionSettings.setBorder(
        javax.swing.BorderFactory.createTitledBorder("Connection settings"));
    ...
    _jRadioButtonEnabled.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    _jRadioButtonDisabled.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    _jFormattedTextFieldPort.setFormatterFactory(
    ...
    _jRadioButtonLocalHostOnly.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    _jRadioButtonNetwork.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    javax.swing.GroupLayout _jPanelConnectionSettingsLayout =
        new javax.swing.GroupLayout(_jPanelConnectionSettings);
    _jPanelConnectionSettings.setLayout(_jPanelConnectionSettingsLayout);
    _jPanelConnectionSettingsLayout.setHorizontalGroup(
        _jPanelConnectionSettingsLayout
    ...
    _jButtonApply.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    _jButtonTest.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    _jButtonRefresh.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    javax.swing.GroupLayout jPanelRemoteSettingsLayout =
        new javax.swing.GroupLayout(jPanelRemoteSettings);
    jPanelRemoteSettings.setLayout(jPanelRemoteSettingsLayout);
    jPanelRemoteSettingsLayout.setHorizontalGroup(
        jPanelRemoteSettingsLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                _jPanelConnectionSettings,
                javax.swing.GroupLayout.Alignment.TRAILING,
                javax.swing.GroupLayout.DEFAULT_SIZE,
                javax.swing.GroupLayout.DEFAULT_SIZE,
                Short.MAX_VALUE)
    ...
    _jCheckBoxEnableMMF.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    javax.swing.GroupLayout jPanelMMFSettingsLayout =
        new javax.swing.GroupLayout(jPanelMMFSettings);
    jPanelMMFSettings.setLayout(jPanelMMFSettingsLayout);
    jPanelMMFSettingsLayout.setHorizontalGroup(
        jPanelMMFSettingsLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(
                jPanelMMFSettingsLayout
                    .createSequentialGroup()
    ...
    _jButtonOKMMF.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    _jButtonApplyMMF.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    _jButtonCancelMMF.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void _jButtonCancelActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event__jButtonCancelActionPerformed
    this.dispose();
    ...
    try {
      ...
      if (_jRadioButtonDisabled.isSelected()) {
        ...
        if (!selectedIP.equals(oldIP)) {
          GeckoRemoteRegistry
              .disableRemotePort(); // if selected IP has changed, should first disable old
          // configuration
        }
      ...
      JOptionPane.showMessageDialog(
          null, ex.getMessage(), "Error with remote access", JOptionPane.ERROR_MESSAGE);
      ex.printStackTrace();
    }
  }
  ...
  private void checkButtons() {
    ...
    _jLabelByAddress.setEnabled(
        _jRadioButtonEnabled.isSelected() && _jRadioButtonNetwork.isSelected());
    _jComboBoxIPs.setEnabled(
        _jRadioButtonEnabled.isSelected() && _jRadioButtonNetwork.isSelected());
  ...
  private void processUserInputMMF() {
    try {
      ...
      JOptionPane.showMessageDialog(
          this, ex.getMessage(), "Error with memory-mapped access", JOptionPane.ERROR_MESSAGE);
      ex.printStackTrace();
    }
  }
  ...
  private void _jButtonOKActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event__jButtonOKActionPerformed
    processUserInput();
    this.dispose();
  } // GEN-LAST:event__jButtonOKActionPerformed

  private void _jButtonTestActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event__jButtonTestActionPerformed
    jTextAreaRemoteTest.setText(GeckoCustomRemote.getClientInfo());
  } // GEN-LAST:event__jButtonTestActionPerformed

  private void _jButtonApplyActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event__jButtonApplyActionPerformed
    processUserInput();
  } // GEN-LAST:event__jButtonApplyActionPerformed

  private void _jRadioButtonDisabledActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event__jRadioButtonDisabledActionPerformed
    checkButtons();
  } // GEN-LAST:event__jRadioButtonDisabledActionPerformed

  private void _jRadioButtonEnabledActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event__jRadioButtonEnabledActionPerformed
    checkButtons();
  } // GEN-LAST:event__jRadioButtonEnabledActionPerformed

  private void _jRadioButtonLocalHostOnlyActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event__jRadioButtonLocalHostOnlyActionPerformed
    checkButtons();
  } // GEN-LAST:event__jRadioButtonLocalHostOnlyActionPerformed

  private void _jRadioButtonNetworkActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event__jRadioButtonNetworkActionPerformed
    checkButtons();
  } // GEN-LAST:event__jRadioButtonNetworkActionPerformed

  private void _jButtonRefreshActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event__jButtonRefreshActionPerformed
    getIPNumbers();
  } // GEN-LAST:event__jButtonRefreshActionPerformed

  private void _jButtonCancelMMFActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event__jButtonCancelMMFActionPerformed
    this.dispose();
  } // GEN-LAST:event__jButtonCancelMMFActionPerformed

  private void _jButtonApplyMMFActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event__jButtonApplyMMFActionPerformed
    processUserInputMMF();
  } // GEN-LAST:event__jButtonApplyMMFActionPerformed

  private void _jButtonOKMMFActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event__jButtonOKMMFActionPerformed
    processUserInputMMF();
    this.dispose();
  } // GEN-LAST:event__jButtonOKMMFActionPerformed

  private void _jCheckBoxEnableMMFActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event__jCheckBoxEnableMMFActionPerformed
    checkButtons();
  ...
  private void doInternationalization() {
    ...
    _jPanelConnectionSettings.setBorder(
        javax.swing.BorderFactory.createTitledBorder(
            I18nKeys.CONNECTION_SETTINGS.getTranslation()));
