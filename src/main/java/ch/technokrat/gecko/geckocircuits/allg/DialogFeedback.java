...
public class DialogFeedback extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    jLabelURL.setText(
        "<html><a href=\"www.bugs.gecko-simulations.org\">www.bugs.gecko-simulations.org</a></html>");
    jLabelURL.addMouseListener(
    ...
    jButtonLaunch.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void jButtonLaunchActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonLaunchActionPerformed
    LaunchBrowser.launch(BUGZILLA_URL);
  } // GEN-LAST:event_jButtonLaunchActionPerformed

  private void jLabelURLMouseClicked(
      java.awt.event.MouseEvent evt) { // NOPMD//GEN-FIRST:event_jLabelURLMouseClicked
    LaunchBrowser.launch(BUGZILLA_URL);
