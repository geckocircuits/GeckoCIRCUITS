...
public class GeckoFileManagerWindow extends javax.swing.JDialog {
  ...
  /**
   * Creates new form GeckoFileManagerWindow should make a different constructor for using circuit
   * blocks (i.e. for loss files)
   */
  public GeckoFileManagerWindow(
      final GeckoFileable fileable,
      final String extension,
      final String type,
      final boolean singleFileOnly) {
    initComponents();
  ...
  /**
   * constructor for creating a GeckoFileManager window for semiconductor loss files
   *
   * @param losses
   * @param extension
   * @param type
   ...
   */
  public GeckoFileManagerWindow(
      final VerlustBerechnungDetailed losses,
      final String extension,
      final String type,
      final FormatJTextField jlS2,
      final FormatJTextField jlS2b,
      final javax.swing.JButton jbS2edit) {
  ...
  private void addGeckoFileToList(final GeckoFile file) {
    if (_singleFileOnly) { // check if this block allows only adding one file - e.g. external data
      // for signal element
  ...
  private void removeGeckoFileFromList(final GeckoFile file) {
    ...
    if (index
        == -1) { // if index is -1, then this is a file which already exists in the block, not a
      // newly added file - add to the list of files to remove
  ...
  private void initComponents() {
    ...
    jButtonRemove.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonAddNewFile.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadioButtonIsExternalNew.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadioButtonIsInternalNew.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jPanel1Layout
            ...
            .addGroup(
                jPanel1Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 439, Short.MAX_VALUE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(
                        jPanel1Layout
    ...
    jButtonAddSelectedExistingFiles.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadioButtonIsInternalExisting.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jRadioButtonIsExternalExisting.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jPanel3Layout
            ...
            .addGroup(
                ...
                jPanel3Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 604, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanel3Layout
            ...
            .addGroup(
                jPanel3Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
                    .addContainerGap()));
  ...
  private void jButtonAddSelectedExistingFilesActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jButtonAddSelectedExistingFilesActionPerformed
    Object[] selectedFiles = jListAvailableFiles.getSelectedValues();
  ...
  private void jButtonRemoveActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonRemoveActionPerformed
    GeckoFile file;
  ...
  private void jButtonCancelActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonCancelActionPerformed
    this.dispose();
  } // GEN-LAST:event_jButtonCancelActionPerformed

  private void jButtonAddNewFileActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonAddNewFileActionPerformed
    FileFilter filter =
        new FileFilter() {
          @Override
  ...
  private void jRadioButtonIsExternalNewActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jRadioButtonIsExternalNewActionPerformed
    Object[] selectedFiles = jListSelectedFilesToAdd.getSelectedValues();
  ...
  private void jRadioButtonIsInternalNewActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jRadioButtonIsInternalNewActionPerformed
    Object[] selectedFiles = jListSelectedFilesToAdd.getSelectedValues();
    GeckoFile selectedFile;
    for (int i = 0; i < selectedFiles.length; i++) {
      selectedFile = (GeckoFile) selectedFiles[i];
  ...
  private void jRadioButtonIsExternalExistingActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jRadioButtonIsExternalExistingActionPerformed
    Object[] selectedFiles = jListAvailableFiles.getSelectedValues();
    GeckoFile selectedFile;
    for (int i = 0; i < selectedFiles.length; i++) {
      selectedFile = (GeckoFile) selectedFiles[i];
  ...
  private void jRadioButtonIsInternalExistingActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jRadioButtonIsInternalExistingActionPerformed
    Object[] selectedFiles = jListAvailableFiles.getSelectedValues();
    GeckoFile selectedFile;
    for (int i = 0; i < selectedFiles.length; i++) {
      selectedFile = (GeckoFile) selectedFiles[i];
  ...
  private void jButtonOKActionPerformed(
    ...
    if (_isLossElement) {
      if (!_newFilesToAdd
          .isEmpty()) { // if user has added new file, old one is removed automatically since
        // semiconductor element can have only one loss file
        ...
        if (fileOK) {
          ...
          _jlS2.setText(
              absPath.substring(
                  0, absPath.lastIndexOf(System.getProperty("file.separator")) + 1)); // Pfad
      ...
      } else if (!_filesToRemove
          .isEmpty()) { // if user did not select a new file, but just removed the old one
