...
public class StartupWindow extends javax.swing.JDialog {
  ...
  private static final String SUPPORT_URL =
      "http://www.gecko-simulations.com/open_source/support.html";
  ...
  private static final Timer delayWindowTimer = new Timer();
  ...
  public static StartupWindow fabricDisabledFeature(final String featureName) {
    ...
    returnValue.jLabel1.setText(
        "<html><font color='red'><b>"
            + featureName
            + ": This feature of GeckoCIRCUITS is not included in the "
            + "open-source release. </b><br><font color='black'>"
            + returnValue.jLabel1.getText().substring(24));
  ...
  private void initComponents() {
    ...
    jLabelSupport.setText(
        "<html><a href=\"www.gecko-simulations.com/open_source/donate.html\">www.gecko-simulations.com/open_source/support.html</a></html>");
    jLabelSupport.addMouseListener(
  ...
  private void jLabelSupportMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_jLabelSupportMouseClicked
