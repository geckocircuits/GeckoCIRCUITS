...
public class GlobalFilePathes {
  ...
  public static String RECENT_CIRCUITS_1 = "",
      RECENT_CIRCUITS_2 = "",
      RECENT_CIRCUITS_3 = "",
      RECENT_CIRCUITS_4 = "";
  // ------------------------
  ...
  // --> ist wichtig, wenn die Pfadstruktur geaendert wurde --> damit werden lokale Pfade
  // aktualisiert, siehe DatenSpeicher.lokalisiereRelativenPfad()
