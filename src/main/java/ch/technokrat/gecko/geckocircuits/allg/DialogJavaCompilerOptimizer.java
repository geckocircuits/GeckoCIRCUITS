...
public class DialogJavaCompilerOptimizer extends JFrame {
  ...
  */
  ...
  private void initComponents() {
    ...
    jTextAreaImports.setBackground(
    ...
    jTextAreaStaticInit.setBackground(
        javax.swing.UIManager.getDefaults().getColor("Button.background"));
    ...
    jTextAreaVariables.setBackground(
        javax.swing.UIManager.getDefaults().getColor("Button.background"));
        ...
        jPanelCompilerMessagesLayout
            ...
            .addGroup(
                jPanelCompilerMessagesLayout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 853, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanelCompilerMessagesLayout
            ...
            .addGroup(
                jPanelCompilerMessagesLayout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
                    .addContainerGap()));
    ...
    jTextArea1.setText(
        "Use the following Interface-methods to control GeckoCIRCUITS:\n\n" + info + "\n");
        ...
        jPanel4Layout
            ...
            .addGroup(
                jPanel4Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 853, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanel4Layout
            ...
            .addGroup(
                jPanel4Layout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        layout
            ...
            .addGroup(
                ...
                layout
                    .createSequentialGroup()
                    .addComponent(
                        jTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 627, Short.MAX_VALUE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(
                        layout
                            .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
  ...
  private void jButtonCloseWindowActionPerformed(
    ...
    if (!(geckoJavaCompiler.getCompileStatus()
        == GeckoJavaCompiler.COMPILESTATUS.COMPILED_SUCCESSFULL)) {
      loadCode();
    }
    this.dispose();
