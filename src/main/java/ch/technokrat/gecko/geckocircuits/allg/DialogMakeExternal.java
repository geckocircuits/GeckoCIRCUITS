...
public final class DialogMakeExternal extends javax.swing.JDialog {
  ...
  public static String dialogResultFabric(
      final GeckoFile geckoFile, final byte[] originalContents) {
  ...
  private void doUpdate() {
    ...
    if (file.exists()) {
      if (file.canWrite()) {
        jTextArea1.setText(
            "WARNING! File already exists. Select if you like to\n"
                ...
                + "Bytes"
                + "\nInternal file size: "
                + _geckoFile.getContentsByte().length
                + " Bytes.");
  ...
  private void initComponents() {
    ...
    jButtonChooser.addActionListener(
    ...
    jButtonCreate.setText("Create file");
    jButtonCreate.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonUseExt.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void jButtonCreateActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonCreateActionPerformed
  ...
  private void jButtonChooserActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonChooserActionPerformed
    ...
    final GeckoFileChooser saveFileChooser =
        GeckoFileChooser.createSimpleSaveFileChooser(_geckoFile.getExtension(), this);
  ...
  private void jTextFieldPathKeyReleased(
      java.awt.event.KeyEvent evt) { // NOPMD//GEN-FIRST:event_jTextFieldPathKeyReleased
    doUpdate();
  ...
  private void jButtonUseExtActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonUseExtActionPerformed
    setVisible(false);
