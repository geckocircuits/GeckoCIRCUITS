...
/** @author florian */
public class DialogControlOrderN extends javax.swing.JDialog
    implements DragGestureListener, DragSourceListener, DropTargetListener {

  /** Creates new form DialogControlOrderN */
  public DialogControlOrderN(
      final java.awt.Frame parent, final boolean modal, final List<RegelBlock> optimizedList) {
  ...
  private void jButtonResetActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonResetActionPerformed
  ...
  //            public void run() {
  //                DialogControlOrderN dialog = new DialogControlOrderN(new javax.swing.JFrame(),
  // true);
  ...
  class ControlOrderTransferable implements Transferable {
    ...
    @Override
    public Object getTransferData(final DataFlavor dataFl) throws UnsupportedFlavorException {
