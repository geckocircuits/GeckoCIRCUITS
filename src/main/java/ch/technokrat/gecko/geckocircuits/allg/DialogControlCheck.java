              ...
              public void valueChanged(final ListSelectionEvent event) {
                ...
                if (selectionIndex > -1) {
                  final Point showPoint =
                      _nlc._inPortsWithoutConnection.get(selectionIndex).getPosition();
        ...
        .addListSelectionListener(
            new ListSelectionListener() {
              ...
              public void valueChanged(final ListSelectionEvent event) {
                ...
                if (selectionIndex > -1) {
                  CircuitSheet._findNodes.add(
                      _nlc._outPortsWithoutConnection.get(selectionIndex).getPosition());
                  SchematischeEingabe2.Singleton._visibleCircuitSheet.repaint();
                }
              }
            });
