...
public class DialogOptimizerParameterSettings extends GeckoDialog {
  ...
  public DialogOptimizerParameterSettings(
      OptimizerParameterData optData, List<AbstractBlockInterface> e) {
  ...
  private JPanel baueGUIInput() {
    ...
    _dataTable =
        new DataTablePanelParameters(
            new String[] {
              I18nKeys.NAME.getTranslation(),
              I18nKeys.VALUE.getTranslation(),
              I18nKeys.USAGES.getTranslation()
            },
            _numberOfUsedParamemters);
    ...
    jbOK.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(final ActionEvent actionEvent) {
            _optData.reSetValuesWithUndo(
                _dataTable.getVariableNames(), _dataTable.getVariableValues());
