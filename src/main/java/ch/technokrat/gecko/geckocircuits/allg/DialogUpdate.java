...
public final class DialogUpdate extends javax.swing.JFrame {
  ...
  private static final String PRO_URL =
      "http://www.gecko-simulations.com/GeckoCIRCUITS/GeckoCIRCUITSreleaseHistory.html";
  ...
  public DialogUpdate() {
    ...
    try {
      ...
      jLabelCurrentNumber.setText(
          Double.toString(DialogAbout.RELEASENUMBER / RELEASE_DIVISOR)
              + " build "
              + DialogAbout.BUILD_NUMBER);
  ...
  private void setErrorMessage() {
    ...
    jLabelInfo.setText(
        "<html>Communication error! Network transfer was probably blocked by a firewall!</html>");
  }
  ...
  private void initComponents() {
    ...
    jButtonGetUpdateOS.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonGetInfosPro.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jPanel2Layout
            ...
            .addGroup(
                jPanel2Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 346, Short.MAX_VALUE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    layout.linkSize(
        ...
        new java.awt.Component[] {jButtonClose, jButtonGetUpdateOS});
  ...
  private void jButtonGetUpdateOSActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonGetUpdateOSActionPerformed
    ...
    GeckoFileChooser fileChooser =
        GeckoFileChooser.createSaveFileChooser(
            ".zip", ".zip archive file", this, currentDirectoryFile);
  ...
  private void jButtonGetInfosProActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonGetInfosProActionPerformed
