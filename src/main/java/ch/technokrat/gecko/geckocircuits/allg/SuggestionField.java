...
public final class SuggestionField extends JTextField {
  ...
  public SuggestionField(final Frame owner) {
    ...
    addFocusListener(
        new FocusListener() {
          public void focusLost(FocusEvent e) {
            ...
            if ((SuggestionField.this.getText().equals(""))
        ...
        new MouseListener() {
          ...
          public void mouseReleased(MouseEvent e) {
            if (this.selected == SuggestionField.this._list.getSelectedIndex()) {
              ...
              SuggestionField.this._lastChosenExistingVariable =
                  SuggestionField.this._list.getSelectedValue().toString();
    ...
    _scrollPane = new JScrollPane(this._list, 20, 31);
          ...
          public void keyReleased(KeyEvent e) {
            ...
            if (e.getKeyCode() == 40) {
              if (SuggestionField.this._dialog.isVisible()) {
                SuggestionField.this._list.setSelectedIndex(
                    SuggestionField.this._list.getSelectedIndex() + 1);
                SuggestionField.this._list.ensureIndexIsVisible(
                    SuggestionField.this._list.getSelectedIndex() + 1);
                return;
              }
              SuggestionField.this.showSuggest();
              ...
              if (((e.getKeyCode() == 10 ? 1 : 0)
                      & (SuggestionField.this._list.getSelectedIndex() != -1 ? 1 : 0)
                      & (SuggestionField.this._suggestions.size() > 0 ? 1 : 0))
                  != 0) {
                SuggestionField.this.setText(
                    (String) SuggestionField.this._list.getSelectedValue());
                SuggestionField.this._lastChosenExistingVariable =
                    SuggestionField.this._list.getSelectedValue().toString();
                SuggestionField.this.fireActionEvent();
                SuggestionField.this._dialog.setVisible(false);
