...
public class UndoRedoManager {
  ...
  public void speichereAutomatischAktuellenZustandFuerUndoRedo(Object daten) {
    ...
    redoAnzahl = 0;
    // --------------
    // ACHTUNG: Der folgende Bereich wird voruebergehend auskommentiert, damit die Undo/Redo-Buttons
    // deaktiviert sind
    // der komplette Undo/Redo-Mechanismus muss ueberarbeitet werden, weil die hier implementierte
    // Speicherung des kompletten
    // Zustandes immer wieder zu massiven Problemen (va. RAM-Speicher) fuehren, weil der
    // RAM-Speicher mit dem OSZI-ReglerBlock
    // verknuepft ist
     ...
     */
    // System.out.println("zeigerAufUndoZustaende=
    // "+zeigerAufUndoZustaende+"\t\tzeigerAufRedoZustaende= "+zeigerAufRedoZustaende);
    // --------------
  }
