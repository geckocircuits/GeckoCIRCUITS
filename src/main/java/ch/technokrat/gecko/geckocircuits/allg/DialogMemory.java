...
public class DialogMemory extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jComboBoxLossy.setModel(
        new javax.swing.DefaultComboBoxModel(new String[] {"No loss", "Low", "Medium", "High"}));
    jComboBoxLossy.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jSpinnerStartup.setModel(
        new javax.swing.SpinnerNumberModel(
            Integer.valueOf(512), Integer.valueOf(32), null, Integer.valueOf(128)));
    jSpinnerStartup.addChangeListener(
        ...
        jPanel1Layout
            ...
            .addGroup(
                jPanel1Layout
                    .createSequentialGroup()
                    .addComponent(
                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
                    .addContainerGap()));
  ...
  private void jSpinnerStartupStateChanged(
      javax.swing.event.ChangeEvent evt) { // NOPMD//GEN-FIRST:event_jSpinnerStartupStateChanged
  ...
  private void jComboBoxLossyActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jComboBoxLossyActionPerformed
    GeckoSim.applicationProps.setProperty(
        "LOSSY_COMPRESSION", "" + jComboBoxLossy.getSelectedIndex());
    DataJunkCompressable.setPrecisionField(
        DataJunkCompressable.PRECISIONS[jComboBoxLossy.getSelectedIndex()]);
