...
abstract class AbstractMotorDC extends AbstractMotor {
  ...
  final UserParameter<Double> _initialArmatureCurrentParam =
      UserParameter.Builder.<Double>start("initialArmaturecurrent", 0.0)
  ...
  final UserParameter<Double> _armatureInductancePar =
      UserParameter.Builder.<Double>start("armatureInductance", INITIAL_ARM_INDUCTANCE)
  ...
  final UserParameter<Double> _armatureResistancePar =
      UserParameter.Builder.<Double>start("armatureResistance", INITIAL_ARM_RESISTANCE)
  ...
  protected void drawConnectorLines(final Graphics2D graphics) {
    graphics.fillRect(
        (int) (-dpix * BLOCK_SYMB_X),
        (int) (-dpix * BLOCK_SYMB_Y),
        (int) (dpix * 2 * BLOCK_SYMB_X),
