...
public abstract class AbstractSemiconductor extends AbstractTwoPortLKreisBlock
    implements SemiconductorLossCalculatable,
        CurrentMeasurable,
        DirectVoltageMeasurable,
        Operationable {

  public final UserParameter<Double> _onResistance =
      UserParameter.Builder.<Double>start("onResistance", AbstractSwitch.RD_ON_DEFAULT)
          .longName(I18nKeys.ON_RESISTANCE)
          .shortName("rON")
          .unit("Ohm")
          .arrayIndex(this, getOnResistanceIndex())
          .build();
  public final UserParameter<Double> _offResistance =
      UserParameter.Builder.<Double>start("offResistance", AbstractSwitch.RD_OFF_DEFAULT)
          .longName(I18nKeys.OFF_RESISTANCE)
          .shortName("rOFF")
          .unit("Ohm")
          .arrayIndex(this, getOffResistanceIndex())
          .build();
  public final UserParameter<Double> kOn =
      UserParameter.Builder.<Double>start("kON", 20e-6)
          .longName(I18nKeys.CURRENT_DEPENDENT_COEFFICIENT_ON)
          .shortName("k_on")
          .arrayIndex(this, 6)
          .unit("Ws/A")
          .build();
  public final UserParameter<Double> kOff =
      UserParameter.Builder.<Double>start("kOFF", 30e-6)
          .longName(I18nKeys.CURRENT_DEPENDENT_COEFFICIENT_OFF)
          .shortName("k_off")
          .unit("Ws/A")
          .arrayIndex(this, 7)
          .build();
  public final UserParameter<Integer> numberParalleled =
      UserParameter.Builder.<Integer>start("numberParalleled", 1)
          .longName(I18nKeys.NUMBER_OF_DEVICES_PARALLEL)
          .shortName("paralleled")
          .unit("unitless")
          .arrayIndex(this, 12)
          .build();
  public final UserParameter<Double> uK =
      UserParameter.Builder.<Double>start("uSWnorm", LossCalculationSimple.UK_DEFAULT_VALUE)
  ...
  /**
   * this "hacks" are just for backwards-compatibility. In the old GeckoCIRCUITS versions, the ideal
   * switch has an on resistance parameter index of 1, in all other switches it is 2. The same
   * "shift" applies for off-resistance.
   *
   * @return
   */
  ...
  public List<GeckoFile> getFiles() {
    if (this instanceof LossCalculatable) {
      ...
      GeckoFile lossFile =
          ((LossProperties) ((LossCalculatable) this).getVerlustBerechnung())
              .getDetailedLosses()
              .lossFile;
  ...
  public List<OperationInterface> getOperationEnumInterfaces() {
    ...
    returnValue.add(
        new OperationInterface("setLossFile", I18nKeys.SET_LOSS_FILE_DOC) {
          @Override
          public Object doOperation(final Object parameterValue) {
            if (!(parameterValue instanceof String)) {
              throw new IllegalArgumentException(
                  "Error: argument must be a String containing a file name");
            }
            ...
            if (!lossFile.exists()) {
              ...
              final String correctedFileName =
                  currentModelDirectory + System.getProperty("file.separator") + parameterValue;
            ...
            if (lossFile.exists() && !lossFile.isDirectory()) {
              ...
              if (foundLossFileName.endsWith(".scl")) {
                ((LossProperties) getVerlustBerechnung())
                    .getDetailedLosses()
                    .readLossesFromFileAndSetDetailedLossType(foundLossFileName);
              } else {
                throw new RuntimeException("Invalid loss file " + foundLossFileName);
              }
            } else {
              throw new RuntimeException(
                  "Specified loss file: " + parameterValue + " does not exist.");
            }
            return null;
          }
        });
