...
public class VoltageSourceCalculator extends AbstractVoltageSourceCalculator
    implements BStampable, DirectCurrentCalculatable, HistoryUpdatable {

  private TimeFunction _function;
  private static final int THREE = 3;
  private static final int FOUR = 4;

  public VoltageSourceCalculator(
      final TimeFunction timeFunction, final AbstractVoltageSource parent) {
    super(parent);
    _function = timeFunction;
    _z = -1;
  }

  VoltageSourceCalculator(
      final double initialValue,
      final int mat0,
      final int mat1,
      final int zValue,
      final int compNumber,
      final AbstractTwoPortLKreisBlock parent) {
    super(parent);
