...
public final class MotorPermanent extends AbstractMotorDC {
  ...
  public static final AbstractTypeInfo TYPE_INFO =
      new CircuitTypeInfo(
          MotorPermanent.class,
          "PM-DC",
          I18nKeys.DC_MACHINE_PERM,
          I18nKeys.PERMANENT_MAGNET_DC_MACHINE);
  double _fluxLinkage;
  final UserParameter<Double> _psiParameter =
      UserParameter.Builder.<Double>start("flux_psi", INITIAL_FLUX_VALUE)
