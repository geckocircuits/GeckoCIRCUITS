...
public class MapList extends ArrayList<AbstractCircuitSheetComponent> {
  ...
  private final Class[] registeredTypes =
      new Class[] {
        AbstractCircuitBlockInterface.class,
        RegelBlock.class,
        AbstractSpecialBlock.class,
        TextFieldBlock.class,
        ComponentCoupable.class,
        PotentialCoupable.class,
        AbstractBlockInterface.class,
        Verbindung.class,
        SubcircuitBlock.class
      };
