...
public class NetListContainer {
  ...
  public static NetListContainer fabricStartSimulation(
      final SchematischeEingabe2 schematicEntry, SimulationsKern simKern) {
    schematicEntry.checkNameOptParameters();
    NetzlisteAllg nlC1 =
        NetzlisteAllg.fabricNetzlistDisabledParentSubsRemoved(
            schematicEntry.getConnection(ConnectorType.CONTROL),
            schematicEntry.getElementCONTROL());
  ...
  public static NetListContainer fabricContinueSimulation(
      final SchematischeEingabe2 schematicEntry,
      SimulationsKern simKern,
      NetListContainer oldNetlist) {
    schematicEntry.checkNameOptParameters();
    return new NetListContainer(
        NetzlisteCONTROL.FabricContinueSimulation(oldNetlist._nlControl),
        oldNetlist._nlLK,
        oldNetlist._nlTH);
  }

  public static NetListContainer fabricGuiUpdate(
      NetListLK circuitNL, NetListLK thermNL, NetzlisteCONTROL nlCONTROL) {
