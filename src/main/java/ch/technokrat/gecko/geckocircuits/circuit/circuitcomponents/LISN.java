...
// dieses Element ist in Wirklichkeit ein Subcircuit, der ein L in Serie zu einer Spannungsquelle
// enthaelt
public class LISN extends AbstractCircuitBlockInterface implements HiddenSubCircuitable {
  public static final AbstractTypeInfo TYPE_INFO =
      new CircuitTypeInfo(
          LISN.class, "LISN", I18nKeys.LISN, I18nKeys.LINE_IMPEDANCE_STABILIZATION_NETWORK);
  ...
  protected void drawBackground(final Graphics2D graphics) {
    graphics.fillRect(
        (int) (-dpix * 2.5), (int) (-dpix * 1.5), (int) (dpix * 4.0), (int) (dpix * 4.0));
  }
