...
/**
 * this ugly class is just (and still) used from the "old" geckocircuits solver. Remove this, when
 * the new solver is finished. CircuitSourceType should be a complemte replacement of this one.
 *
 * @author andy
 */
