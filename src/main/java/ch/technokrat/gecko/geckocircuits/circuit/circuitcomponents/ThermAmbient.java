...
// Definierte Bezugstemperatur speziell fuer interne Subcircuits, ist eigentlich KEINE
// Ambient-Temperatur
...
public final class ThermAmbient extends AbstractCircuitBlockInterface {
  ...
  final UserParameter<Double> _ambientTemp =
      UserParameter.Builder.<Double>start("tRef", 0.0)
