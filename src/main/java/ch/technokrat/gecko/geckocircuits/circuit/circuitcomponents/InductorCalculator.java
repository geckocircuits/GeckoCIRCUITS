...
public class InductorCalculator extends CircuitComponent implements BStampable, HistoryUpdatable {
  ...
  // because of coupled inductors, so that inductor coupling can override this method - also UGLY,
