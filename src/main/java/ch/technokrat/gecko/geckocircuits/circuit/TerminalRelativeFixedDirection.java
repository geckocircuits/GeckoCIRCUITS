...
public final class TerminalRelativeFixedDirection extends AbstractTerminal {
  ...
  public TerminalRelativeFixedDirection(
      final AbstractBlockInterface relatedComponent, final int posX, final int posY) {
  ...
  public static Point getPointFromDirection(
      final ComponentDirection direction, final Point center, final int posX, final int posY) {
  ...
  public AbstractTerminal createCopy(final AbstractBlockInterface relatedComponent) {
    final AbstractTerminal returnValue =
        new TerminalRelativeFixedDirection(relatedComponent, _posX, _posY);
