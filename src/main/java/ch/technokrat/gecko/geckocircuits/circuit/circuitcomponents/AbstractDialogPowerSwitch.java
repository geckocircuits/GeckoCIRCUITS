...
public abstract class AbstractDialogPowerSwitch<T extends AbstractSemiconductor>
    extends DialogElementLK<T> {
  ...
  public AbstractDialogPowerSwitch(final T elementLK) {
    ...
    _jRadioButtonSimpleLosses.addActionListener(
        new ActionListener() {
          @Override
    ...
    _jRadioButtonDetailedLosses.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(final ActionEvent actionEvent) {
  ...
  private void populateCharacteristicsPanel() {
    _characteristicsPanel.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            I18nKeys.CIRCUIT_MODEL.getTranslation(),
            TitledBorder.LEFT,
            TitledBorder.TOP));
  ...
  /**
   * when changing between simple losses and detailled losses, the corresponding panel is enabled,
  ...
  private JPanel createSimpleOuterPanel() {
    ...
    _jPanelSimpleLosses.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(),
            I18nKeys.LOSSES_BASED_ON_CIRCUIT_MODEL.getTranslation(),
            TitledBorder.LEFT,
            TitledBorder.TOP));
