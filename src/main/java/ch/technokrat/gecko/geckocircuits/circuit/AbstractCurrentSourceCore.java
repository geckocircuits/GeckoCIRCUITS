...
/**
 * Core current source simulation logic - NO GUI dependencies.
 * Pure simulation contract extractable to gecko-simulation-core.
 * Manages current source parameters and waveform generation.
 */
public abstract class AbstractCurrentSourceCore extends CircuitComponentCore {
    
    protected double _dcValue = 1.0;           // DC component in Amperes
    ...
    protected AbstractCurrentSourceCore(SolverType solverType) {
        super(solverType);
    }
