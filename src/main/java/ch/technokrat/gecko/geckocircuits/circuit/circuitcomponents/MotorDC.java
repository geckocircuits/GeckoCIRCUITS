...
public final class MotorDC extends AbstractMotorDC {
  ...
  public static final AbstractTypeInfo TYPE_INFO =
      new CircuitTypeInfo(MotorDC.class, "M-DC", I18nKeys.DC_MACHINE);

  private double _fieldInductance;
  final UserParameter<Double> _fieldInductanceParameter =
      UserParameter.Builder.<Double>start("fieldInductance", INITIAL_FIELD_INDUCTANCE)
  ...
  final UserParameter<Double> _fieldResistanceParameter =
      UserParameter.Builder.<Double>start("fieldResistance", INITIAL_FIELD_RESISTANCE)
  ...
  UserParameter<Double> _fieldWindingsParameter =
      UserParameter.Builder.<Double>start("fieldWindings", INITIAL_NUMBER_WINDINGS)
  ...
  final UserParameter<Double> _initialFieldCurrentParameter =
  ...
  final UserParameter<Double> _machineConstantParam =
      UserParameter.Builder.<Double>start("machineConstant", 1.0)
  ...
  public List<String> getParameterStringIntern() {
    return Arrays.asList(
        "ia [A]", "ie [A]", "omega", "n [rpm]", "phi [Vs]", "emf [V]", "Tel [Nm]", "theta [rad]");
  }
  ...
  protected void drawConnectorLines(final Graphics2D graphics) {
    ...
    graphics.drawLine(
        XPOS_LEFT_TERM * dpix,
        YPOS_EXCITATION_1 * dpix,
        (int) (dpix * BLOCK_SYMB_Y),
        YPOS_EXCITATION_1 * dpix);
    graphics.drawLine(-dpix, -dpix, -dpix, (int) (-dpix * MID_POSITION));
    graphics.drawLine(
        -dpix,
        (int) (-dpix * MID_POSITION),
        (int) (dpix * BLOCK_SYMB_Y),
        (int) (-dpix * MID_POSITION));
