...
public class BVector {
  ...
  private BVector(
      double[] bcopy,
      double[] basisBcopy,
      ArrayList<BStampable> bStampables,
      ArrayList<BStampable> isBasisStampable,
      ArrayList<BStampable> isNotBasisStampable,
      boolean updateAllFlagcopy) {
    b = bcopy;
    basisB = basisBcopy;
