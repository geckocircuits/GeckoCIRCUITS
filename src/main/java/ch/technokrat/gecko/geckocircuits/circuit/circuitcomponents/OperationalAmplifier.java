...
public final class OperationalAmplifier extends AbstractCircuitBlockInterface
    implements HiddenSubCircuitable {
  ...
  UserParameter<Double> inputResistance =
      UserParameter.Builder.<Double>start("inputResistance", 90000.0)
          .longName(I18nKeys.INPUT_RESISTANCE)
          .shortName("rIN")
          .unit("ohm")
          .arrayIndex(this, 0)
          .build();
  UserParameter<Double> outputResistance =
      UserParameter.Builder.<Double>start("outputResistance", 0.12)
          .longName(I18nKeys.OUTPUT_RESISTANCE)
          .shortName("rOUT")
          .unit("ohm")
          .arrayIndex(this, 1)
          .build();
  final UserParameter<Double> frequencyDependency =
      UserParameter.Builder.<Double>start("frequencyDependency", 1E5)
          ...
          .arrayIndex(this, 4)
          .build();
  UserParameter<Double> gainValue =
      UserParameter.Builder.<Double>start("gainValue", 10000.0)
          .longName(I18nKeys.GAIN)
          .shortName("gain")
          .unit("V/V")
          .arrayIndex(this, 5)
          .build();
  UserParameter<Double> voltageLimitationMax =
      UserParameter.Builder.<Double>start("voltageLimitMax.", 12.0)
          .longName(I18nKeys.VOLTAGE_LIMITATION_MAXIMUM)
          .shortName("U_max")
          .unit("V")
          .arrayIndex(this, 7)
          .build();
  UserParameter<Double> voltageLimitationMin =
      UserParameter.Builder.<Double>start("voltageLimitatMin.", -12.0)
          .longName(I18nKeys.VOLTAGE_LIMITATION_MINIMUM)
          .shortName("U_min")
          .unit("V")
          .arrayIndex(this, 8)
          .build();
  UserParameter<Double> voltageDividerRa =
      UserParameter.Builder.<Double>start("voltageDividerRa", 1.0)
          .longName(I18nKeys.VOLTAGE_DIVIDER)
          .shortName("Ra")
          .unit("ohm")
          .arrayIndex(this, 13)
          .build();
  UserParameter<Double> voltageDividerRb =
      UserParameter.Builder.<Double>start("voltageDividerRb", 100.0)
          .longName(I18nKeys.VOLTAGE_DIVIDER)
          .shortName("Rb")
          .unit("ohm")
          .arrayIndex(this, 14)
  ...
  private void setzeSubcircuit() {
    ...
    _internalVoltageSource.sourceType.setValueWithoutUndo(
    ...
    _outputVoltageSource.sourceType.setValueWithoutUndo(
        CircuitSourceType.QUELLE_VOLTAGECONTROLLED_DIRECTLY);
  ...
  protected void drawBackground(final Graphics2D graphics) {
    graphics.fillPolygon(
        new int[] {(int) (-dpix * 1.5), (int) (dpix * 1.5), 0},
        new int[] {(int) (-dpix * 1), (int) (-dpix * 1), (int) (dpix * 2)},
        3);
  }
  ...
  protected void addTextInfoParameters() {
    ...
    if ((voltageLimitationMin.getNameOpt().isEmpty()
        && voltageLimitationMax.getNameOpt().isEmpty())) {
      _textInfo.addParameter(
          "u=[" + voltageLimitationMin.getValue() + ".." + voltageLimitationMax.getValue() + "]");
    }
  }
