...
public final class DialogVerlusteDetail extends GeckoDialog {
  ...
  private final DetailedSwitchingLossesPanel _switchingLossPanel =
      new DetailedSwitchingLossesPanel();
  private final DetailedConductionLossPanel _conductionLossPanel =
      new DetailedConductionLossPanel();
  private final JButton _jButtonSaveChanged =
      GuiFabric.getJButton(I18nKeys.OVERWRITE_AND_SAVE_CHANGES);
  ...
  private final JPanelLossDataInterpolationSettings _jpTest =
      new JPanelLossDataInterpolationSettings(this);
  private final JTabbedPane _tabbedPane = new JTabbedPane();
  private StorageType _storageType = StorageType.INTERNAL;

  public static DialogVerlusteDetail fabricCreateNew(
      final VerlustBerechnungDetailed lossCalculation, final Window parent) {
  ...
  public static DialogVerlusteDetail fabricCreateExisiting(
      final VerlustBerechnungDetailed lossCalculation, final Window parent) {
    DialogVerlusteDetail returnValue = new DialogVerlusteDetail(lossCalculation, parent);
  ...
  private DialogVerlusteDetail(
    ...
    _switchingLossPanel._lossCurves.addAll(
        _lossCalculation.getCopyOfSchaltverlusteMesskurvenArray());
    _conductionLossPanel._lossCurves.addAll(
        _lossCalculation.getCopyOfLeitverlusteMesskurvenArray());
  ...
  private final ActionListener _saveChangeListener =
      new ActionListener() {
        @Override
  ...
  private final ActionListener _saveNewActionListener =
      new ActionListener() {
        @Override
  ...
  private void buildMainPanel() {
    ...
    _jButtonCancel.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(final ActionEvent actionEvent) {
            dispose();
  ...
  private void applyChanges(final String fileName) {
    ...
    _lossCalculation.setzeNeueParameter(
        _switchingLossPanel._lossCurves, _conductionLossPanel._lossCurves);
    ...
    _lossCalculation.schreibeDetailVerlusteAufDatei(
        fileName, _switchingLossPanel._lossCurves, _conductionLossPanel._lossCurves, _storageType);
        ...
        case 0:
          ...
          GeckoFileChooser fileChooser =
              GeckoFileChooser.createSaveFileChooser(
                  ".scl", "Semiconductor Loss Files (*.scl)", this, null);
        ...
        case 1:
          ...
          fileName.append(
              JOptionPane.showInputDialog(
                  null,
                  "Please select a file name identifier:",
                  "Choose file name",
