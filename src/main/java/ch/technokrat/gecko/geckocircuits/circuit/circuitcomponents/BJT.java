...
public final class BJT extends AbstractTwoPortLKreisBlock implements HiddenSubCircuitable {
  ...
  public static final AbstractTypeInfo TYPE_INFO =
      new CircuitTypeInfo(BJT.class, "BJT", I18nKeys.BIPOLAR_TRANSISTOR);

  final UserParameter<Double> _forwardBeta =
      UserParameter.Builder.<Double>start("forwardBeta", DEF_FORWARD_BETA)
  ...
  final UserParameter<Double> _backwardBeta =
      UserParameter.Builder.<Double>start("backwardBeta", DEF_BACKWARD_BETA)
  ...
  final UserParameter<Double> _baseResistance =
      UserParameter.Builder.<Double>start("baseResistance", DEF_BASE_RES)
  ...
  final UserParameter<Double> _emitterResistance =
      UserParameter.Builder.<Double>start("emitterResistance", DEF_EM_RES)
  ...
  final UserParameter<Double> _collectorResistance =
      UserParameter.Builder.<Double>start("collectorResistance", DEF_COL_RES)
  ...
  final UserParameter<Double> _forwardVoltage =
      UserParameter.Builder.<Double>start("forwardVoltage", DEF_uF)
  ...
  final UserParameter<Boolean> _isNpn =
      UserParameter.Builder.<Boolean>start("isNpn", true)
  ...
  public BJT() {
    ...
    double i = 0,
        u = 0; // Strom und Spannung eines Zweipols --> wird laufend in 'LKMatrizen' in parameter[]
    // hineingeschrieben
    ...
    controlledSource1 =
        (AbstractCurrentSource) AbstractTypeInfo.fabricHiddenSub(CircuitTyp.LK_I, this);
    controlledSource1.setOutputTerminal(0, _midTerminal);
    controlledSource1.setInputTerminal(0, _collectorTerminal);
    controlledSource1.sourceType.setValueWithoutUndo(
    ...
    controlledSource2.sourceType.setValueWithoutUndo(
        CircuitSourceType.QUELLE_VOLTAGECONTROLLED_DIRECTLY);
  ...
  public Collection<AbstractBlockInterface> getHiddenSubCircuitElements() {
    ...
    controlledSource1.directPotentialGain.setValueWithoutUndo(
        _forwardBeta.getValue() / (_baseResistance.getValue()));
    controlledSource2.directPotentialGain.setValueWithoutUndo(
        _backwardBeta.getValue() / (_baseResistance.getValue()));
    ...
    return Arrays.asList(
        new AbstractBlockInterface[] {_diode1, _diode2, controlledSource1, _resistor1});
  }

  @Override
  protected void drawForeground(final Graphics2D graphics) {
    double dd = 0.25,
        alpha = Math.atan(HEIGHT),
        ddx = dd * Math.cos(alpha),
        ddy = dd * Math.sin(alpha);
    ...
    graphics.drawLine(
        -(int) (dpix * 0.8), (int) (dpix * 0.8), -(int) (dpix * 0.8), (int) (-dpix * 0.8));
