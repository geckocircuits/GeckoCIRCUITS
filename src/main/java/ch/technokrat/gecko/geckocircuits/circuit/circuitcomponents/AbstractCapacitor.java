...
public abstract class AbstractCapacitor extends AbstractNonLinearCircuitComponent
  ...
  final UserParameter<Double> _capacitance =
      UserParameter.Builder.<Double>start("capacitance", 100e-9)
          ...
          . // nonlinearity: custom display!
          arrayIndex(this, 0)
          .build();

  UserParameter<Double> _initialValue =
      UserParameter.Builder.<Double>start("initVoltage", 0.0)
          .mapDomains(ConnectorType.LK, ConnectorType.THERMAL)
