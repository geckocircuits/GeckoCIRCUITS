...
public final class LossProperties implements AbstractLossCalculatorFabric {
  ...
  public final ModelMVC<LossCalculationDetail> _lossType =
      new ModelMVC<LossCalculationDetail>(LossCalculationDetail.SIMPLE, "Loss calculation level: ");
  ...
  public boolean importASCII(final TokenMap tokenMap) {
    ...
    _lossType.setValue(
        LossCalculationDetail.getFromDeprecatedFileVersion(tokenMap.readDataLine("verlustTyp", 1)));
  ...
  private class LossCalculatorParallelWrapper implements AbstractLossCalculator {
    ...
    public LossCalculatorParallelWrapper(
        final AbstractLossCalculator toWrap, final int numberParalleled) {
      super();
      _wrapped = toWrap;
  ...
  private class LossCalculatorParallelWrapperWithSplit extends LossCalculatorParallelWrapper
    ...
    public LossCalculatorParallelWrapperWithSplit(
        final AbstractLossCalculator toWrap, final int numberParalleld) {
  ...
  private final class LossCalculatorAdditionalDiode
      implements AbstractLossCalculator, LossCalculationSplittable {
    ...
    public LossCalculatorAdditionalDiode(final AbstractLossCalculator original, final Diode diode) {
      ...
      _diodeLosses =
          ((SemiconductorLossCalculatable) _diode).getVerlustBerechnung().lossCalculatorFabric();
    }
    ...
    public void calcLosses(final double current, final double temperature, final double deltaT) {
      ...
      _conductionLosses =
          _splittable.getConductionLoss()
              + ((LossCalculationSplittable) _diodeLosses).getConductionLoss();
      _switchingLosses =
          _splittable.getSwitchingLoss()
              + ((LossCalculationSplittable) _diodeLosses).getSwitchingLoss();
    }
