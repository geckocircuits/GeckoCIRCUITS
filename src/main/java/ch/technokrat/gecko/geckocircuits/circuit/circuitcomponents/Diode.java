...
public final class Diode extends AbstractSemiconductor implements ForwardVoltageDropable {
  static final AbstractTypeInfo TYPE_INFO =
      new CircuitTypeInfo(
          Diode.class, "D", I18nKeys.DIODE, I18nKeys.IDEAL_DIODE_WITH_ON_RESISTANCE);

  private static final double WIDTH = 0.5;
  private static final double HEIGHT = 0.6;
  private static final int NUMBER_POLYGON_POINTS = 3;

  final UserParameter<Double> _forwardVoltageDrop =
      UserParameter.Builder.<Double>start("forwardVoltageDrop", AbstractSwitch.UF_DEFAULT)
  ...
  public final UserParameter<Boolean> useNonlinearChar =
      UserParameter.Builder.<Boolean>start("useNonlinearChar", false)
  ...
  protected void drawForeground(final Graphics2D graphics) {
    graphics.drawPolygon(
        new int[] {0, (int) (-dpix * WIDTH), (int) (dpix * WIDTH)},
        new int[] {(int) (dpix * HEIGHT), (int) (-dpix * HEIGHT), (int) (-dpix * HEIGHT)},
        NUMBER_POLYGON_POINTS);
    graphics.fillRect(
        (int) (-dpix * WIDTH), (int) (dpix * HEIGHT - 2), (int) (dpix * 2 * WIDTH), 2);
  }
