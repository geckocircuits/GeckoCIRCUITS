...
public abstract class AbstractMotorIMCommon extends AbstractThreePhaseMotor {
  ...
  final UserParameter<Double> statorLeakageInductance =
      UserParameter.Builder.<Double>start("statorLeakageInductance", 0.0010)
          ...
          .arrayIndex(this, 18)
          .build();
  final UserParameter<Double> rotorResistance =
      UserParameter.Builder.<Double>start("rotorResistance", 1.0)
          .longName(I18nKeys.ROTOR_RESISTANCE)
          .shortName("Rr")
          .unit("ohm")
          .arrayIndex(this, 19)
          .build();
  final UserParameter<Double> rotorLeakageInductance =
      UserParameter.Builder.<Double>start("rotorLeakageInductance", 0.0018)
  ...
  public final UserParameter<Double> initialStatorFluxD =
      UserParameter.Builder.<Double>start("initialStatorFluxD", 0.0)
          ...
          .build();
  public final UserParameter<Double> initialStatorFluxQ =
