          ...
          public void keyReleased(KeyEvent ke) {
            try {
              if (windingsField2.getNumberFromField() != 0) {
                windingsRatio.setNumberToField(
                    windingsField1.getNumberFromField() / windingsField2.getNumberFromField());
              }
            } catch (Exception ex) {
              ex.printStackTrace();
            }
