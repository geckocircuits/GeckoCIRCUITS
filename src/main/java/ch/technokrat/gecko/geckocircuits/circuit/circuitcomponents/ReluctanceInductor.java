...
public final class ReluctanceInductor extends AbstractCircuitBlockInterface
  ...
  static final AbstractTypeInfo TYPE_INFO =
      new ReluctanceAndCircuitTypeInfo(
          ReluctanceInductor.class,
          "LRel",
          I18nKeys.INDUCTOR_RELUCTANCE,
          I18nKeys.INDUCTOR_RELUCTANCE_COUPLING_COMPONENT);
  ...
  final UserParameter<Double> _windings =
      UserParameter.Builder.<Double>start("turns", 2.0)
  ...
  final UserParameter<Double> _initCurrent =
      UserParameter.Builder.<Double>start("initCurrent", 0.0)
  ...
  final UserParameter<Boolean> _inputReversed =
      UserParameter.Builder.<Boolean>start("inputReversed", false)
          .longName(I18nKeys.INPUT_REVERSED)
          .shortName("ir")
          .arrayIndex(this, INPUT_REV_INDEX)
          .build();
  private static final int OUTPUT_REV_INDEX = 4;
  final UserParameter<Boolean> _outputReversed =
      UserParameter.Builder.<Boolean>start("outputReversed", false)
  ...
  public ReluctanceInductor() {
    ...
    _secondarySource.sourceType.setValueWithoutUndo(
        CircuitSourceType.QUELLE_CURRENTCONTROLLED_DIRECTLY);
    ...
    _initCurrent.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(final ActionEvent event) {
  ...
  private final ActionListener _reversedListener =
      new ActionListener() {
        @Override
        public void actionPerformed(final ActionEvent event) {
          defineTerminals();
  ...
  public AbstractCircuitBlockInterface[] getCurrentMeasurementComponents(
      final ConnectorType simulationDomain) {
    setSubComponentsName();
