  ...
  protected void baueGUIIndividual() {
    ...
    pNonLinL.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(), "Non-Linear", TitledBorder.LEFT, TitledBorder.TOP));
    ...
    pMAG1.setBorder(
        BorderFactory.createTitledBorder(
            BorderFactory.createEtchedBorder(), "Losses", TitledBorder.LEFT, TitledBorder.TOP));
