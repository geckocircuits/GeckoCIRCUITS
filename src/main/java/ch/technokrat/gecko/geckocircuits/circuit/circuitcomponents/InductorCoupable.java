...
// dahinter verbirgt sich nicht ein Subcircuit, sondern die linearisierte Martixgleichung der
// Topologie wird
// um die Stroeme in diesen gekoppelten Induktivitaeten erweitert --> verbesserte numerische
// Stabilitaet
public final class InductorCoupable extends AbstractInductor {
  ...
  public static final AbstractTypeInfo TYPE_INFO =
      new CircuitTypeInfo(
          InductorCoupable.class,
          "Lc",
          I18nKeys.INDUCTOR_COUPLING_LC_H,
          I18nKeys.INDUCTOR_THAT_CAN_BE_COUPLED);

  @Override
  protected void drawForeground(final Graphics2D graphics) {
    super.drawForeground(graphics);
    graphics.fillOval(
        (int) (DOT_SPACING_X * dpix), (int) (dpix * DOT_SPACING_Y), DOT_DIAMETER, DOT_DIAMETER);
  }
