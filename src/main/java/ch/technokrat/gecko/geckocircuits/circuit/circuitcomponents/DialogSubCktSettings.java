...
public class DialogSubCktSettings extends javax.swing.JDialog {
  ...
  public DialogSubCktSettings(
      java.awt.Frame parent, boolean modal, final SubcircuitBlock subBlock) {
    super(parent, modal);
    initComponents();
    _subBlock = subBlock;
    ...
    jLabelSubcircuitSizeX.setText(
        I18nKeys.SUBCIRCUIT.getTranslation() + " " + I18nKeys.SIZE.getTranslation() + " X:");
    jLabelSubcircuitSizeY.setText(
        I18nKeys.SUBCIRCUIT.getTranslation() + " " + I18nKeys.SIZE.getTranslation() + " Y:");
  ...
  private void initComponents() {
    ...
    jSpinnerSheetX.setModel(
        new javax.swing.SpinnerNumberModel(
            Integer.valueOf(40), Integer.valueOf(20), null, Integer.valueOf(5)));
    jSpinnerSheetX.addChangeListener(
    ...
    jSpinnerSheetY.setModel(
        new javax.swing.SpinnerNumberModel(
            Integer.valueOf(30), Integer.valueOf(20), null, Integer.valueOf(5)));
    jSpinnerSheetY.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    jSpinnerBlockY.setModel(
        new javax.swing.SpinnerNumberModel(
            Integer.valueOf(10), Integer.valueOf(1), null, Integer.valueOf(1)));
    jSpinnerBlockY.addChangeListener(
        new javax.swing.event.ChangeListener() {
          public void stateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    layout.linkSize(
        ...
        new java.awt.Component[] {jSpinnerBlockX, jSpinnerBlockY, jSpinnerSheetX, jSpinnerSheetY});
  ...
  private void jSpinnerSheetXStateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_jSpinnerSheetXStateChanged

    if (_initDone) {
      _subBlock._myCircuitSheet._worksheetSize.setNewWorksheetSize(
          (Integer) jSpinnerSheetX.getValue(), (Integer) jSpinnerSheetY.getValue());
      _subSheet.repaint();
    }
  } // GEN-LAST:event_jSpinnerSheetXStateChanged

  private void jSpinnerBlockXStateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_jSpinnerBlockXStateChanged
    if (_initDone) {
  ...
  private void jSpinnerBlockYStateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_jSpinnerBlockYStateChanged
    if (_initDone) {
  ...
  private void jSpinnerSheetYStateChanged(
      javax.swing.event.ChangeEvent evt) { // GEN-FIRST:event_jSpinnerSheetYStateChanged
    if (_initDone) {
      _subBlock._myCircuitSheet._worksheetSize.setNewWorksheetSize(
          (Integer) jSpinnerSheetX.getValue(), (Integer) jSpinnerSheetY.getValue());
      _subSheet.repaint();
