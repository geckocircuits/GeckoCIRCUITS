...
public final class NonLinearReluctance extends AbstractNonLinearCircuitComponent
    implements HiddenSubCircuitable, PostCalculatable, CurrentMeasurable, DirectVoltageMeasurable {

  public static final AbstractTypeInfo TYPE_INFO =
      new ReluctanceTypeInfo(NonLinearReluctance.class, "NLRel", I18nKeys.NONLINEAR_RELUCTANCE);
  ...
  private AbstractBlockInterface[] qLK =
      new AbstractBlockInterface[] {_primarySource, _secondarySource};

  public NonLinearReluctance() {
    this.setOutputTerminal(0, new TerminalHiddenSubcircuit(this));
    TerminalRelativePosition commonTerminal =
        new TerminalRelativePositionReluctance(this, 0, X_TERM_DISTANCE);
        ...
        new TerminalRelativePositionReluctance(this, 0, -X_TERM_DISTANCE) {
          ...
          public void paintComponent(Graphics graphics) {
            ...
            super.paintComponent(
                graphics); // To change body of generated methods, choose Tools | Templates.
          }
        });
  ...
  public final void doCalculation(final double deltaT, final double time) {
    parameter[0] =
        getActualValueLINFromLinearizedCharacteristicInverse(
            Math.abs(_secondarySource.parameter[6]));
  }
