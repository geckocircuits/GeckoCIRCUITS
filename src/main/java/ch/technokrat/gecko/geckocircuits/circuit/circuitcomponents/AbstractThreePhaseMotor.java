...
abstract class AbstractThreePhaseMotor extends AbstractMotor {
  ...
  final UserParameter<Double> _statorResistancePar =
      UserParameter.Builder.<Double>start("statorResistance", 0.5)
  ...
  final UserParameter<Double> initialStatorCurrentA =
      UserParameter.Builder.<Double>start("initialStatorCurrentA", 0.0)
  ...
  final UserParameter<Double> initialStatorCurrentB =
      UserParameter.Builder.<Double>start("initialStatorCurrentB", 0.0)
  ...
  void setSubCircuit() {
    ...
    _controlledAnchorSourceA.sourceType.setValueWithoutUndo(
        CircuitSourceType.QUELLE_SIGNALGESTEUERT);
    ...
    _controlledAnchorSourceC.sourceType.setValueWithoutUndo(
        CircuitSourceType.QUELLE_SIGNALGESTEUERT);
  ...
  void updateSourceParameters() {
    ...
    isc =
        isd * Math.cos(_thetaElectric + 2 * Math.PI / 3)
            - isq * Math.sin(_thetaElectric + 2 * Math.PI / 3);
    isb = -(isa + isc);
