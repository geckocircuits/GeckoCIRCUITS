...
/**
 * This is an enum to differentiate between different loss components being calculated: To allow the
 * user to see only switching, or only conduction losses, or both.
 *
 * @author anstupar
 */
public enum LossComponent {
  ...
  private static final String saveStringTotal = "total";
  private static final String saveStringConduction = "conduction";
  private static final String saveStringSwitching = "switching";
