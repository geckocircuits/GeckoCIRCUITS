...
class MotorDCDialog extends AbstractMotorDialog<MotorDC> {
  ...
  List<UserParameter<Double>> getDialogSortedParameters() {
    return Arrays.asList(
        element._machineConstantParam,
        element._frictionParameter,
        element._inertiaParameter,
        element._polePairsParameter,
        element._armatureResistancePar,
        element._armatureInductancePar,
        element._fieldResistanceParameter,
        element._fieldInductanceParameter,
        element._fieldWindingsParameter,
        element._initialArmatureCurrentParam,
        element._initialFieldCurrentParameter,
