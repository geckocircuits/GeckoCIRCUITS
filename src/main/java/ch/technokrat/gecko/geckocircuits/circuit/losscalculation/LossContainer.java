...
/**
 * This is a class to "package" losses being returned by loss-calculators - so we can keep switching
 * and conduction losses separate for semiconductor components. Wrapping them in an object is more
 * "proper" than returning an array.
 *
 * @author anstupar
 */
