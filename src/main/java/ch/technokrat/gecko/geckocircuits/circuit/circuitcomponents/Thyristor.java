...
public final class Thyristor extends AbstractVoltageDropSwitch {
  ...
  public static final AbstractTypeInfo TYPE_INFO =
      new CircuitTypeInfo(Thyristor.class, "THYR", I18nKeys.THYRISTOR);
  ...
  final UserParameter<Double> _reverseRecoveryDelay =
      UserParameter.Builder.<Double>start("reverserecoverydelay", 0.0)
