...
public final class TerminalTwoPortComponent extends AbstractTerminal {
  ...
  public static Point getPointFromDirection(
      ComponentDirection direction, Point center, int _termDist) {
  ...
  public Point getPosition() {
    return getPointFromDirection(
        _parentElement.getComponentDirection(), _parentElement.getSheetPosition(), _termDist);
  }

  @Override
  public AbstractTerminal createCopy(AbstractBlockInterface relatedComponent) {
    final TerminalTwoPortComponent returnValue =
        new TerminalTwoPortComponent(relatedComponent, _termDist);
