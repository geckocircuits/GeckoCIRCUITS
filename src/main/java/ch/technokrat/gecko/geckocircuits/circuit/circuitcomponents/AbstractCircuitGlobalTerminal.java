...
public abstract class AbstractCircuitGlobalTerminal extends AbstractCircuitBlockInterface
    implements GlobalTerminable {
  public static final Map<AbstractComponentTyp, HashSet<AbstractCircuitGlobalTerminal>>
      ALL_GLOBALS = new HashMap<AbstractComponentTyp, HashSet<AbstractCircuitGlobalTerminal>>();
