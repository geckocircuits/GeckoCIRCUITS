...
public class MutualCouplingCalculator {
  ...
  public MutualCouplingCalculator(
      InductorCouplingCalculator l1, InductorCouplingCalculator l2, double k) {
    _k = k;
  ...
  void stampInductanceMatrix(
      double[][] inductanceMatrix, final List<InductorCouplingCalculator> allInductors) {
