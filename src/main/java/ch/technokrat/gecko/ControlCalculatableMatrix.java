...
/**
 * WARNING: this interface is only used within the Java-Block. However, it should not be moved to
 * this package. This interface is NOT allowed to be obfuscated. Otherwise, the java-Block has a
 * problem.
 *
 * @author andy
 */
