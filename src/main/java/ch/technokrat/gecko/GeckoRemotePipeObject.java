...
/**
 * This class contains the description of a GeckoRemote i.e. AbstractGeckoCustom method being
 * called. It is used for the alternative, memory-mapped remote interface for GeckoCIRCUITS. Inside
 * this object all the relevant information is packed, and then the object is serialized and written
...
public class GeckoRemotePipeObject implements Serializable {
  ...
  // internal enum which defines which type of action this objects represents - a method call, a
  // return variable, successful void return, or an error message
  public static enum GeckoRemotePipeObjectType {
    METHOD_CALL,
    METHOD_RETURN_VALUE,
    METHOD_VOID_RETURN,
    ERROR_MESSAGE
  ...
  private final String
      _methodName; // the name of the method - must be set for all types (method calls and returns
  // and errors)
  private final Object[] _methodArguments; // method arguments for method call - null in other cases
  private final Object
      _methodReturnValue; // the return value of the method - null if void or if not a return action
   ...
   * @param methodArguments the arguments of the method, IN THE ORDER they appear in the method
   *     definition!
   */
