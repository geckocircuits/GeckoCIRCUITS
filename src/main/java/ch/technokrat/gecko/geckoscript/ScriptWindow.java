...
public class ScriptWindow extends javax.swing.JFrame {
  ...
  public ScriptWindow(SimulationAccess circuitSim) {
    ...
    jComboBoxCategory.addActionListener(
        new ActionListener() {
    ...
    jListFunctions.addMouseListener(
        new MouseAdapter() {
  ...
  public void optionJDialog(String displayText) {
    ...
    JOptionPane optPane =
        new JOptionPane(displayText, JOptionPane.INFORMATION_MESSAGE, JOptionPane.PLAIN_MESSAGE);
  ...
  private void initComponents() {
    ...
    jPanel2.setBorder(
        javax.swing.BorderFactory.createTitledBorder("public void runScript() { ... }"));
    ...
    jPanel2Layout.setHorizontalGroup(
        jPanel2Layout
            ...
            .addComponent(
                jPanelCodeEditor, javax.swing.GroupLayout.DEFAULT_SIZE, 1072, Short.MAX_VALUE));
    jPanel2Layout.setVerticalGroup(
        jPanel2Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                jPanelCodeEditor, javax.swing.GroupLayout.DEFAULT_SIZE, 539, Short.MAX_VALUE));
    ...
    jListFunctions.setFont(
        jListFunctions.getFont().deriveFont(jListFunctions.getFont().getSize() - 1f));
    ...
    jPanel3Layout.setHorizontalGroup(
        jPanel3Layout
            ...
            .addComponent(
                jComboBoxCategory, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
    ...
    jPanel4Layout.setHorizontalGroup(
        jPanel4Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                jPanelImports, javax.swing.GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE));
    jPanel4Layout.setVerticalGroup(
        jPanel4Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                jPanelImports, javax.swing.GroupLayout.DEFAULT_SIZE, 57, Short.MAX_VALUE));
    ...
    jPanel5Layout.setHorizontalGroup(
        jPanel5Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                jPanelDeclarations, javax.swing.GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE));
    jPanel5Layout.setVerticalGroup(
        jPanel5Layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                jPanelDeclarations, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE));
    ...
    jPanelCodeLayout.setHorizontalGroup(
        jPanelCodeLayout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                jSplitPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1084, Short.MAX_VALUE));
        ...
        jPanelRunOutputLayout
            ...
            .addGroup(
                jPanelRunOutputLayout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 1060, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanelRunOutputLayout
            ...
            .addGroup(
                jPanelRunOutputLayout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 748, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanelInfoLayout
            ...
            .addGroup(
                jPanelInfoLayout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 1060, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanelInfoLayout
            ...
            .addGroup(
                jPanelInfoLayout
                    ...
                    .addContainerGap()
                    .addComponent(
                        jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 748, Short.MAX_VALUE)
                    .addContainerGap()));
    ...
    jButtonFunctionDetails1.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButtonAdditionalSources.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    layout.linkSize(
        ...
        new java.awt.Component[] {jButtonAbort, jButtonCloseWindow, jButtonCompile, jButtonRun});
  ...
  private void jButtonRunActionPerformed(
      java.awt.event.ActionEvent evt) { // NOPMD//GEN-FIRST:event_jButtonRunActionPerformed
  ...
  private void jButtonFunctionDetails1ActionPerformed(
      java.awt.event.ActionEvent
          evt) { // NOPMD//GEN-FIRST:event_jButtonFunctionDetails1ActionPerformed
  ...
  private void jButtonAdditionalSourcesActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonAdditionalSourcesActionPerformed
    if (!_extWindowInit) {
  ...
  private static final String functionDetails =
      "<font face=\"Tahoma\" size=\"3\">This is a set of functions available within the GeckoSCRIPT which allows the user to write "
    ...
    if (docAnnotation != null && declaration != null) {
      ...
      if (selection == MethodCategory.ALL_CATEGORIES || category.value() == selection) {
        _listModel.addElement(
            new FunctionDescription(declaration.value(), docAnnotation.value().getTranslation()));
      }
    } else {
      if (docAnnotation == null && declaration != null
          || docAnnotation != null && declaration == null) {
