...
public class ParameterSupport extends javax.swing.JFrame {
  ...
  public ParameterSupport(final SimulationAccess circuit) {
    ...
    _listSelectBlockType.setCellRenderer(
        new DefaultListCellRenderer() {
          ...
          public Component getListCellRendererComponent(
            ...
            return _wrapped.getListCellRendererComponent(
    ...
    _listAvailableParameters.setCellRenderer(
        new DefaultListCellRenderer() {
          public Component getListCellRendererComponent(
              final JList list,
              final Object value,
  ...
  private void initComponents() {
    ...
    _listSelectBlockType.addListSelectionListener(
        ...
        jPanel1Layout
            ...
            .addGroup(
                jPanel1Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 296, Short.MAX_VALUE)
                    .addContainerGap()));
        ...
        jPanel2Layout
            ...
            .addGroup(
                jPanel2Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 421, Short.MAX_VALUE)
                    .addContainerGap()));
  ...
  private void _listSelectBlockTypeValueChanged(
      javax.swing.event.ListSelectionEvent
          evt) { // GEN-FIRST:event__listSelectBlockTypeValueChanged
    final AbstractTypeInfo selectedType =
        (AbstractTypeInfo) (_listSelectBlockType.getSelectedValue());
  ...
  private void updateAccessibleParameters(final AbstractTypeInfo selectedType) {
    ...
    for (List<AbstractBlockInterface> currentList : _allComponents) {
      ...
      final List<UserParameter<? extends Object>> currentElemTypeFields =
          firstElement.getRegisteredParameters();
      ...
      if (currentList.get(0).getTypeInfo().equals(selectedType)) {
        ...
        if (currentElemTypeFields.isEmpty()) {
          ...
          for (UserParameter parameter : currentElemTypeFields) {
            if (!(parameter.getValue()
                instanceof String)) { // string parameters cannot be accessed!
              _availableParametersModel.addElement(
                  parameter.getShortName() + "\t(" + parameter.getLongName() + ")");
            }
          }
        }
        ...
        if (firstElement instanceof Operationable) {
          List<Operationable.OperationInterface> ops =
              ((Operationable) firstElement).getOperationEnumInterfaces();
          _availableParametersModel.addElement(
              "-- POSSIBLE OPERATIONS (see method \"doOperation\") --");
          for (Operationable.OperationInterface op : ops) {
            String opName = op.toString();
            String opDoc = op.getDocumentationString();
            _availableParametersModel.addElement(
                "Operation name: \"" + opName + "\"  ( " + opDoc + " )");
          }

          _availableParametersModel.addElement(
              "Operation name: \"setTextFieldPosition\" ( Example: doOperation(\"R.1\", \"setTextFieldPosition\", new double[]{2.1, 1.5});");
        }
      }
    }
  }
