...
public class InitParameters {
  ...
  public static final String DATABASE_ERROR_MESSAGEb =
      "Please select English or establish connection.";
  /** Connection error message 3 */
  public static final String DATABASE_ERROR_MESSAGEc =
      "   Please re-establish connection and try again.";
  ...
  /**
   * Used to separate suggestions from comments pages IMPORTANT: This has to be a regex expression!)
   */
