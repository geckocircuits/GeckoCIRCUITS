...
public class DLbot {
  ...
  /**
   * Downloads all current single-line translations for the chosen language (other than English) off
  ...
  public static DoubleMap getTranslations_single() {
    try {
      ...
      SimpleArticle sa =
          b.readData(InitParameters.SINGLE_PAGE + "/" + InitParameters.getCurrentLanguageCode());
      ...
      new TranslationDialog(
              InitParameters.DATABASE_ERROR_MESSAGEa, InitParameters.DATABASE_ERROR_MESSAGEb)
          .setVisible(true);
      connected = false;
      return null;
    }
  ...
  /**
   * Downloads all current multiple-line translations for the chosen language off of the Wiki
   * database
   *
  ...
  /**
   * Method to get download progress - To be called while downloading from a separate thread
   *
  ...
  /** Method to reinitialize progress - To be called after completing download instructions */
