  ...
  private class Task extends SwingWorker<Void, Void> {
    ...
    public Void doInBackground() {
      if (confirmedSingle) {
        ...
        UPbot.addTranslationSuggestion_single(
            keysSingle.get(counterSingle), newTranslationSingle, commentSingle);
      }
      if (confirmedMultiple) {
        // upload multiple-line suggestion
        UPbot.addTranslationSuggestion_multiple(
            keysMultiple.get(counterMultiple), newTranslationMultiple, commentMultiple);
      }
      return null;
    }
          ...
          public void actionPerformed(ActionEvent e) {
            if (changed) {
              ...
              if (confirmedSingle || confirmedMultiple) {
                ...
                progressMonitor =
                    new ProgressMonitor(
                        TranslationTools.this, InitParameters.P_BAR_MESSAGE_UP, "", 0, 100);
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            if (counterSingle > 1) {
              ...
              // "Original English" text field in single-line
              jTextField6.setText(
                  LangInit.englishMap_single.getValue(keysSingle.get(counterSingle)));
              // "Current Translation" text field in single-line
              jTextField7.setText(LangInit.transMap_single.getValue(keysSingle.get(counterSingle)));
            }
          }
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            if (counterMultiple > 1) {
              ...
              // "Original English" text area in multiple-line
              jTextArea5.setText(
                  LangInit.englishMap_multiple.getValue(keysMultiple.get(counterMultiple)));
              // "Current Translation" text area in multiple-line
              jTextArea4.setText(
                  LangInit.transMap_multiple.getValue(keysMultiple.get(counterMultiple)));
            }
          }
        });
  ...
  private void initComponents() {
    ...
    jLabel2.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/gecko/i18n/resources/arrow.jpg"))); // NOI18N
    ...
    jPanel3Layout.linkSize(
        javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jButton6, jButton7});
    ...
    jPanel4Layout.linkSize(
        javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jButton10, jButton9});
    ...
    jPanel4Layout.linkSize(
        ...
        new java.awt.Component[] {jScrollPane3, jScrollPane4, jScrollPane5});
