...
public enum I18nKeys {
  ...
  WE_WANT_TO_IMPROVE_OUR_SOFTWARE(
      "<html>We want to improve our software! If you would like to submit a bug-report, <br>give us suggestions about features that we should implement in the software, <br>or you have other issues, then please visit our bugtracking homepage:"),
  BATIK_LICENSE(
      "GeckoCIRCUITS uses the \"Batik SVG Vector-Graphics libraries\" and \"JSyntaxPane\", which are both licensed under the Apache License (Version 2.0):"),
  YOU_ATTEMPTED_TO_CLOSE_WHILE_SIMULINK(
  ...
  COULD_NOT_FIND_PATH_TO_GECKOCIRCITS_INSTALL(
  ...
  YOU_CAN_PROCEED_WITH_CURRENT(
      "You can proceed with the simulation with the current parameter set."),
  ERROR_PARAMETER_DEFINITION_MISSING("*** ERROR: Parameter Definition Missing ***"),
  NO_ERRORS("No Errors."),
  THE_SIM_CANNOT_START(
      "The simulation cannot be started. Please set the missing parameters first."),
  ...
  IDEAL_DIODE_WITH_ON_RESISTANCE(
      "Ideal diode with on-resistance, off-resistance and forward voltage drop"),
  INSULATED_GATE_BIPOLAR_TRANSISTOR(
      "Insulated Gate Bipolar Transistor (ideal switch model with series diode)"),
  LINE_IMPEDANCE_STABILIZATION_NETWORK("Line Impedance Stabilization Network (LISN)"),
  INDUCTOR_THAT_CAN_BE_COUPLED(
      "Inductor that can be coupled via magnetic coupling components (mutual inductances)"),
  LC_INDUCTOR_SELECTION("Lc Inductor selection"),
  NO_LC_FOUND("No Lc-Component found in circuit."),
  IDEALIZED_METAL_OXIDE_FIELD_EFFECT(
      "Idealized Metal Oxide Field Effect Transtor with integrated anti-parallel ideal diode"),
  ...
  INDUCTOR_RELUCTANCE_COUPLING_COMPONENT(
      "Inductor-Reluctance: Coupling component between<br>electric and reluctance circuit"),
  NONLINEAR_RELUCTANCE_DESCRIPTION(
      "Flux dependent Reluctance: Enables inductor modeling <br> with core saturation effects."),
  ...
  COMPONENT_FOR_DATA_VISUALIZATION(
      "Component for data visualization and plotting of simulation curves."),
  SCOPE("Scope"),
  ...
  IF_TRUE_USE_NONLINEAR_CHARACTERISTIC(
      "If true, use nonlinear characteristic of circuit component"),
  IF_TRUE_TRANSPOSE_DATA("If true, exchange output rows/columns (transposition)"),
  SKIP_DATA_POINTS(
      "If number > 1, every n'th data point is used (and (n-1)th are skipped) when saving the data to a file."),
  IF_TRUE_PRINT_HEADER("If true, print header information into data file"),
  SIGNIFICANT_DIGITS(
      "Determines the number of digits written to the file for every data point. Reducing this value"
  ...
  TYPE_OF_SIGNAL_SOURCE(
      "Signal source tpye: Sinus: 0, Triangle: 1, Rectangle: 2, Random: 3, Import: 4"),
  ...
  USE_MATRICES_FOR_JAVA_CODE_INPUT_OUTPUT(
      "Use matrices for Java code input/output variables xIN and yOUT instead of vectors."),
  ENABLE_DEBUGGING_OPTIONS(
      "When enabled, source files will be saved on hard-disk for debugging purposes."),
  ...
  ERROR_CLIENT_IS_REGISTERED_BUT_CANNOT_BE_CONTACTED(
      "Error: Client is registered, but cannot be contacted! Probably the connection timed out"),
  ...
  VALUE("Value"),
  USAGES("Usages"),
  SET_THE_TOTAL_SIMULATION_TIME_TO_THE_GIVEN_VALUE_TEND(
      "Set the total simulation time to the given value Tend."),
  RUNS_THE_SIMULATION_CURRENTLY_LOADED(
      "Runs the simulation currently loaded into GeckoCIRCUITS, "
          + "from start to finish as defined in the simulator settings."),
  INIT_SIMULATION_WO_PARAMETERS(
      "Initializes the simulation. Call before using the simulateStep() "
          + "or simulateSteps(int steps) functions, i.e. if controlling the simulation step by step is wanted."),
  INIT_SIMULATION_WITH_PARAMETERS(
      "Initializes the simulation with the specified time step and total simulation time."
  ...
  CONTINUE_SIMULATION_DOC(
      "Continue the preceeding simulation. The simulation stepwidth and simulation"
  ...
  OPEN_FILE_DOCUMENTATION(
      "Opens a model file with the given file path \"fileName\". Both, global an local file paths can be"
          ...
          + "<br>}"),
  SAVE_FILE_AS_DOCUMENTATION(
      "Save the current model file to the given path \"fileName\". Only global file-paths are accepted."),
  SIMULATE_STEP_DOCUMENTATION("Runs one time step of the simulation."),
  SIMULATE_STEPS_DOCUMENTATION(
      "Runs consecutively the number of simulation time steps specified by \"steps\"."),
  SIMULATE_TIME_DOCUMENTATION(
      "Runs the simulation for the duration of simulation" + " time specified by \"time\"."),
  END_SIMULATION_DOCUMENTATION(
      "Finishes the simulation. Use this function if the methods for simulation step-by-step were used."),
  GET_SIGNAL_DATA_DOCUMENTATION(
      "Get the Data, as written into the scope. The signalName parameter is the named input label of"
  ...
  GET_TIME_ARRAY_DOCUMENTATION(
      "Call this function in combination with getSignalData(...). The returned values "
          + "are the time values corresponding to the signal data from getSignalData()."),
  WRITE_OUTPUT_DOCUMENTATION(
      "Writes the String given as the argument to the Output tab of the GeckoSCRIPT window. "
          + "Use for writing output from your script."),
  WRITE_OUTPUT_LN_DOCUMENTATION(
      "Writes the String given as the argument as a new line to the Output tab "
          + "of the GeckoSCRIPT window. Use for writing output from your script."),
  SET_PARAMETER_DOCUMENTATION(
      "Sets the specified parameter of the specified circuit element. The arguments"
  ...
  SET_PARAMETERS_DOCUMENTATION(
      "Sets the specified parameters of the specified element, allowing several parameters to be set at"
  ...
  GET_PARAMETER_DOCUMENTATION(
      "Returns the value of the specified parameter of the specified element. The"
  ...
  GET_OUTPUT_DOCUMENTATION(
      "Returns the value of the output port of a control block. The arguments are the"
  ...
  GET_OUTPUT_SINGLE_PARAMETER(
      "Returns the value of the output port of a control block which has only one output. "
  ...
  SET_COMPONENT_NAME_DOCUMENTATION(
      "Change the name of component \"oldName\" to a new name. If the component cannot be found,"
          + " or the new name is already in use, a RuntimeException will be thrown."),
  GET_CIRCUIT_ELEMS_DOC(
      "Returns, as an array of Strings, the names of all the circuit elements"
          + " (e.g. switches, capacitors, resistors...) in the model."),
  GET_CONTROL_ELEMS_DOC(
      "Returns, as an array of Strings, the names of all control elements in the model."),
  GET_THERM_ELEMS_DOC(
      "Returns, as an array of Strings, the names of all thermal elements in the model."),
  GET_SPEC_ELEMS_DOC(
      "Returns, as an array of Strings, the names of all model components that don't fit into the regular categories."),
  ...
  GET_IDEAL_SWITCHES_DOC(
      "Returns, as an array of Strings, the names of all ideal switches in the model."),
  ...
  GET_SIG_AVG_DOC(
      "Returns the calculated average value of the waveform stored in a particular SCOPE"
  ...
  GET_SIG_RMS_DOC(
      "Returns the calculated root-mean-square (RMS) value of the waveform stored in a particular SCOPE"
          + " channel with a specified Portlabel (\"signalName\"). The times in between which"
          + " the calculation is to take place must also be specified; "
  ...
  GET_SIG_MIN_DOC(
      "Returns the minimum value of the waveform stored in a particular SCOPE"
          + " channel with a specified Portlabel (\"signalName\"). The times in between which"
          + " the calculation is to take place must also be specified; "
  ...
  GET_SIG_MAX_DOC(
      "Returns the maximum value of the waveform stored in a particular SCOPE"
          + " channel with a specified Portlabel (\"signalName\"). The times in between which"
          + " the calculation is to take place must also be specified; "
          + "\"startTime\" cannot be less than 0 and \"endTime\" cannot be greater than the total simulation time.<br><br>"
          + "Example: double max = getSignalMax(\"U.1\",0,0.5e-3,20e-3);"),
  GET_SIG_THD_DOC(
      "Returns the calculated total harmonic distortion (THD) of the waveform stored in a particular SCOPE"
          + " channel with a specified Portlabel (\"signalName\"). The times in between which"
          + " the calculation is to take place must also be specified; "
          + "\"startTime\" cannot be less than 0 and \"endTime\" cannot be greater than the total simulation time.<br><br>"
          + "Example: double thd = getSignalTHD(\"U.1\",0,0.5e-3,20e-3);"),
  GET_SIG_RIP_DOC(
      "Returns the calculated ripple of the waveform stored in a particular SCOPE"
          + " channel with a specified Portlabel (\"signalName\"). The times in between which"
          + " the calculation is to take place must also be specified; "
          + "\"startTime\" cannot be less than 0 and \"endTime\" cannot be greater than the total simulation time.<br><br>"
          + "Example: double ripple = getSignalRipple(\"U.1\",0,0.5e-3,20e-3);"),
  GET_SIG_SHAPE_DOC(
      "Returns the calculated shape factor value of the waveform stored in a particular SCOPE"
          + " channel with a specified Portlabel (\"signalName\"). The times in between which"
          + " the calculation is to take place must also be specified; "
          + "\"startTime\" cannot be less than 0 and \"endTime\" cannot be greater than the total simulation time.<br><br>"
          + "Example: double shape = getSignalShape(\"U.1\",0,0.5e-3,20e-3);"),
  GET_SIG_KLIRR_DOC(
      "Returns the calculated klirrfactor value of the waveform stored in a particular SCOPE"
          + " channel with a specified Portlabel (\"signalName\"). The times in between which"
          + " the calculation is to take place must also be specified; "
          + "\"startTime\" cannot be less than 0 and \"endTime\" cannot be greater than the total simulation time.<br><br>"
          + "Example: double klirr = getSignalKlirr(\"U.1\",0,0.5e-3,20e-3);"),
  INIT_STEADY_STATE_DETECTION(
      "GeckoSCRIPT provides the ability to simulate a power electronic circuit until a periodic steady-state is reached."
  ...
  INIT_STEADY_STATE_DETECTION_XC(
      "GeckoSCRIPT provides the ability to simulate a power electronic circuit until a periodic steady-state is reached."
          + " Steady state can be detected for circuits with well-defined periods (e.g. pulse-width modulated converters). To"
          + " initialize steady-state detection, the user must supply the circuit's state variables - those values by which steady-"
          + " state can be detected - these are typically inductor currents and capacitor voltages. The \"stateVariables\""
  ...
  SIMULATE_UNTIL_STEADY_STATE(
      "Simulates a model until periodic steady-state is detected or until the end of the defined simulation time."
  ...
  SIMULATE_TO_STEADY_STATE_DEFAULT(
      "Simulates a model until periodic steady-state is detected or until the end of the defined simulation time."
          + " The function \"initSteadyStateDetection()\" must be called first with the appropriate arguments. Setting "
          + " \"supressMessages\" to \"true\" omits the printing of messages by the function to the GeckoSCRIPT output"
          + " pane and thus speeds up execution. Returned is an array with the results of the steady-state"
  ...
  GET_FOURIER_1_DOC(
      "Performs an FFT on the data stored in the specified channel of the specified SCOPE, where SCOPE ports are numbered"
  ...
  GET_FOURIER_2_DOC(
      "Returns, as a two-dimensional array of doubles, calculated Fourier series coefficients for the"
          + " waveform at SCOPE channel at port 0 (the upper-most port). Convenient for use with single-port SCOPEs."),
  SET_LOSS_FILE_DOC(
      "Sets the detailed loss model file for a semiconductor element (IGBT, ideal"
  ...
  CREATE_COMPONENT_DOC(
      "Creates a new component in the circuit sheet. The parameter compType specifies the component to create,"
  ...
  CREATE_CONNECTOR_DOC(
      "Creates a new connector (wire) in the circuit sheet. The connector name is for later reference. Qualified,"
  ...
  DELETE_COMPONENT_DOC(
      "Deletes the component with the name \"elementName\". In case you like to delete a component"
          + " inside a subcircuit block, please use the path separator \"#\". <br><br>"
          + "Example: deleteComponent(\"SUBCIRCUIT.1#C.5\");"),
  DELETE_ALL_COMPONENTS_DOC(
      "Deletes all component within the given subcircuit sheet. In case \"null\" <br>is passed as parameter, the whole circuit model will be removed."
  ...
  SET_ORIENTATION_DOC(
      "Set the component rotation to a specific value. Allowed values for \"direction\"are \"DOWN\", \"LEFT\", \"UP\", \"RIGHT\";"),
  SET_POSITION_DOC(
      "Places the selected component \"elementName\" within its circuit sheet to the point coordinates (xPosition, yPosition)"),
  GET_POSITION_DOC(
      "Return the selected component \"elementName\" circuit sheet position x and y in an int array."),
  IMPORT_FROM_FILE_DOC(
      "Imports the simulation model from the given file name \"fileName\" into"
  ...
  DO_OPERATION_DOC(
      "This function allows calling methods that are individual for selected GeckoCIRCUITS components."
  ...
  SHUTDOWN_DOC(
      "Closes the GeckoCIRCUITS instance via System.exit(0). Be careful: modified models"
          + " will not be saved, the shutdown procedure is immediate!"),
  GET_SIM_TIME_DOC(
      "Returns the actual simulation time in seconds. When executing GeckoCIRCUITS"
          + "step by step, the simulation time increases by dt, respectively."),
  STORED_MATRIX_DOC(
      "This function is a conveniece function, please see also the corresponding setter / getter"
  ...
  GLOBAL_PAR_DOC(
      "Here, you can get/set the GeckoCIRCUITS global parameters (e.g. defined as \"$PARAMETER 123\") within"
  ...
  FLOAT_FFT_DOC(
      "This is a convenience function for your own Java / scripting code. It performs"
  ...
  GET_PEAK_AT_FREQ(
      "Return the \"PEAK\"-calculation of the EMI spectrum at the given frequency. "
          + "Function parameter type: Double, return value: Double\""),
  GET_QUASI_PEAK_AT_FREQ(
      "Return the \"QUASI-PEAK\"-calculation of the EMI spectrum at the given frequency. "
          + "Function parameter type: Double, return value: Double"),
  GET_AVG_AT_FREQ(
      "Return the \"AVERAGE\"-calculation of the EMI spectrum at the given frequency. "
          + "Function parameter type: Double, return value: Double\""),
  SAVE_DATA_DOC(
      "Save the calcuation/simulation data in the given file. The function parameter"
          + "must be a String containing a valid filePath, e.g. /home/gecko/data.txt . No "
          + "return value (null)"),
  SAVE_DATA_DOC_BLOCKING(
      "Same behavior as \"doSaveData\", but command waits until results are written to disk. No "
          + "return value (null)"),
  SET_OUTPUT_FILE_NAME("Set the file name to the given value. No return value (null)"),
  START_CALCULATION_DOC(
      "Start the EMI testreceiver calculation with the settings as given"
  ...
  SET_TEXT(
      "Set the body text of the Text-Field component. Please note: Line-breaks have to be set by the user manually."),
  SET_NUMERATOR_POLYNOM(
      "Sets the numerator polynom coefficients of the transfer function."
          + "\n The parameter has to be a double[] array containing the numerator coefficients."),
  SET_DENOMINATOR_POLYNOM(
      "Sets the denominator polynom coefficients of the transfer function."
          + "\n The parameter has to be a double[] array containing the numerator coefficients."),
  SET_POLE_COEFF(
      "Sets the transfer function poles. The parameter has to be a double[] array containing"
          + "the pole values.\n Please note: the data has to be in the format new double[] data = {real1, im1, real2, im2, ...}"),
  SET_ZERO_COEFF(
      "Sets the transfer function zeros. The parameter has to be a double[] array containing"
          + "the zero values.\n Please note: the data has to be in the format new double[] data = {real1, im1, real2, im2, ...}"),
  SET_NONLINEAR_OPERATION_DOC(
      "Operation parameter should be a String containing the filename\n"
  ...
  EMI_DATA_EXPORT(
      "Please note that only data which is visible in the plot will be exported. To proceed, please select the output unit"
  ...
  IMPORTS_EXAMPLE(
      "Example: doOperation(\"JAVA.1\", \"setImportCode\", \"import static java.lang.Math.*;\");"
          + "   // Function parameter type: String, no return value."),
  SOURCE_CODE(
      "Example: doOperation(\"JAVA.1\", \"setSourceCode\", \"System.out.println(\"source test\"););"
          + "   // Function parameter type: String, no return value."),
  INIT_CODE(
      "Example: doOperation(\"JAVA.1\", \"setInitCode\", \"System.out.println(\"init test\"););"
          + "   // Function parameter type: String, no return value."),
  VARIABLES_CODE(
      "Example: doOperation(\"JAVA.1\", \"setInitCode\", \"double test = 20;););"
          + "   // Function parameter type: String, no return value."),
  SET_COMPONENT_COUPLING(
      "Example: doOperation(\"GATE.1\", \"setComponentCoupling\", \"IGBT.1\");"
          + "   // Function parameter type: String, no return value."),
  SET_COUPLING_LABEL(
      "Example: doOperation(\"VOLT.1\", \"setCouplingLabel\", \"signal\");"
          + "   // Function parameter type: String, no return value."),
  ;

  private static final Map<String, I18nKeys> _keyStringToEnumConstant =
      new HashMap<String, I18nKeys>();
  ...
  //        }
  /**
   * this constructor uses the enum name as the key. Be careful! Changing the enum name will create
   * a problem. Whenever you want to change the enum name, then use the constructor with the
   * explicit key value.
   */
