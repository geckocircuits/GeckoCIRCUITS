...
public class GeckoRemoteException extends Exception {
  ...
  /** Creates a new instance of <code>GeckoRemoteObjectException</code> without detail message. */
  public GeckoRemoteException() {}

  /**
   * Constructs an instance of <code>GeckoRemoteObjectException</code> with the specified detail
   * message.
   *
  ...
  /**
   * Create a new GeckoRemoteException which contains a reference to the exception (e.g.
   * IOException, or other) which cause the GeckoRemote exception.
   *
