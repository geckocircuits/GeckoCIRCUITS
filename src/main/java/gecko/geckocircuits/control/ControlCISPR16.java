...
public final class ControlCISPR16 extends RegelBlock implements SpecialNameVisible,
    ...
    private class CisprCalculator extends AbstractControlCalculatable implements MemoryInitializable {
        ...
        public void doInit(final double deltaT) {
            try {
                _zvDatenRam = DataContainerSimple.fabricConstantDtTimeSeries(1, (int) ((SimulationKernel.getStaticTEND() - SimulationKernel.getStaticTSTART()) / deltaT)
                        + DATA_INDEX_ADD);
