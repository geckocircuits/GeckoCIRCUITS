...
public final class ControlTERMINAL extends RegelBlock implements SubCircuitTerminable {
    ...
    public void copyAdditionalParameters(final AbstractBlockInterface originalBlock) {
        ...
        _wrapped.copyAdditionalParameters(((ControlTERMINAL) originalBlock)._wrapped);
    }
    ...
    protected Window openDialogWindow() {
        return new ControlTerminalDialog(this);
    }
