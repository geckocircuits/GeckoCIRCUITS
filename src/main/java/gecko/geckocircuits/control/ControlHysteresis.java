...
public final class ControlHysteresis extends RegelBlock implements ControlInputTwoTerminalStateable {
    ...
    public static final ControlTypeInfo tinfo = new ControlTypeInfo(ControlHysteresis.class, "HYS", I18nKeys.HYSTERESIS);
    ...
    protected Window openDialogWindow() {
        return new ControlHysteresisDialog(this);
    }
