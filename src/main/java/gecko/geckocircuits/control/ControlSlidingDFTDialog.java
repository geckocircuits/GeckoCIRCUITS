...
import gecko.geckocircuits.control.ControlSlidingDFT.OutputData;
...
final class ControlSlidingDFTDialog extends DialogElementCONTROL<ControlSlidingDFT> {
    ...
    private void addComboBox(final OutputData data) {
        ...
        frequencySelectionBox.addItem(ControlSlidingDFT.OutputData.ABS);
        frequencySelectionBox.addItem(ControlSlidingDFT.OutputData.REAL);
        frequencySelectionBox.addItem(ControlSlidingDFT.OutputData.IMAG);
        frequencySelectionBox.addItem(ControlSlidingDFT.OutputData.PHASE);
