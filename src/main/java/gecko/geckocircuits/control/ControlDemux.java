...
public final class ControlDemux extends RegelBlock implements VariableTerminalNumber {
    private static final long serialVersionUID = 1L;

    private static final double DA_CONST = 0.5;
    private static final double WIDTH = 0.3;
    private static final int DEFAULT_TERM_NUMBER = 3;
    public static final ControlTypeInfo tinfo = new ControlTypeInfo(ControlDemux.class, "DEMUX", I18nKeys.CONTROL_DEMUX);
    public ControlJavaFunction _connectedJavaBlock;
