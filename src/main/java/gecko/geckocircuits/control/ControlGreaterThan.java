...
public final class ControlGreaterThan extends SimpleRegelBlock {
    public static final ControlTypeInfo tinfo = new ControlTypeInfo(ControlGreaterThan.class, "GT", I18nKeys.GREATER_THAN);

    public ControlGreaterThan() {
        super(2, 1);
    }
