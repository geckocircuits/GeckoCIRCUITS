...
public class DialogFourierDiagram extends JDialog implements ComponentListener {
    ...
    private FourierDiagram[] diagrams;
    ...
    private void buildGUI() {
        ...
        diagrams = new FourierDiagram[_worksheet.getRowLength()+1];
        ...
        for (int i1 = 1; i1 < _worksheet.getRowLength()+1; i1++) {
            if (_signalFourierAnalysiert[i1]) {
                ...
                //---------
                diagrams[i1 - 1] = new FourierDiagram(_cn[i1 - 1], _nMin, _f1);
