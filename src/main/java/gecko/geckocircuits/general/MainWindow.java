...
public final class MainWindow extends JFrame implements WindowListener, ActionListener, ComponentListener {
    ...
    public boolean saveZVData(String stringID_scope, String fileName) {
        ...
        for (RegelBlock ec : eC) {
            if (ec.getStringID().equals(stringID_scope) && ec instanceof ControlOSZI) {
                ScopeFrame scope = ((ControlOSZI) ec)._scopeFrame;
    ...
    public void initStartWithErrorDialogMessage() {
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    ...
                    JOptionPane.ERROR_MESSAGE);
            pauseSimulation();
            _simRunner.simKern._simulationStatus = SimulationKernel.SimulationStatus.FINISHED;
