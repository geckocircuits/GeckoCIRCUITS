...
import ch.technokrat.gecko.systemtests.GoldenReferenceHelper.GoldenEntry;
        ...
        for (GoldenEntry golden : goldenEntries) {
            try {
                ...
                assertNotNull(actual,
                        "getSignalCharacteristics returned null for " + golden.scopeName + " port " + golden.port);
                assertTrue(actual.length > 0,
                        "getSignalCharacteristics returned empty for " + golden.scopeName + " port " + golden.port);
