...
public abstract class AbstractSimpleMathFunctionTest {
    ...
    public final void setUp() {
        ...
        _controlCalculatable._inputSignal = new double[1];
        _controlCalculatable._inputSignal[0] = 0;
        _controlCalculatable._outputSignal = new double[1];
        _controlCalculatable._outputSignal[0] = 0;
