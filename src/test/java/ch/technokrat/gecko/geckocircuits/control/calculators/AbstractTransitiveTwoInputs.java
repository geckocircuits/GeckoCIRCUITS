...
/**
 * any function, where the input arguments can be exchanged and the result should not change is here
 * called "Transitive". Addition is transitive. Subtraction not!
 *
 * @author andy
 */
public abstract class AbstractTransitiveTwoInputs extends AbstractTwoInputsMathFunctionTest {
  ...
  public void testTransitivity() {
    ...
    _controlCalculatableTwoInputs._inputSignal[1][0] =
        _controlCalculatableTwoInputs._inputSignal[0][0];
