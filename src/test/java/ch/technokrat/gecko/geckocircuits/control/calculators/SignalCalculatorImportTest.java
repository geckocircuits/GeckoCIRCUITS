...
public class SignalCalculatorImportTest {
  ...
  final double[][] testTable =
      new double[][] {
        new double[] {
          0.0, 2.17E-4, 5.0E-4, 6.0E-4, 8.0E-4, 0.0010, 0.0011, 0.0013, 0.0040, 0.0040015, 0.0050,
          0.0050015, 0.0060, 0.006003, 0.0070, 0.007003, 0.0080, 0.008003, 0.0090, 0.0090015, 0.01,
          0.0100015, 0.011, 0.011003, 0.012, 0.012003, 0.013
        },
        new double[] {
          0.0, 20.0, 34.0, 36.0, 38.5, 39.5, 39.7, 40.0, 40.0, 20.0, 20.0, 40.0, 40.0, 0.5, 0.5,
          40.0, 40.0, 15.0, 15.0, 25.0, 25.0, 40.0, 40.0, 4.0, 4.0, 40.0, 40.0
        }
      };
  ...
  public void testCorruptedData() {
    final double[][] wrongData =
        new double[][] {new double[] {0, 1, 3, 2}, new double[] {0, 0, 0, 0}};
