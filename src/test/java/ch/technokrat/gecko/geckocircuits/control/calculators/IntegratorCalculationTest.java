...
public class IntegratorCalculationTest {
  /**
   * the deltaT is quite "large" here, possibly this will lead to a test failure in the future. But
   * this should encourage the programmers only to increase the integration accuracy...
   */
