 ...
 * @author andy
 */
public class MinCalculatorMultiInputsTest extends AbstractMultiInputFunctionTest {

    @Override
    public AbstractControlCalculatable calculatorFabricTwoInputs() {
        return new MinCalculatorMultiInputs(2);
    }

    @Override
    public AbstractControlCalculatable calculatorFabricThreeInputs() {
        return new MinCalculatorMultiInputs(3);
    }
