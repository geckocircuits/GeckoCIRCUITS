...
public final class SignalCalculatorTriangleTest {
  ...
  /**
   * WARNING: giving a negative amplitude makes probems in this test. Then, the output signal is
   * just zero? but in the simulation model, the triangle still works, even with a negative
   * amplude... strange. Andy.
   */
