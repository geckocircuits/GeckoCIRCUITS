...
/**
 * Comment: The Native C Test Libraries were compiled on a Windows x86_64 machine with GCC. To use
 * them, you need to run the JUnit test under Windows 64bit. Otherwise, please recompile them and if
 * necessary edit the fileName.
 *
