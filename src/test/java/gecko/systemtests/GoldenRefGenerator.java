 ...
 *        gecko.systemtests.GoldenRefGenerator \
 *        src/test/resources/ipes/education \
 *        src/test/resources/golden
 * </pre>
 *
 * <p>To generate from v2.02 baseline, build v2.02 and adjust the classpath.
 */
public final class GoldenRefGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Wait for full initialization (GeckoSim.main is synchronous in testing mode)
        Thread.sleep(3000);
