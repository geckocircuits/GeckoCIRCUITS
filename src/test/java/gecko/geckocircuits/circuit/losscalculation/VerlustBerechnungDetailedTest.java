...
/**
 * Unit tests for VerlustBerechnungDetailed and its inner class LossCalculatorDetailed.
 ...
 */
public class VerlustBerechnungDetailedTest {

    private static final double TOLERANCE = 1e-10;

    private Diode testDiode;
    private VerlustBerechnungDetailed verlustBerechnung;
    ...
    public void setUp() {
        ...
        // Get VerlustBerechnungDetailed through the LossProperties
    ...
    public void testCopyPropertiesFrom_CopiesSwitchingCurves() throws Exception {
        ...
        VerlustBerechnungDetailed source = sourceDiode.getVerlustBerechnung().getDetailedLosses();
    ...
    public void testLossCalculatorDetailed_DefaultReferenceVoltage() throws Exception {
        ...
        for (Class<?> declaredClass : VerlustBerechnungDetailed.class.getDeclaredClasses()) {
