...
/**
 * Tests for VerlustBerechnungDetailed file I/O methods using a mock LossFileAccessor.
 ...
 */
public class VerlustBerechnungDetailedFileOpsTest {
    ...
    private VerlustBerechnungDetailed verlust;
    ...
    public void setUp() {
        ...
        verlust = new VerlustBerechnungDetailed(testDiode, lossProperties, mockAccessor);
    }
    ...
    public void testDefaultConstructor_CreatesMainWindowAccessor() {
        ...
        VerlustBerechnungDetailed defaultInstance = diode.getVerlustBerechnung().getDetailedLosses();
     ...
     * matching the format that VerlustBerechnungDetailed.schreibeDetailVerlusteAufDatei produces.
     */
    private String generateLossFileContent(List<SwitchingLossCurve> switchCurves,
            List<LeitverlusteMesskurve> condCurves) {
        StringBuffer ascii = new StringBuffer();
        gecko.geckocircuits.allg.ProjectData.appendAsString(
