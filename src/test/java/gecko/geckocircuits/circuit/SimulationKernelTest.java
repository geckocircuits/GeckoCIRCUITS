...
/**
 * Unit tests for SimulationKernel - the main simulation engine.
 *
...
public class SimulationKernelTest {
    ...
    private SimulationKernel simulationsKern;

    @Before
    public void setUp() {
        simulationsKern = new SimulationKernel();
    }
    ...
    public void testSetZeiten_UpdatesStaticAccessors() {
        ...
        SimulationKernel kern1 = new SimulationKernel();
        ...
        assertEquals(5.0, SimulationKernel.getStaticTEND(), 1e-15);
        assertEquals(0.0, SimulationKernel.getStaticTSTART(), 1e-15);
    }
    ...
    public void testMultipleKernelInstances_HaveIndependentStatus() {
        SimulationKernel kern1 = new SimulationKernel();
        SimulationKernel kern2 = new SimulationKernel();
    ...
    public void testGetSimulationStatus_NotInit() {
        ...
        assertEquals("Should return NOT_INIT",
                gecko.geckocircuits.api.ISimulationEngine.SimulationStatus.NOT_INIT,
    ...
    public void testGetSimulationStatus_Running() {
        ...
        assertEquals("Should return RUNNING",
                gecko.geckocircuits.api.ISimulationEngine.SimulationStatus.RUNNING,
                simulationsKern.getSimulationStatus());
    }
    ...
    public void testGetSimulationStatus_Paused() {
        ...
        assertEquals("Should return PAUSED",
                gecko.geckocircuits.api.ISimulationEngine.SimulationStatus.PAUSED,
                simulationsKern.getSimulationStatus());
    }
    ...
    public void testGetSimulationStatus_Finished() {
        ...
        assertEquals("Should return FINISHED",
                gecko.geckocircuits.api.ISimulationEngine.SimulationStatus.FINISHED,
                simulationsKern.getSimulationStatus());
    }
    ...
    public void testImplementsISimulationEngine() {
        assertTrue("SimulationKernel should implement ISimulationEngine",
                simulationsKern instanceof gecko.geckocircuits.api.ISimulationEngine);
    }
}
