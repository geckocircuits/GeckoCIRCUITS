 ...
 */
public class UniqueObjectIdentifierTest {

    private UniqueObjectIdentifier _identifier;

    @Before
    public void setUp() {
        _identifier = new UniqueObjectIdentifier();
    }
    ...
    public void testCreateNewIdentifier_GeneratesUniqueValuesForDifferentInstances() {
        UniqueObjectIdentifier id1 = new UniqueObjectIdentifier();
        UniqueObjectIdentifier id2 = new UniqueObjectIdentifier();
    ...
    public void testMultipleIdentifierObjects_HaveDifferentIds() {
        UniqueObjectIdentifier[] identifiers = new UniqueObjectIdentifier[5];
        for (int i = 0; i < 5; i++) {
            identifiers[i] = new UniqueObjectIdentifier();
            identifiers[i].createNewIdentifier();
        }

        // All should have non-zero IDs
        for (UniqueObjectIdentifier id : identifiers) {
    ...
    public void testRandomIdentifierGeneration_IsNotZero() {
        ...
        for (int i = 0; i < 10; i++) {
            UniqueObjectIdentifier id = new UniqueObjectIdentifier();
    ...
    public void testCreateNewIdentifier_WithRandomness_ProducesVariousValues() {
        ...
        long[] ids = new long[3];
        for (int i = 0; i < 3; i++) {
            UniqueObjectIdentifier temp = new UniqueObjectIdentifier();
    ...
    public void testIdentifierUniquenessAcrossInstances() {
        UniqueObjectIdentifier id1 = new UniqueObjectIdentifier();
        UniqueObjectIdentifier id2 = new UniqueObjectIdentifier();
        UniqueObjectIdentifier id3 = new UniqueObjectIdentifier();
    ...
    public void testSequentialIdentifierCreation() {
        UniqueObjectIdentifier[] ids = new UniqueObjectIdentifier[3];
        for (int i = 0; i < 3; i++) {
            ids[i] = new UniqueObjectIdentifier();
