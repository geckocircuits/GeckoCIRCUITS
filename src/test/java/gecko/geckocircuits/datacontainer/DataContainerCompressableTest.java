...
public class DataContainerCompressableTest {
    ...
    public void testInsertValuesAtEndWithAvgTracking() {
        ...
        java.util.List<gecko.geckocircuits.newscope.ScopeSignalMean> meanSignals =
            new java.util.ArrayList<>();
        gecko.geckocircuits.newscope.ScopeSignalRegular regular =
            new gecko.geckocircuits.newscope.ScopeSignalRegular(0, null);
        gecko.geckocircuits.newscope.ScopeSignalMean mean =
            new gecko.geckocircuits.newscope.ScopeSignalMean(regular, 0.01);
