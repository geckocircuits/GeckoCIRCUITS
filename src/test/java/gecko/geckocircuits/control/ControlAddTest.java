...
public class ControlAddTest {
    ...
    public void testAddBlockCreation() {
        ControlAdd block = new ControlAdd();
        assertNotNull("Block should be created", block);
    }

    @Test
    public void testAddBlockTypeInfo() {
        assertNotNull("Type info should exist", ControlAdd.tinfo);
        assertEquals("ID string should be ADD", "ADD", ControlAdd.tinfo._fixedIDString);
    }
