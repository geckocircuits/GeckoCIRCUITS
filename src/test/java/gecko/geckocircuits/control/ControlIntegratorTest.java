 ...
 */
public class ControlIntegratorTest {
    ...
    public void testIntegratorBlockCreation() {
        ControlIntegrator block = new ControlIntegrator();
    ...
    public void testIntegratorBlockTypeInfo() {
        assertNotNull("Type info should exist", ControlIntegrator.tinfo);
        assertEquals("ID string should be INT", "INT", ControlIntegrator.tinfo._fixedIDString);
    }
