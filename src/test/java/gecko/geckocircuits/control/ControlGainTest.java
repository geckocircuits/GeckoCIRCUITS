...
public class ControlGainTest {
    ...
    public void testGainBlockCreation() {
        ControlGain block = new ControlGain();
    ...
    public void testGainBlockTypeInfo() {
        assertNotNull("Type info should exist", ControlGain.tinfo);
        assertEquals("ID string should be GAIN", "GAIN", ControlGain.tinfo._fixedIDString);
    }
    ...
    public void testGainCalculatorTimeStepIndependent() {
        ...
        calc.calculateYOUT(0.0001);
        double result2 = calc._outputSignal[0][0];

        calc.calculateYOUT(0.01);
