...
- JNI functions use correct package name: `Java_gecko_geckocircuits_nativec_*`
...
**Usage:**
```bash
cd src/test/java/gecko/geckocircuits/nativec/testJNI_DLL
...
- `Java_gecko_geckocircuits_nativec_NativeCWrapper_calcOutputs`
- `Java_gecko_geckocircuits_nativec_NativeCWrapper_initParameters`
