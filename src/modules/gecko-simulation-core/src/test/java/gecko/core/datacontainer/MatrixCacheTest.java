...
class MatrixCacheTest {
    ...
    @Test
    void testIntegerCache_GetFromEmptyCache() {
    ...
    @Test
    void testIntegerCache_RecycleAndReuse() {
    ...
    @Test
    void testIntegerCache_DifferentDimensions() {
        // Get various sizes
    ...
    @Test
    void testIntegerCache_MultipleRecycles() {
    ...
    @Test
    void testIntegerCache_EmptyArray() {
    ...
    @Test
    void testIntegerCache_SingleRow() {
    ...
    @Test
    void testIntegerCache_SingleColumn() {
    ...
    @Test
    void testIntegerCache_ClearCache() {
        // Add to cache
    ...
    @Test
    void testShortCache_GetFromEmptyCache() {
    ...
    @Test
    void testShortCache_RecycleAndReuse() {
    ...
    @Test
    void testShortCache_DifferentDimensions() {
    ...
    @Test
    void testShortCache_EmptyMatrix() {
    ...
    @Test
    void testShortCache_ClearCache() {
    ...
    @Test
    void testDimensionKey_SameDimensions() {
    ...
    @Test
    void testDimensionKey_DifferentDimensions() {
    ...
    @Test
    void testCacheStress_ManyAllocations() {
    ...
    @Test
    void testCacheStress_ShortMatrix() {
        for (int i = 0; i < 100; i++) {
    ...
    @Test
    void testIntegerCache_DataInitialization() {
    ...
    @Test
    void testShortCache_DataInitialization() {
