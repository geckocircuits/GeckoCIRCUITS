...
class BigLUDecompositionTest {
    private static final double TOLERANCE = 1e-8;

    // ==================== DECOMPOSITION TESTS ====================

    @Test
    void testLUDecomposition_2x2Matrix() {
        BigDecimal[][] data = {
    ...
    @Test
    void testLUDecomposition_3x3Matrix() {
        BigDecimal[][] data = {
    ...
    @Test
    void testLUDecomposition_IdentityMatrix() {
        BigDecimal[][] data = {
    ...
    @Test
    void testLUDecomposition_DiagonalMatrix() {
        BigDecimal[][] data = {
    ...
    @Test
    void testIsNonsingular_NonSingularMatrix() {
        BigDecimal[][] data = {
            {new BigDecimal("2.0"), new BigDecimal("1.0")},
            {new BigDecimal("1.0"), new BigDecimal("2.0")}
        };
    ...
    @Test
    void testIsNonsingular_SingularMatrix() {
    ...
    @Test
    void testIsNonsingular_ZeroRow() {
        BigDecimal[][] data = {
            {new BigDecimal("1.0"), new BigDecimal("2.0")},
    ...
    @Test
    void testGetDoublePivot_2x2Matrix() {
        BigDecimal[][] data = {
            {new BigDecimal("2.0"), new BigDecimal("1.0")},
    ...
    @Test
    void testSolve_2x2DiagonalSystem() {
    ...
    @Test
    void testSolve_2x2GeneralSystem() {
    ...
    @Test
    void testSolve_DimensionMismatch() {
    ...
    @Test
    void testLUDecomposition_HighPrecision() {
    ...
    @Test
    void testLUDecomposition_4x4Matrix() {
        BigDecimal[][] data = {
    ...
    @Test
    void testLUDecomposition_4x4NonsingularMatrix() {
        BigDecimal[][] data = {
