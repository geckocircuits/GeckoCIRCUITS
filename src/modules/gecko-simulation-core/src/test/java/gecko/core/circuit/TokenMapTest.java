...
class TokenMapTest {
    ...
    @Test
    void testConstructor_AcceptsAsciiArray() {
    ...
    @Test
    void testConstructor_WithSpecialPairs() {
        String[] ascii = {"token1 value", "token2 123"};
    ...
    @Test
    void testGetLines_ReturnsOriginalAsciiArray() {
        String[] ascii = {"token1 value", "token2 123"};
        TokenMap map = new TokenMap(ascii);
    ...
    @Test
    void testContainsToken_WithExistingToken() {
        assertTrue(_tokenMap.containsToken("componentA"));
    }

    @Test
    void testContainsToken_WithNonExistentToken() {
        assertFalse(_tokenMap.containsToken("nonExistentToken"));
    }

    @Test
    void testContainsToken_CaseSensitive() {
    ...
    @Test
    void testGetLineNumber_ValidToken() {
    ...
    @Test
    void testGetLineNumber_AnotherValidToken() {
    ...
    @Test
    void testReadDataLine_String_WithValidToken() {
    ...
    @Test
    void testReadDataLine_String_WithInvalidToken_ReturnsDefault() {
    ...
    @Test
    void testReadDataLine_Double_WithValidToken() {
        double value = _tokenMap.readDataLine("param2", 0.0);
        assertEquals(3.14159, value, 0.00001);
    }

    @Test
    void testReadDataLine_Double_WithInvalidToken_ReturnsDefault() {
    ...
    @Test
    void testReadDataLine_Integer_WithValidToken() {
        int value = _tokenMap.readDataLine("componentB", 0);
        assertEquals(123, value);
    }

    @Test
    void testReadDataLine_Integer_WithInvalidToken_ReturnsDefault() {
    ...
    @Test
    void testReadDataLine_DoubleArray() {
        String[] ascii = {
    ...
    @Test
    void testReadDataLine_IntArrayWithNull() {
        String[] ascii = {
            "arrayWithNull null"
        };
        TokenMap map = new TokenMap(ascii);
    ...
    @Test
    void testReadDataLine_DoubleArrayWithNull() {
        String[] ascii = {
            "arrayWithNull null"
        };
        TokenMap map = new TokenMap(ascii);
    ...
    @Test
    void testReadDataLine_BooleanArray() {
        String[] ascii = {
    ...
    @Test
    void testReadDataLine_ByteArray() {
        String[] ascii = {
            "byteArray 1 2 3 4 5"
        };
        TokenMap map = new TokenMap(ascii);
    ...
    @Test
    void testReadDataLine_LongArray() {
        String[] ascii = {
    ...
    @Test
    void testReadDataLine_2DIntArray() {
        String[] ascii = {
    ...
    @Test
    void testReadDataLine_2DDoubleArray() {
        String[] ascii = {
    ...
    @Test
    void testReadDataLine_2DBooleanArray() {
        String[] ascii = {
    ...
    @Test
    void testReadDataLine_StringArray() {
        String[] ascii = {
        ...
        assertTrue(result.length >= 0, "Result should be array");
    }

    @Test
    void testLeseASCIITextBlock_BasicUsage() {
        String[] ascii = {
    ...
    @Test
    void testLeseASCIITextBlock_WithNewlineEscape() {
        String[] ascii = {
            "description Line1\\nLine2"
        };
        TokenMap map = new TokenMap(ascii);
    ...
    @Test
    void testToString_CreatesCorrectOutput() {
        String[] ascii = {
            "token1 value1",
            "token2 value2"
        };
    ...
    @Test
    void testToString_SingleLineArray() {
    ...
    @Test
    void testFindSubBlock_ValidRange() {
        String[] ascii = {
            "start",
            "content1",
            "content2",
    ...
    @Test
    void testFindSubBlock_EmptyBlock() {
        String[] ascii = {
            "start",
            "end",
            "after"
    ...
    @Test
    void testCreateSubBlock_ValidRange() {
        String[] ascii = {
            "start",
            "line1",
            "line2",
    ...
    @Test
    void testReadDataLineDoubleArray_ValidData() {
        String[] ascii = {
    ...
    @Test
    void testReadDataLineStringArray_ValidData() {
        String[] ascii = {
        ...
        assertNotNull(result, "Result should not be null");
        // The actual result depends on the API implementation
        assertTrue(result.size() >= 0, "Result should be list");
    }

    @Test
    void testReadDataLine_LongWithValidToken() {
        String[] ascii = {
