...
class AverageValueTest {
    ...
    @Test
    void testConstructor_BasicValues() {
    ...
    @Test
    void testConstructor_NegativeInterval() {
    ...
    @Test
    void testAppendAverage_EqualSpans() {
    ...
    @Test
    void testAppendAverage_UnequalSpans() {
    ...
    @Test
    void testAppendAverage_NullAppend() {
    ...
    @Test
    void testAppendAverage_VerySmallSpan() {
    ...
    @Test
    void testAppendAverage_MultipleAppends() {
    ...
    @Test
    void testAppendAverage_NegativeValues() {
    ...
    @Test
    void testAppendAverage_PositiveAndNegative() {
        AverageValue avg1 = new AverageValue(10.0, 0.0, 5.0);
    ...
    @Test
    void testToString_ContainsAllValues() {
    ...
    @Test
    void testAverageValue_DCSignal() {
    ...
    @Test
    void testAverageValue_RampSignal() {
