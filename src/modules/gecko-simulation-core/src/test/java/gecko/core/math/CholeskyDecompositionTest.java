...
class CholeskyDecompositionTest {
    ...
    @Test
    void testCholesky_NonSPD_Matrix() {
    ...
    @Test
    void testCholesky_SymmetricButNotPositiveDefinite() {
    ...
    @Test
    void testCholesky_IdentityMatrix() {
    ...
    @Test
    void testL_TimesL_Transpose_EqualsA() {
    ...
    @Test
    void testL_TimesL_Transpose_3x3() {
    ...
    @Test
    void testSolve_NonSPD_ThrowsException() {
        ...
        CholeskyDecomposition chol = new CholeskyDecomposition(A);
        assertFalse(chol.isSPD());
        assertThrows(RuntimeException.class, () -> chol.solve(b));
    }

    @Test
    void testSolve_DimensionMismatch_ThrowsException() {
        ...
        CholeskyDecomposition chol = new CholeskyDecomposition(A);
        assertThrows(IllegalArgumentException.class, () -> chol.solve(b));
    }
    ...
    @Test
    void testCholesky_DiagonalMatrix() {
