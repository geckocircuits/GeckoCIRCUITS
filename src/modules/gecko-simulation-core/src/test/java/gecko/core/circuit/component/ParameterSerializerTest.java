...
import gecko.core.circuit.component.ParameterSerializer.*;
...
class ParameterSerializerTest {
    ...
    @Test
    void testExportValuesScientific() {
    ...
    @Test
    void testExportNamesWithMiddleNull() {
    ...
    @Test
    void testImportValuesEmpty() throws ParseException {
    ...
    @Test
    void testImportValuesSingle() throws ParseException {
    ...
    @Test
    void testImportValuesMultiple() throws ParseException {
    ...
    @Test
    void testImportValuesMultiLine() throws ParseException {
        TokenizerAdapter tok = serializer.createTokenizer("3\n1.0\n2.5\n3.14159");
        double[] values = serializer.importValuesFromASCII(tok);
        assertEquals(1.0, values[0], 1e-10);
        assertEquals(2.5, values[1], 1e-10);
    ...
    @Test
    void testImportValuesScientific() throws ParseException {
    ...
    @Test
    void testImportValuesInvalidCount() {
    ...
    @Test
    void testImportValuesNegativeCount() {
        assertThrows(ParseException.class, () -> {
    ...
    @Test
    void testImportValuesTooManyParameters() {
        assertThrows(ParseException.class, () -> {
    ...
    @Test
    void testImportValuesInvalidValue() {
        assertThrows(ParseException.class, () -> {
            TokenizerAdapter tok = serializer.createTokenizer("2\n1.0 xyz");
            serializer.importValuesFromASCII(tok);
        });
    ...
    @Test
    void testImportValuesMissingValues() {
        assertThrows(ParseException.class, () -> {
            TokenizerAdapter tok = serializer.createTokenizer("5\n1.0 2.0");
            serializer.importValuesFromASCII(tok);
        });
    ...
    @Test
    void testImportNamesEmpty() throws ParseException {
        TokenizerAdapter tok = serializer.createTokenizer("0");
    ...
    @Test
    void testImportNamesSingle() throws ParseException {
        TokenizerAdapter tok = serializer.createTokenizer("1\nresistance");
        String[] names = serializer.importNamesFromASCII(tok);
    ...
    @Test
    void testImportNamesMultiple() throws ParseException {
        TokenizerAdapter tok = serializer.createTokenizer("3\nR\nL\nC");
        String[] names = serializer.importNamesFromASCII(tok);
    ...
    @Test
    void testImportNamesWithEmptyLine() throws ParseException {
        TokenizerAdapter tok = serializer.createTokenizer("3\nR\n\nC");
        String[] names = serializer.importNamesFromASCII(tok);
        assertEquals("R", names[0]);
    ...
    @Test
    void testExportImportRoundTrip() throws ParseException {
    ...
    @Test
    void testImportResult() throws ParseException {
        TokenizerAdapter tok = serializer.createTokenizer("2\n1.0 2.0\n2\nA\nB");
        ImportResult result = serializer.importFromASCII(tok);
    ...
    @Test
    void testListTokenizerNextLine() {
    ...
    @Test
    void testListTokenizerMixedUsage() {
    ...
    @Test
    void testTypicalComponentSerialization() throws ParseException {
    ...
    @Test
    void testSwitchParameterSerialization() throws ParseException {
    ...
    @Test
    void testEmptyComponentSerialization() throws ParseException {
    ...
    @Test
    void testDoubleFormattingPrecision() throws ParseException {
    ...
    @Test
    void testImportValuesMissingNewline() throws ParseException {
    ...
    @Test
    void testImportValuesInvalidDouble() {
        assertThrows(ParseException.class, () -> {
            TokenizerAdapter tok = serializer.createTokenizer("1\n1.0.0");
            serializer.importValuesFromASCII(tok);
        });
    ...
    @Test
    void testImportValuesEndOfInput() {
        assertThrows(ParseException.class, () -> {
            TokenizerAdapter tok = serializer.createTokenizer("5\n1.0");
            serializer.importValuesFromASCII(tok);
        });
    ...
    @Test
    void testImportNamesEndOfInput() {
        assertThrows(ParseException.class, () -> {
            TokenizerAdapter tok = serializer.createTokenizer("3\nA\nB");
    ...
    @Test
    void testImportResultGetName() throws ParseException {
        TokenizerAdapter tok = serializer.createTokenizer("0\n3\nA\nB\nC");
        ImportResult result = serializer.importFromASCII(tok);
    ...
    @Test
    void testSerializerCustomSize() {
        ParameterSerializer custom = new ParameterSerializer(10);
        assertEquals(10, custom.getArraySize());
    }

    @Test
    void testListTokenizerBasicUsage() {
        TokenizerAdapter tok = new ListTokenizer(Arrays.asList("a b c", "d e f"));
        assertNotNull(tok.nextToken(), "First token should not be null");
        // Tokenizer behavior varies - just verify no exceptions
        assertNotNull(tok.nextToken(), "Next call should work");
    }

    @Test
    void testTokenizerCreation() {
        TokenizerAdapter tok = serializer.createTokenizer("name1\nname2\n");
        assertNotNull(tok, "Tokenizer should be created");
    }

    @Test
    void testExportImportRoundTripNegativeValues() throws ParseException {
        double[] originalValues = {-100.0, -0.001, -1e-6};
    ...
    @Test
    void testExportImportRoundTripWithNullNames() throws ParseException {
    ...
    @Test
    void testImportInvalidCountFormat() {
        assertThrows(ParseException.class, () -> {
    ...
    @Test
    void testCreateTokenizerFromString() {
