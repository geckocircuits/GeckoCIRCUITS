 ...
 */
package gecko.core.circuit.terminal;

import gecko.core.circuit.ConnectorType;
...
class ITerminalPositionTest {
    ...
    @Test
    void testOf_CreatesTerminalPosition_LK() {
    ...
    @Test
    void testOf_CreatesTerminalPosition_CONTROL() {
    ...
    @Test
    void testOf_CreatesTerminalPosition_RELUCTANCE() {
    ...
    @Test
    void testOf_NegativeCoordinates() {
    ...
    @Test
    void testIsAtSamePosition_True() {
    ...
    @Test
    void testIsAtSamePosition_True_DifferentTypes() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 10, ConnectorType.LK);
    ...
    @Test
    void testIsAtSamePosition_False_DifferentX() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 10, ConnectorType.LK);
    ...
    @Test
    void testIsAtSamePosition_False_DifferentY() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 10, ConnectorType.LK);
    ...
    @Test
    void testIsAtSamePosition_False_DifferentBoth() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 10, ConnectorType.LK);
    ...
    @Test
    void testManhattanDistanceTo_Horizontal() {
    ...
    @Test
    void testManhattanDistanceTo_Vertical() {
    ...
    @Test
    void testManhattanDistanceTo_Diagonal() {
    ...
    @Test
    void testManhattanDistanceTo_SamePoint() {
    ...
    @Test
    void testManhattanDistanceTo_NegativeCoordinates() {
        ITerminalPosition t1 = ITerminalPosition.of(-5, -5, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(5, 5, ConnectorType.LK);
    ...
    @Test
    void testManhattanDistanceTo_LargeDistances() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testEuclideanDistanceTo_Horizontal() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testEuclideanDistanceTo_Vertical() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testEuclideanDistanceTo_3_4_5Triangle() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(3, 4, ConnectorType.LK);
    ...
    @Test
    void testEuclideanDistanceTo_SamePoint() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 5, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(5, 5, ConnectorType.LK);
    ...
    @Test
    void testEuclideanDistanceTo_Symmetric() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testEuclideanDistanceTo_NegativeCoordinates() {
    ...
    @Test
    void testCanConnectTo_SameType_LK() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(10, 10, ConnectorType.LK);
    ...
    @Test
    void testCanConnectTo_SameType_CONTROL() {
    ...
    @Test
    void testCanConnectTo_SameType_RELUCTANCE() {
    ...
    @Test
    void testCanConnectTo_SameType_THERMAL() {
    ...
    @Test
    void testCanConnectTo_IncompatibleTypes_LK_CONTROL() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(10, 10, ConnectorType.CONTROL);
    ...
    @Test
    void testCanConnectTo_IncompatibleTypes_LK_RELUCTANCE() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(10, 10, ConnectorType.RELUCTANCE);
    ...
    @Test
    void testCanConnectTo_IncompatibleTypes_CONTROL_THERMAL() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.CONTROL);
        ITerminalPosition t2 = ITerminalPosition.of(10, 10, ConnectorType.THERMAL);
    ...
    @Test
    void testCanConnectTo_WithNONE() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testIsHorizontallyAligned_True() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 5, ConnectorType.LK);
    ...
    @Test
    void testIsHorizontallyAligned_False() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 5, ConnectorType.LK);
    ...
    @Test
    void testIsHorizontallyAligned_SamePoint() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 5, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(5, 5, ConnectorType.LK);
    ...
    @Test
    void testIsHorizontallyAligned_NegativeCoordinates() {
    ...
    @Test
    void testIsVerticallyAligned_True() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 0, ConnectorType.LK);
    ...
    @Test
    void testIsVerticallyAligned_False() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 0, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(10, 20, ConnectorType.LK);
    ...
    @Test
    void testIsVerticallyAligned_SamePoint() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 5, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(5, 5, ConnectorType.LK);
    ...
    @Test
    void testIsVerticallyAligned_NegativeCoordinates() {
        ITerminalPosition t1 = ITerminalPosition.of(-5, -10, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(-5, 10, ConnectorType.LK);
    ...
    @Test
    void testSimpleTerminalPosition_Equality() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 10, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(5, 10, ConnectorType.LK);
    ...
    @Test
    void testSimpleTerminalPosition_HashCode() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 10, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(5, 10, ConnectorType.LK);
    ...
    @Test
    void testSimpleTerminalPosition_ToString() {
    ...
    @Test
    void testSimpleTerminalPosition_NotEqual_DifferentX() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 10, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(6, 10, ConnectorType.LK);
    ...
    @Test
    void testSimpleTerminalPosition_NotEqual_DifferentY() {
        ITerminalPosition t1 = ITerminalPosition.of(5, 10, ConnectorType.LK);
        ITerminalPosition t2 = ITerminalPosition.of(5, 11, ConnectorType.LK);
    ...
    @Test
    void testSimpleTerminalPosition_EqualsNull() {
        ITerminalPosition t = ITerminalPosition.of(5, 10, ConnectorType.LK);
    ...
    @Test
    void testSimpleTerminalPosition_EqualsSelf() {
        ITerminalPosition t = ITerminalPosition.of(5, 10, ConnectorType.LK);
    ...
    @Test
    void testAllConnectorTypes_NONE() {
    ...
    @Test
    void testBoundaryValues_ZeroCoordinates() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testBoundaryValues_MaxIntegerCoordinates() {
    ...
    @Test
    void testPositionIndependenceOfAlignment() {
