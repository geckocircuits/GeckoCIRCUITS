...
class ConnectionPathTest {
    ...
    @Test
    void testGetStartEndPoint_EmptyPath() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
    ...
    @Test
    void testCreateLPath_HorizontalFirst() {
    ...
    @Test
    void testCreateLPath_VerticalFirst() {
        ITerminalPosition start = ITerminalPosition.of(0, 0, ConnectorType.LK);
        ITerminalPosition end = ITerminalPosition.of(10, 5, ConnectorType.LK);
    ...
    @Test
    void testCreateLPath_AlignedHorizontally() {
    ...
    @Test
    void testCreateLPath_AlignedVertically() {
    ...
    @Test
    void testCreateLPath_IncompatibleTypes() {
    ...
    @Test
    void testCreateDirectPath_Horizontal() {
    ...
    @Test
    void testCreateDirectPath_Vertical() {
    ...
    @Test
    void testCreateDirectPath_NotAligned() {
        assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    void testGetTotalLength_Horizontal() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testGetTotalLength_Vertical() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(0, 5);
    ...
    @Test
    void testGetCornerCount_Straight() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testGetCornerCount_OneCorner() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
        path.addPoint(10, 5);
    ...
    @Test
    void testGetCornerCount_TwoCorners() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(5, 0);
        path.addPoint(5, 5);
    ...
    @Test
    void testIsValid_DiagonalSegment() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
    ...
    @Test
    void testContainsPoint_OnHorizontalSegment() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testContainsPoint_OnVerticalSegment() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(0, 10);
    ...
    @Test
    void testContainsPoint_NotOnPath() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testContainsPoint_AtCorner() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
        path.addPoint(10, 5);
    ...
    @Test
    void testReverse_PreservesConnectorType() {
    ...
    @Test
    void testTrimmed_RemovesCollinearPoints() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
    ...
    @Test
    void testTrimmed_PreservesCorners() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
        path.addPoint(10, 5);
    ...
    @Test
    void testPath_Inequality_DifferentType() {
        ConnectionPath path1 = new ConnectionPath(ConnectorType.LK);
        path1.addPoint(0, 0);
    ...
    @Test
    void testPath_Inequality_DifferentPoints() {
        ConnectionPath path1 = new ConnectionPath(ConnectorType.LK);
        path1.addPoint(0, 0);
        path1.addPoint(10, 0);
