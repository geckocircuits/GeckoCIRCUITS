 ...
 */
class ShortMatrixCacheEdgeCasesTest {
    ...
    @Test
    void testGetCachedMatrixZeroDimensions() {
    ...
    @Test
    void testGetCachedMatrixSingleElement() {
    ...
    @Test
    void testRecycleAndRetrieveSameSize() {
    ...
    @Test
    void testDifferentSizesNoConflict() {
    ...
    @Test
    void testClearCacheFreesMemory() {
        // Fill cache
        for (int i = 0; i < 10; i++) {
    ...
    @Test
    void testLargeMatrixDimensions() {
    ...
    @Test
    void testRapidRecycleRetrieveCycle() {
    ...
    @Test
    void testDataIntegrityAfterCache() {
