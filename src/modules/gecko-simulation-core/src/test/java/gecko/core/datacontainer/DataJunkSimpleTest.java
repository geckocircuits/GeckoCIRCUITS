...
class DataJunkSimpleTest {
    ...
    @Test
    void testGetIntegralValueThrows() {
        DataJunkSimple junk = createJunk(0, 2, 5);
        if (junk == null) return;
        try {
    ...
    @Test
    void testGetAverageValueThrows() {
        DataJunkSimple junk = createJunk(0, 2, 5);
        if (junk == null) return;
        try {
    ...
    @Test
    void testSetValuesOverwritesPrevious() {
        DataJunkSimple junk = createJunk(0, 2, 5);
        if (junk == null) return;
