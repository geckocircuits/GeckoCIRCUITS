...
class MatrixTest {
    ...
    // Constructor Tests
    @Test
    void testConstructor_ZeroMatrix() {
    ...
    @Test
    void testConstructor_ConstantMatrix() {
    ...
    @Test
    void testInverse_TimesOriginal_IsIdentity() {
        double[][] data = {{2, 1}, {1, 2}};
        Matrix m = new Matrix(data);
        Matrix inv = m.inverse();
    ...
    @Test
    void testArrayRightDivideEquals() {
    ...
    @Test
    void testTimes_ScalarMultiplication() {
        double[][] data = {{1, 2}, {3, 4}};
        Matrix m = new Matrix(data);
        Matrix result = m.times(2.0);
    ...
    @Test
    void testGetMatrix_ByRowColumnIndices() {
    ...
    @Test
    void testGetMatrix_ByRowIndices() {
        double[][] data = {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
        Matrix m = new Matrix(data);
        int[] rows = {1};
    ...
    @Test
    void testDeterminant_NonSquareThrowsException() {
        double[][] data = {{1, 2, 3}, {4, 5, 6}};
        Matrix m = new Matrix(data);

        // Non-square matrix should throw exception
        assertThrows(Exception.class, () -> m.det());
    }
