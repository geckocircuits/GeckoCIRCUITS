...
import gecko.core.circuit.terminal.ConnectionValidator.ValidationResult;
import gecko.core.circuit.terminal.ConnectionValidator.ValidationResult.Status;
...
class ConnectionValidatorTest {
    ...
    @Test
    void testValidateConnection_SameType_LK() {
    ...
    @Test
    void testValidateConnection_SameType_CONTROL() {
    ...
    @Test
    void testValidateConnection_SameType_RELUCTANCE() {
    ...
    @Test
    void testValidateConnection_IncompatibleTypes_LK_CONTROL() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testValidateConnection_IncompatibleTypes_LK_RELUCTANCE() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testValidateConnection_IncompatibleTypes_CONTROL_RELUCTANCE() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.CONTROL);
        ITerminalPosition t2 = ITerminalPosition.of(10, 0, ConnectorType.RELUCTANCE);
    ...
    @Test
    void testValidateConnection_SamePosition() {
    ...
    @Test
    void testValidateConnection_NullTerminal1() {
    ...
    @Test
    void testValidateConnection_NullTerminal2() {
        assertThrows(NullPointerException.class, () -> {
            ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testValidateConnection_BothNull() {
        assertThrows(NullPointerException.class, () -> {
            // Should throw NullPointerException
    ...
    @Test
    void testValidatePath_ValidHorizontalPath() {
    ...
    @Test
    void testValidatePath_ValidVerticalPath() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(0, 10);
    ...
    @Test
    void testValidatePath_ValidLPath() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
        path.addPoint(10, 5);
    ...
    @Test
    void testValidatePath_ValidMultiCornerPath() {
    ...
    @Test
    void testValidatePath_InsufficientPoints() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
    ...
    @Test
    void testValidatePath_DiagonalSegment() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
    ...
    @Test
    void testValidatePath_ZeroLengthSegment() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
    ...
    @Test
    void testValidatePathEndpoints_ValidEndpoints() {
    ...
    @Test
    void testValidatePathEndpoints_StartMismatch() {
    ...
    @Test
    void testValidatePathEndpoints_EndMismatch() {
        ITerminalPosition start = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testValidatePathEndpoints_TypeMismatch() {
        ITerminalPosition start = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testPathsIntersect_Crossing() {
    ...
    @Test
    void testPathsIntersect_NoCrossing() {
        ConnectionPath path1 = new ConnectionPath(ConnectorType.LK);
        path1.addPoint(0, 0);
        path1.addPoint(5, 0);
    ...
    @Test
    void testPathsIntersect_Touching() {
        ConnectionPath path1 = new ConnectionPath(ConnectorType.LK);
        path1.addPoint(0, 0);
        path1.addPoint(5, 0);
    ...
    @Test
    void testPathsIntersect_LPaths() {
        ConnectionPath path1 = new ConnectionPath(ConnectorType.LK);
        path1.addPoint(0, 5);
        path1.addPoint(10, 5);
    ...
    @Test
    void testPathsIntersect_SamePath() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testPathsIntersect_ParallelOverlapping() {
        ConnectionPath path1 = new ConnectionPath(ConnectorType.LK);
        path1.addPoint(0, 0);
        path1.addPoint(10, 0);
    ...
    @Test
    void testPathsIntersect_ParallelNonOverlapping() {
        ConnectionPath path1 = new ConnectionPath(ConnectorType.LK);
        path1.addPoint(0, 0);
        path1.addPoint(5, 0);
    ...
    @Test
    void testValidatePowerConnection() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testValidatePowerConnection_WrongType() {
        ConnectionPath path = new ConnectionPath(ConnectorType.CONTROL);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testValidateControlConnection() {
        ConnectionPath path = new ConnectionPath(ConnectorType.CONTROL);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testValidateControlConnection_WrongType() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testValidateReluctanceConnection() {
    ...
    @Test
    void testValidateReluctanceConnection_WrongType() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
        path.addPoint(0, 0);
        path.addPoint(10, 0);
    ...
    @Test
    void testValidationResult_Warning() {
    ...
    @Test
    void testValidateConnection_FarApartTerminals() {
        ITerminalPosition t1 = ITerminalPosition.of(0, 0, ConnectorType.LK);
    ...
    @Test
    void testValidateConnection_NegativeCoordinates() {
    ...
    @Test
    void testValidatePath_LongPath() {
        ConnectionPath path = new ConnectionPath(ConnectorType.LK);
