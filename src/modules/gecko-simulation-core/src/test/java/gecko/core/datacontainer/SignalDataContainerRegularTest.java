 ...
 */
class SignalDataContainerRegularTest {
    ...
    @Test
    void testSetSignalNameOverridesDefault() {
    ...
    @Test
    void testMultipleSignalContainers() {
    ...
    @Test
    void testGetHiLoValueNegatives() {
    ...
    @Test
    void testIsAbstractDataContainerSignal() {
        assertTrue(
                   signalContainer instanceof AbstractDataContainerSignal, "Should be instance of AbstractDataContainerSignal");
    }
    ...
    @Test
    void testSignalContainerWithTimeSeriesData() {
    ...
    @Test
    void testSignalContainerTimeSeries() {
    ...
    @Test
    void testSignalNamePersistenceWithData() {
    ...
    @Test
    void testMultipleSignalsIndependentNames() {
    ...
    @Test
    void testGetAbsoluteMinMaxValueBoundary() {
        for (int i = 0; i < 50; i++) {
    ...
    @Test
    void testMultipleDataContainers() {
    ...
    @Test
    void testSignalNameWithUnicode() {
    ...
    @Test
    void testGetHiLoValueZeroRange() {
        dataContainer.setValue(42.0f, 1, 0);
        HiLoData hiLo = dataContainer.getHiLoValue(1, 0, 1);
    ...
    @Test
    void testSignalContainerReferencesCorrectRow() {
    ...
    @Test
    void testSignalContainerDataIndependence() {
        SignalDataContainerRegular sig1 = new SignalDataContainerRegular(dataContainer, 1);
        SignalDataContainerRegular sig2 = new SignalDataContainerRegular(dataContainer, 2);
