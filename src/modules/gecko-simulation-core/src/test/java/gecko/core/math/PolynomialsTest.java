...
class PolynomialsTest {
    ...
    @Test
    void testPoldiv_SimpleExactDivision() {
    ...
    @Test
    void testPoldiv_DivideByConstant() {
    ...
    @Test
    void testPoldiv_LowerDegreeDividend() {
    ...
    @Test
    void testPoldiv_MonomialDivision() {
        // (x³) / (x) = x², remainder = 0
        float[] u = {0, 0, 0, 1}; // x³
        float[] v = {0, 1};        // x
        float[] q = new float[4];
    ...
    @Test
    void testPoldiv_HigherDegreeDivision() {
    ...
    @Test
    void testPoldiv_ConstantDividend() {
        // 5 / (x+2) = 0, remainder = 5
        float[] u = {5, 0, 0}; // 5
        float[] v = {2, 1};    // x + 2
        float[] q = new float[3];
    ...
    @Test
    void testPoldiv_LargeCoefficients() {
    ...
    @Test
    void testPoldiv_SmallCoefficients() {
    ...
    @Test
    void testPoldiv_QuadraticDividendLinearDivisor() {
    ...
    @Test
    void testPoldiv_CubicDividendQuadraticDivisor() {
    ...
    @Test
    void testPoldiv_NegativeCoefficients() {
    ...
    @Test
    void testPoldiv_HighDegreePolynomial() {
    ...
    @Test
    void testPoldiv_FractionalCoefficients() {
    ...
    @Test
    void testPoldiv_SingleElementArrays() {
    ...
    @Test
    void testPoldiv_LinearDividendConstantDivisor() {
    ...
    @Test
    void testPoldiv_QuarticByQuadratic() {
    ...
    @Test
    void testPoldiv_LargerDividendThanDivisor() {
        // (2x⁴+3x³+4x²+5x+6) / (x²+1)
    ...
    @Test
    void testPoldiv_IdentityDivision() {
    ...
    @Test
    void testPoldiv_NegativeDividendCoefficients() {
    ...
    @Test
    void testPoldiv_LargeArraysWithPartialUse() {
    ...
    @Test
    void testPoldiv_HighDegreeQuotient() {
        // (x⁵+2x⁴+3x³+4x²+5x+6) / (x+1)
    ...
    @Test
    void testPoldiv_ExactDivisionQuadraticByLinear() {
    ...
    @Test
    void testPoldiv_VerifyRemainder() {
    ...
    @Test
    void testPoldiv_MixedSignCoefficients() {
