...
class SignalDataContainerTest {
    ...
    @Test
    void testSignalDataContainerRegularCreation() {
    ...
    @Test
    void testSignalDataContainerRegularGetSignalName() {
        SignalDataContainerRegular signal = new SignalDataContainerRegular(dataContainer, 0);
    ...
    @Test
    void testSignalDataContainerRegularSetSignalName() {
        SignalDataContainerRegular signal = new SignalDataContainerRegular(dataContainer, 0);
    ...
    @Test
    void testSignalDataContainerRegularToString() {
    ...
    @Test
    void testSignalDataContainerRegularIndex() {
    ...
    @Test
    void testMultipleSignalsRegular() {
    ...
    @Test
    void testSignalDataContainerRegularWithMultipleDataContainers() {
    ...
    @Test
    void testSignalIndependenceRegular() {
    ...
    @Test
    void testSignalDataContainerRegularChangeSignalName() {
        SignalDataContainerRegular signal = new SignalDataContainerRegular(dataContainer, 0);
