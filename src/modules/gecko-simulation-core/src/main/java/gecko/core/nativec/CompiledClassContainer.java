...
/**
 * Container for compiled Java class bytes and source code.
 *
 * <p>Used to store and retrieve compiled class files for native C/C++ integration.
 * Supports serialization for persistence and circuit file storage.
 *
 * @author andreas
