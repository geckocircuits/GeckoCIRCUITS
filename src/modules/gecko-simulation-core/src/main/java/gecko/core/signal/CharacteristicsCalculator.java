...
import gecko.core.datacontainer.AbstractDataContainer;
import gecko.core.GeckoInvalidArgumentException;
import edu.umd.cs.findbugs.annotations.SuppressFBWarnings;

/**
 * Calculates characteristic values of signal data for power electronics analysis.
 *
 * <p>Computes RMS, THD, average, min/max, ripple, distortion factor, and shape factor
 * for signals in a data container. Implements caching for performance optimization.
 *
 * <p>Used for REST API signal analysis endpoints and GeckoSCRIPT integration.
 *
 * @author andy
...
public final class CharacteristicsCalculator {
    ...
    /**
     * Creates a characteristics calculator for all signals in the worksheet.
     *
    ...
    /**
     * Returns all characteristic values for a specific channel.
     *
     * @param channel the signal channel index
     * @return array containing [AVG, RMS, THD, MIN, MAX, RIPPLE, KLIRR, SHAPE, PEAK_PEAK]
     * @throws GeckoInvalidArgumentException if channel index is invalid
     */
