...
/**
 * Enumeration of all supported languages in GeckoCIRCUITS.
 *
 * <p>Each language includes its ISO 639-1 language code and native name.
 * Used for internationalization support in both desktop and REST API interfaces.
 *
