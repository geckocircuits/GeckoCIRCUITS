...
- SpotBugs: 0 bugs (maintained), PMD: 3,316 violations (down from ~4,800), Checkstyle: 4,618 (down from 56,673)
...
- PMD: Custom ruleset (`pmd-ruleset.xml`), 3,316 remaining violations (code-style, not bugs)
